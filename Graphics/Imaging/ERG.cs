...
namespace Librainian.Graphics.Imaging {
    ...
    /// </remarks>
    /// <remarks>
    ///     Prefer native file system compression over encoding/compression
    ...
    ///     on each pixel to guard against (detect but not fix) corruption.
    /// </remarks>
    /// <remarks>
    ///     60
    ///     frames per second allows
    ///     16. 67 milliseconds per frame.
    ///     1920x1080 pixels = 2,052,000 possible pixels ...so about 8 nanoseconds per pixel?
    /// </remarks>
    [DataContract]
    [Serializable]
    public class ERG {
