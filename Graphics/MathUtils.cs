...
//
// =========================================================
// This section of source code, "MathUtils.cs",
...
//
// "Librainian/Librainian/MathUtils.cs" was last cleaned by Protiguous on 2018/05/15 at 10:43 PM.
...
namespace Librainian.Graphics {
    ...
    public static class MathUtils {
        ...
        public static Rect3D TransformBounds( Rect3D bounds, Matrix3D transform ) {
            ...
            Point3D[] points = {
                new Point3D( x1, y1, z1 ), new Point3D( x1, y1, z2 ), new Point3D( x1, y2, z1 ), new Point3D( x1, y2, z2 ), new Point3D( x2, y1, z1 ), new Point3D( x2, y1, z2 ), new Point3D( x2, y2, z1 ),
