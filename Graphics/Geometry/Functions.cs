...
// 
// "Librainian/Functions.cs" was last cleaned by Rick on 2015/06/12 at 2:55 PM
...
namespace Librainian.Graphics.Geometry {
    ...
    public static class Functions {
        ...
        /// </summary>
        /// <returns></returns>
        public static Boolean CalculateLineLineIntersection(Vector3D line1Point1, Vector3D line1Point2, Vector3D line2Point1, Vector3D line2Point2, out Vector3D resultSegmentPoint1, out Vector3D resultSegmentPoint2) {

            // Algorithm is ported from the C algorithm of
            // Paul Bourke at http://local.wasp.uwa.edu.au/~pbourke/geometry/lineline3d/
            //resultSegmentPoint1 = Vector3D.Empty;
            //resultSegmentPoint2 = Vector3D.Empty;
