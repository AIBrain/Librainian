...
//  
// "Librainian/Coordinate.cs" was last cleaned by Rick on 2015/10/20 at 8:10 AM
...
namespace Librainian.Graphics.DDD {
    ...
    public struct Coordinate : IEquatable<Coordinate>, IComparable<Coordinate> {
        ...
        public static implicit operator Point( Coordinate coordinate ) => new Point( ( Int32 )coordinate.X, ( Int32 )coordinate.Y );
        ...
        public Int32 CompareTo( Coordinate other ) => this.SquareLength.CompareTo( other.SquareLength );
        ...
        public override Int32 GetHashCode() => this.X.GetHashMerge( this.Y )
                                                   .GetHashMerge( this.Z );
