...
// 
// "Librainian2/Extensions.cs" was last cleaned by Rick on 2014/08/08 at 2:30 PM
#endregion
...
namespace Librainian.Parsing {
    ...
    public static class Extensions {
        ...
        public static String PluralOf( this Decimal number, [NotNull] String word ) {
            ...
            return LazyPluralizationService.Value.IsPlural( word ) ? word : LazyPluralizationService.Value.Pluralize( word );
        }
        ...
        public static String PluralOf( this BigDecimal number, [NotNull] String word ) {
            ...
            if ( number > BigDecimal.One || number < BigDecimal.One ) {
                return word;
            }
            return LazyPluralizationService.Value.Pluralize( word );
        }
