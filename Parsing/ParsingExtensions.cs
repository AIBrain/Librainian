...
// 
// "Librainian/ParsingExtensions.cs" was last cleaned by Rick on 2015/06/12 at 3:09 PM
...
namespace Librainian.Parsing {
    ...
    public static class ParsingExtensions {
        ...
        public static readonly String ARareString = Alphabet.ToBase64();
        ...
        static ParsingExtensions() {
            Alphabet = new String( value: AllLowercaseLetters.Where( Char.IsLetter ).Distinct().OrderBy( c => c ).Aggregate( String.Empty, ( s, c1 ) => s + ' ' + c1 ).ToArray() ).Trim();
        }

        public static ConcurrentDictionary< String, String > PluralCache {
            get;
        }
        ...
        public static String Humanize( [NotNull] this String word ) {
            ...
            return word.AddSpacesBeforeUppercase().ToLowerInvariant();
        }
        ...
        public static UInt64 RealLength( [CanBeNull] this String s ) {
            ...
            var bob = new StringInfo( s );
            return ( UInt64 ) bob.LengthInTextElements;
        }
        ...
        /// <summary>Return the <see cref="tuple" /> formatted with the index.</summary>
        /// <param name="tuple"></param>
        /// <returns></returns>
        public static String AsIndexed( this Tuple< String, Int32 > tuple ) => $"{tuple.Item1}.[{tuple.Item2}]";

        /// <summary>Return the <see cref="word" /> formatted with the <see cref="index" />.</summary>
        /// <param name="word"></param>
        ...
        /// <summary>Pulled from https://bitbucket.org/jpbochi/jplabscode/src/e1bb20c8f273/Extensions/CompressionExt.cs</summary>
        ...
        /// <summary>
        /// <para>Escapes a String according to the URI data String rules given in RFC 3986.</para></summary>
        ...
        public static Boolean IsUpperCase( this String inputString ) => Regex.IsMatch( inputString, @"^[A-Z]+$" );

        /// <summary>
        /// <para>String sentence = "10 cats, 20 dogs, 40 fish and 1 programmer.";</para>
        /// <para>Should return: <list type=""><item>10</item><item>20</item><item>40</item><item>1</item></list></para>
        /// </summary>
        ...
        /// <summary>Crude attempt at pluralizing a <paramref name="number" />.</summary>
        /// <param name="number"></param>
        ...
        public static String PluralOf( this UInt64 number, [NotNull] String singular ) {
            ...
            String plural;
            if ( PluralCache.TryGetValue( singular, out plural ) ) {
                return plural;
            }
        ...
        /// <summary>Case sensitive <see cref="StringComparison.InvariantCulture" /></summary>
        /// <param name="source"></param>
        /// <param name="compare"></param>
        /// <returns></returns>
        ...
        /// <summary>Just <see cref="string.Substring(int)" /> with a length check.</summary>
        /// <param name="s"></param>
        ...
        /// <summary>
        /// <para>Remove duplicate words ONLY if the previous word was the same word.</para></summary>
        /// <example>
        ...
        public static String[] Consonants {
            get;
        } = "B,C,CH,CL,D,F,FF,G,GH,GL,J,K,L,LL,M,MN,N,P,PH,PS,R,RH,S,SC,SH,SK,ST,T,TH,V,W,X,Y,Z".Split( ',' );
