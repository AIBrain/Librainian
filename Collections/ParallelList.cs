...
// 
// "Librainian/ParallelList.cs" was last cleaned by Rick on 2015/06/12 at 2:50 PM
...
namespace Librainian.Collections {
    ...
    /// <summary>
    /// <para>A thread safe list. Uses the Microsoft TPL dataflow behind the scene.</para></summary>
    ...
    public sealed class ParallelList<TType> : IList<TType> {
        ...
        /// <summary>
        /// <para>Provide a dataflow block to process messages in a serial fashion.</para></summary>
        [NotNull]
        ...
        /// <summary>
        /// <para>The internal list actually used.</para></summary>
        [DataMember]
        [NotNull]
        ...
        /// <summary>
        /// <para>Count of items currently in this <see cref="ParallelList{TType}" />.</para></summary>
        public Int32 Count => this._itemCounter.Values.Aggregate( 0, (current, variable) => current + variable );

        /// <summary>
        /// <para>Returns the count of items waiting to be added to this <see cref="ParallelList{TType}" />.</para></summary>
        ...
        /// <summary>
        /// <para>Returns the count of items waiting to be changed in this <see cref="ParallelList{TType}" />.</para></summary>
        ...
        /// <summary>
        /// <para>Returns the count of items waiting to be inserted to this <see cref="ParallelList{TType}" />.</para></summary>
        ...
        /// <summary>
        /// <para>Add the <typeparam name="TType">item</typeparam> to the end of this <see cref="ParallelList{TType}" />.</para></summary>
        ...
        /// <summary>
        /// <para>Returns true if the request to remove <paramref name="item" /> was posted.</para></summary>
        /// <param name="item"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// <para>Filter read requests through a <see cref="ReaderWriterLockSlim" />.</para></summary>
        ...
        /// <summary>
        /// <para>Filter write requests through a <see cref="ReaderWriterLockSlim" />.</para></summary>
        /// <typeparam name="TFuncResult"></typeparam>
        /// <param name="func"></param>
