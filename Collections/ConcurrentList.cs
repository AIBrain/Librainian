...
//
// "Librainian/Librainian/ConcurrentList.cs" was last formatted by Protiguous on 2018/05/21 at 10:50 PM.
...
namespace Librainian.Collections {
    ...
    public class ConcurrentList<TType> : ABetterClassDispose, IList<TType>, IEquatable<IEnumerable<TType>> {
        ...
        private void OnDeserialized( StreamingContext context ) {
            ...
            if ( null == this.InputBuffer ) { this.InputBuffer = new ConcurrentQueue<TType>(); }

            if ( null == this.ItemCounter ) { this.ItemCounter = new ThreadLocal<Int32>( valueFactory: () => 0, trackAllValues: true ); }
