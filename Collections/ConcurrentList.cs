...
namespace Librainian.Collections {
    ...
    /// <remarks>
    /// This class was created on a spur of the moment idea, and is <b>thoroughly</b> untested.
    /// </remarks>
    /// <copyright>
    ///     Rick@AIBrain.org
    /// </copyright>
    ...
    public sealed class ConcurrentList<TType> : IList<TType> {
        ...
        /// </summary>
        [NotNull]
        private ThreadLocal<int> ItemCounter { get; set; }
        = new ThreadLocal<int>( ( ) => 0, trackAllValues: true );

        /// <summary>
        /// <para>
        /// Tracks count of times this <see cref="ConcurrentList{TType}" /> has been marked as <see cref="Complete" />.
        /// </para>
        /// </summary>
        ...
        public Span TimeoutForReads { get; }
        = Minutes.One;

        public Span TimeoutForWrites { get; }
        = Minutes.One;
        ...
        /// <see cref="ConcurrentList{TType}" /> and then,
        /// </para>
        /// <para>
