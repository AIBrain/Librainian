...
//
// "Librainian2/AbstractCollection.cs" was last cleaned by Rick on 2014/08/08 at 2:24 PM
...
namespace Librainian.Collections {
    ...
    /// <summary>
    /// Serve as based class to be inherited by the classes that needs to implement both the <see
    /// cref="ICollection" /> and the <see cref="ICollection{T}" /> interfaces.
    /// </summary>
    /// <remarks>
    /// <para> By inheriting from this abstract class, subclass is only required to implement the
    /// <see cref="GetEnumerator()" /> to complete a concrete read only collection class.
    /// </para><para><see cref="AbstractCollection{T}" /> throws <see cref="NotSupportedException"
    ...
    public abstract class AbstractCollection<T> : ICollection<T>, ICollection //NET_ONLY
    {
        ...
        /// implementation counts the elements by iterating through the enumerator returned by <see
        /// cref="GetEnumerator()" /> method.
        /// </summary>
        ...
        /// <summary>
        /// Adds an item to the <see cref="ICollection{T}" />. This implementation always throw <see
        ...
        /// implementation searches the element by iterating through the enumerator returned by <see
        /// cref="GetEnumerator()" /> method.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This method is intentionally sealed. Subclass should override <see cref="DoCopyTo(T[],
        /// int, Boolean)" /> instead.
        /// </remarks>
        /// <param name="array">
        ...
        /// length of array. <br />-or-<br /> The number of elements in the source <see
        /// cref="ICollection{T}" /> is greater than the available space from arrayIndex to the end
        /// of the destination array. <br />-or-<br /> Type T cannot be cast automatically to the
        ...
        /// cref="T:System.Collections.ICollection" /> is greater than the available space from
        ...
        /// false. This method also returns false if item is not found in the original <see
        /// cref="ICollection{T}" /> .
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// <para> Like the <see cref="ToArray()" /> method, this method acts as bridge between
        /// array-based and collection-based APIs. Further, this method allows precise control over
        /// the runtime type of the output array, and may, under certain circumstances, be used to
        /// save allocation costs. </para><para> Suppose <i>x</i> is a collection known to contain
        /// only strings. The following code can be used to dump the collection into a newly
        /// allocated array of <see cref="string" />s: <code language="c#"> string[] y = (string[])
        /// x.ToArray(new string[0]); </code></para><para> Note that <i>ToArray(new T[0])</i> is
        /// identical in function to <see cref="AbstractCollection{T}.ToArray()" />. </para>
        /// </remarks>
        ...
        /// If type of <paramref name="targetArray" /> is a derived type of <typeparamref name="T"
        /// /> and the collection contains element that is not that derived type.
        /// </exception>
        ...
        /// </summary>
        /// <remarks>
        /// <para> The returned array will be "safe" in that no references to it are maintained by
        /// this collection. (In other words, this method must allocate a new array). The caller is
        /// thus free to modify the returned array. </para><para> This method acts as bridge between
        /// array-based and collection-based APIs. </para>
        /// </remarks>
        /// <returns>An array containing all of the elements in this collection.</returns>
        ...
        /// <returns>
        /// A new array of same runtime type as <paramref name="array" /> if <paramref name="array"
        /// /> is too small to hold all elements and <paramref name="ensureCapacity" /> is
        /// <c>false</c>. Otherwise the <paramref name="array" /> instance itself.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// <para> Attempts to <see cref="AddRange" /> of a collection to itself result in <see
        /// cref="ArgumentException" /> . Further, the behavior of this operation is undefined if
        /// the specified collection is modified while the operation is in progress. </para><para>
        ...
        /// successfully added when the associated exception is thrown. </para>
        /// </remarks>
