...
namespace Librainian.Collections {
    ...
    /// <summary>
    ///     Serve as based class to be inherited by the classes that needs to implement both the
    ///     <see
    ///         cref="ICollection" />
    ///     and the <see cref="ICollection{T}" /> interfaces.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    public abstract class AbstractCollection< T > : ICollection< T >, ICollection //NET_ONLY
    {
        ...
        /// <remarks>
        ///     <para>
        ///         Like the <see cref="ToArray()" /> method, this method acts as bridge between
        ...
        ///         identical in function to <see cref="AbstractCollection{T}.ToArray()" />.
        ///     </para>
        /// </remarks>
        ...
        ///     If type of <paramref name="targetArray" /> is a derived type of <typeparamref name="T" /> and the collection
        ///     contains element that is not that derived type.
        /// </exception>
        ...
        ///     elements and <paramref name="ensureCapacity" /> is
        ...
        ///         . Further, the behavior of this operation is undefined if
