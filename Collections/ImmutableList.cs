...
namespace Librainian.Collections {
    ...
    /// <summary>
    /// A list that has been written to be observationally immutable. A mutable array is used as the
    /// backing store for the list, but no mutable operations are offered.
    /// </summary>
