...
//
// =========================================================
// This section of source code, "ImmutableList.cs",
...
//
// "Librainian/Librainian/ImmutableList.cs" was last cleaned by Protiguous on 2018/05/15 at 10:37 PM.
...
namespace Librainian.Collections {
    ...
    public sealed class ImmutableList<T> : IList<T> {
        ...
        public Boolean Contains( T item ) => Array.IndexOf( array: this._mArray, item ) != -1;
        ...
        public Int32 IndexOf( T item ) => Array.IndexOf( array: this._mArray, item );
