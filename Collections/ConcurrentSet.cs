...
// 
// "Librainian/ConcurrentSet.cs" was last cleaned by Rick on 2015/06/12 at 2:50 PM
...
namespace Librainian.Collections {
    ...
    public class ConcurrentSet<T> : ISet<T> {
        ...
        /// </exception>
        public void CopyTo(T[] array, Int32 arrayIndex) => this.Values.CopyTo( array, arrayIndex );
        ...
        /// </summary>
        /// <returns>
        /// true if the <see cref="T:System.Collections.Generic.ISet`1" /> object is a correct
        /// superset of <paramref name="other" />; otherwise, false.
        /// </returns>
        /// <param name="other">The collection to compare to the current set.</param>
        /// <exception cref="T:System.ArgumentNullException">
        /// <paramref name="other" /> is null.
        ...
        /// <returns>
        /// true if the current set and <paramref name="other" /> share at least one common element;
        /// otherwise, false.
        /// </returns>
        /// <param name="other">The collection to compare to the current set.</param>
        /// <exception cref="T:System.ArgumentNullException">
