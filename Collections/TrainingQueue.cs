...
//
// ========================================================= This section of source code, "TrainingQueue.cs", belongs to Rick@AIBrain.org and Protiguous@Protiguous.com unless otherwise specified OR the original license
...
//
// "Librainian/TrainingQueue.cs" was last cleaned by Protiguous on 2018/05/15 at 1:29 AM.
...
namespace Librainian.Collections {
    ...
    public class TrainingQueue : ABetterClassDispose {
        ...
        public void Wait() {
            ...
            //this.bob.Reset();
            while ( !this.Items.Any() ) { this._bob.WaitOne( timeout: TimeSpan.FromMilliseconds( value: 1234 ) ); }
