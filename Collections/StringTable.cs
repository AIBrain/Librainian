...
//
// ========================================================= This section of source code, "StringTable.cs", belongs to Rick@AIBrain.org and Protiguous@Protiguous.com unless otherwise specified OR the original license has
...
//
// "Librainian/StringTable.cs" was last cleaned by Protiguous on 2018/05/15 at 1:29 AM.
...
namespace Librainian.Collections {
    ...
    public class StringTable {
        ...
        public Boolean Contains( String word ) {
            if ( String.IsNullOrEmpty( value: word ) ) { return false; }
