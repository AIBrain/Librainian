(function() {
    ...
    if (La) {
        ...
        var mb = (new Date).getTime(),
            ob = window.google_top_experiment, pb = ["<!doctype html><html><body><", _script$$inline_89, ">", ab, "google_show_ads_impl=true;google_unique_id=", F.google_unique_id, ';google_async_iframe_id="', U, '";google_start_time=', k, ";", ob ? 'google_top_experiment="' + ob + '";' : "", Qa ? 'google_adk_sa="' + Qa + '";' : "", "google_bpp=", mb > k ? mb - k : 1, ";</", _script$$inline_89, ">", Ba(), "</body></html>"].join("");
