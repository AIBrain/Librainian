...
//  
// "Librainian/NetworkAdapter.cs" was last cleaned by Rick on 2015/11/13 at 11:31 PM
    ...
    public class NetworkAdapter {
        ...
        public NetworkAdapter( Int32 deviceId ) {
            ...
            try {
                ...
                var crtNetworkAdapter = networkAdapters.Cast< ManagementBaseObject >()
                                                       .Select( o => o as ManagementObject )
                                                       .FirstOrDefault();
                ...
                if ( Convert.ToBoolean( crtNetworkAdapter[ "NetEnabled" ].ToString() ) ) {
                    this.NetEnabled = ( Int32 ) EnumNetEnabledStatus.Enabled;
                }
                else {
                    this.NetEnabled = ( Int32 ) EnumNetEnabledStatus.Disabled;
                }
        ...
        /// </summary>
        public Int32 NetConnectionStatus { get; private set; }

        /// <summary>
        ///     The NetEnabled status of the NetworkAdapter
        /// </summary>
        public Int32 NetEnabled { get; private set; }
        ...
        public Int32 EnableOrDisableNetworkAdapter( String strOperation ) {
            ...
            try {
                ...
                Task.Delay( Milliseconds.OneHundred )
                    .Wait();
        ...
        public Int32 GetNetEnabled() {
            ...
            try {
                ...
                foreach ( var networkAdapter in networkAdapters.Cast< ManagementBaseObject >()
                                                               .Select( o => o as ManagementObject ) ) {
