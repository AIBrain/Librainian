...
//
// This source code contained in "CryptUtility.cs" belongs to Rick@AIBrain.org and
...
//
// "Librainian/Librainian/CryptUtility.cs" was last formatted by Protiguous on 2018/05/24 at 7:32 PM.
...
namespace Librainian.Security {
    ...
    public class CryptUtility {
        ...
        private static MemoryStream GetKeyStream( IReadOnlyList<FilePasswordPair> keys ) {
            ...
            var maxLength = keyStreams.Select( selector: stream => stream.Length ).Concat( second: new Int64[] { 0 } ).Max();
