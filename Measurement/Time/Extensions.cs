...
namespace Librainian.Measurement.Time {
    ...
    public static class Extensions {
        ...
        /// of the next month is used. Eg, 2013-01-31T06:40:20.005
    ...
    public static class DurationParser {
        private static readonly Regex _regex = new Regex( "(?<Value>[\\-0-9]+)\\s*(?<Unit>[a-z]+)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant );
