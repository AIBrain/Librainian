...
// 
// "Librainian/DurationParser.cs" was last cleaned by Rick on 2015/06/12 at 3:02 PM
...
namespace Librainian.Measurement.Time {
    ...
    public static class DurationParser {
        private static readonly Regex Regex = new Regex( "(?<Value>[\\-0-9]+)\\s*(?<Unit>[a-z]+)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant );
        ...
        public static Boolean TryParse(String str, out TimeSpan ts) {
            String failReason;
        ...
        /// </param>
        /// <returns>True if the parsing was successful; otherwise false.</returns>
        public static Boolean TryParse(String str, out TimeSpan ts, out String failReason) {
