...
// 
// "Librainian/Attoseconds.cs" was last cleaned by Rick on 2015/06/12 at 3:02 PM
...
namespace Librainian.Measurement.Time {
    ...
    public struct Attoseconds : IComparable<Attoseconds>, IQuantityOfTime {
        ...
        public override String ToString() {
            return this.Value > Decimal.MaxValue ? $"{this.Value.GetWholePart()} as" : $"{( Decimal )this.Value} as";
        }
