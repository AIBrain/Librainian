...
namespace Librainian.Measurement.Time {
    ...
    /// \hbar in the definition[1]) G = gravitational constant c = speed of light in a vacuum s is
    /// the SI unit of time, the second. The two digits between parentheses denote the standard
