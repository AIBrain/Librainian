...
namespace Librainian.Measurement.Time {
    ...
    public static class TimeExtensions {
        ...
        /// <summary> <para>Determines if the specified year is a leap year.</para> </summary> <returns></returns> <param name="year">Year to test.</param> <copyright> Tommy Dugger & Jared Chavez </copyright>
        ...
        /// = &gt; 2013-01-05T06:40:20.005 If the next month doesn't have that many days the last day of the next month is used. Eg, 2013-01-31T06:40:20.005
        ...
        /// <summary>
        /// Returns the same date (same Day, Month, Hour, Minute, Second etc) in the next calendar year. If that day does not exist in next year in same month, number of missing days is added to the last day in same month
        /// next year.
        /// </summary>
        ...
        /// <summary>
        /// Returns the previous month keeping the time component intact. Eg, 2010-01-20T06:40:20.005 =&gt; 2009-12-20T06:40:20.005 If the previous month doesn't have that many days the last day of the previous month is
        ...
        /// <summary>
        /// Returns the same date (same Day, Month, Hour, Minute, Second etc) in the previous calendar year. If that day does not exist in previous year in same month, number of missing days is added to the last day in
