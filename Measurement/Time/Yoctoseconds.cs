...
// 
// "Librainian/Yoctoseconds.cs" was last cleaned by Rick on 2015/06/12 at 3:03 PM
...
namespace Librainian.Measurement.Time {
    ...
    public struct Yoctoseconds : IComparable<Yoctoseconds>, IQuantityOfTime {
        ...
        public override String ToString() {
            return this.Value > Decimal.MaxValue ? $"{this.Value.GetWholePart()} ys" : $"{( Decimal ) this.Value} ys";
        }
