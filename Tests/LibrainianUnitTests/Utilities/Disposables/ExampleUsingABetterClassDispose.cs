...
//
// File "ExampleUsingABetterClassDispose.cs" last touched on 2021-11-30 at 7:23 PM by Protiguous.
...
/// <summary>A fake COM interface object.</summary>
public class SysComObject {
	...
	public void ReserveMemory() {
		...
		Debug.Assert( this.fakeInternalMemoryAllocation != null, "" );
		TestContext.WriteLine( $"{this.fakeInternalMemoryAllocation.Length} bytes allocated to fake COM object." );
	}
}