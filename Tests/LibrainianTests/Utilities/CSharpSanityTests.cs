...
//
// File "CSharpSanityTests.cs" last touched on 2022-01-22 at 1:05 AM by Protiguous.

namespace TestBigDecimal.Utilities;

using FluentAssertions;
using NUnit.Framework;

[TestFixture]
public static class CSharpSanityTests {

	[Test]
	public static void TestVarIsStillValue3() {
		var a = 1;
		var b = 2;
		var result = a + b;
		result.Should()!.Be( 3 );
	...
	[Test]
	public static void TestVarIsStillValueFalse() {
		var result = !true;
		result.Should()!.BeFalse();
	}

	[Test]
	public static void TestVarIsStillValueTrue() {
		var result = true;
