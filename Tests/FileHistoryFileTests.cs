...
//
// This source code, "FileHistoryFileTests.cs", belongs to Rick@AIBrain.org and Protiguous@Protiguous.com
...
//
// "Librainian/LibrainianTests/FileHistoryFileTests.cs" was last formatted by Protiguous on 2018/05/20 at 5:56 PM.
...
namespace LibrainianTests {
    ...
    public static class FileHistoryFileTests {
        ...
        public static void RunTests() {
            ...
            if ( !FileHistoryFileExtensions.TryParseFileHistoryFile( new Document( Example ), out _, out _, out _ ) ) { throw new InvalidCastException(); }
        }
