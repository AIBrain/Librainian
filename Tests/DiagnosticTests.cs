...
// 
// Project: "LibrainianTests", "DiagnosticTests.cs" was last formatted by Protiguous on 2018/10/06 at 5:00 AM.
...
namespace LibrainianTests {
    ...
    public static class DiagnosticTests {
        ...
        private static void AddToList( [NotNull] this ConcurrentBag<Int32> list ) {
            ...
            Parallel.ForEach( 1.To( 128 ), ThreadingExtensions.AllCPUExceptOne, i => list.Add( Int32.MinValue.Next( maxValue: Int32.MaxValue ) ) );
        }
