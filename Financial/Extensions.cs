...
// 
// "Librainian/Extensions.cs" was last cleaned by Rick on 2015/06/12 at 2:54 PM
...
namespace Librainian.Financial {
    ...
    public static class Extensions {
        ...
        [NotNull]
        public static HashSet<IDenomination> PossibleDenominations {
            get;
        }
        = new HashSet<IDenomination>();
        ...
        /// <summary>
        /// Transfer everything FROM the <paramref name="source" /><see cref="Wallet" /> into this <paramref name="target" /><see cref="Wallet" />.
        /// </summary>
