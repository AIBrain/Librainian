...
//
// File "Crc32.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
/// <remarks>
/// Crc32 should only be used for backward compatibility with older file formats and algorithms. It is not secure enough for
/// new applications. If you need to call multiple times for the same data either use the HashAlgorithm interface or remember
/// that the result of one Compute call needs to be ~ (XOR) before being passed in as the seed for the next Compute call.
/// </remarks>
/// <copyright>
