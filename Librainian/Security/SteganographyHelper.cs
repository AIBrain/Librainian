...
//
// This source code contained in "SteganographyHelper.cs" belongs to Protiguous@Protiguous.com and
...
//
// Project: "Librainian", "SteganographyHelper.cs" was last formatted by Protiguous on 2018/07/13 at 1:38 AM.
					...
					for ( var n = 0; n < 3; n++ ) {
						...
						if ( pixelElementIndex % 8 == 0 ) {
							...
							if ( state == State.FillingWithZeros && zeros == 8 ) {
								...
								if ( ( pixelElementIndex - 1 ) % 3 < 2 ) { bmp.SetPixel( x: j, y: i, color: Color.FromArgb( red: r, green: g, blue: b ) ); }
