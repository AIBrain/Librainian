...
//
// File "LazyAsync.cs" last formatted on 2021-11-30 at 7:23 PM by Protiguous.
...
/// <summary>Provides support for asynchronous lazy initialization. This type is fully threadsafe.</summary>
...
public sealed class LazyAsync<T> {
	...
	/// <summary>The underlying lazy task.</summary>
	private readonly Lazy<Task<T>> instance;

	/// <summary>Initializes a new instance of the <see cref="LazyAsync{T}" /> class.</summary>
	...
	/// <summary>Starts the asynchronous initialization, if it has not already started.</summary>
