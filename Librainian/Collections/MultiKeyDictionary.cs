...
//
// Project: "Librainian", File: "MultiKeyDictionary.cs" was last formatted by Protiguous on 2020/03/16 at 2:53 PM.
...
namespace Librainian.Collections {
    ...
    public class MultiKeyDictionary<TK, TL, TV> : ConcurrentDictionary<TK, TV> {
        ...
        public new Boolean TryGetValue( [NotNull] TK primaryKey, out TV val ) => base.TryGetValue( key: primaryKey, value: out val );
    }
}