...
//
// File "ConcurrentList.cs" last formatted on 2021-11-30 at 7:16 PM by Protiguous.
...
public class ConcurrentList<T> : ABetterClassDispose, IList<T?> /*, IEquatable<IEnumerable<T>>*/ {
	...
	/// <summary>
	/// <para><exception cref="IndexOutOfRangeException" /> will be thrown.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>Throw <exception cref="ObjectDisposedException" /> when list has been disposed.</para>
	...
	/// <summary>
	/// <para>Add the <typeparam name="T">item</typeparam> to the end of this <see cref="ConcurrentList{TType}" />.</para>
	/// </summary>
	...
	/// <summary>
	/// <para>
	/// Determines whether the <paramref name="item" /> is in this <see cref="ConcurrentList{TType}" /> at this moment in time.
	/// </para>
	/// </summary>
	...
	/// <summary>
	/// <para>
	/// Searches at this moment in time for the first occurrence of <paramref name="item" /> and returns the zero-based index,
	/// or -1 if not found.
	/// </para>
	/// </summary>
	...
	/// <summary>
	/// <para>
	/// Requests an insert of the <paramref name="item" /> into this <see cref="ConcurrentList{TType}" /> at the specified
	/// <paramref name="index" />.
	/// </para>
	/// </summary>
	/// <param name="index"></param>
