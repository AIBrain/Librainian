...
// 
// File "VirtualList.cs" last formatted on 2020-08-14 at 8:31 PM.
...
namespace Librainian.Collections.Lists {
	...
	/// <example>
	///     var pi = new VirtualList(Double)(int.MaxValue, i =&gt; Math.Pow(-1d, i) / (2 * i + 1) * 4)
	///     .AsParallel().Aggregate(() = &gt; 0d, (tot, next) =&gt; tot + next,
