...
//
// File "AsyncList.cs" last formatted on 2021-11-30 at 7:16 PM by Protiguous.
...
[NeedsTesting]
public class AsyncList<T> : ABetterClassDispose, IList<T?> {
	...
	/// <summary>
	/// <para>
	/// If <see cref="ThrowExceptions" /> is set to <see cref="ThrowSetting.Throw" />, then <exception
	/// cref="ObjectDisposedException" /> will be thrown.
	/// </para>
	...
	/// <para>
	/// If <see cref="ThrowExceptions" /> is set to <see cref="ThrowSetting.Throw" />, then <exception
	/// cref="ArgumentOutOfRangeException" /> will be thrown.
	/// </para>
	/// </summary>
	...
	/// <summary>
	/// Copies the entire <see cref="AsyncList{T}" /> to the <paramref name="array" />, starting at the specified index in the
	/// target array.
	/// </summary>
	...
	/// <summary>
	/// <para>
	/// Requests an insert of the <paramref name="item" /> into this <see cref="AsyncList{T}" /> at the specified <paramref
	/// name="index" />.
	/// </para>
	/// </summary>
	/// <param name="index"></param>
