...
// 
// This source code contained in "QueueWaiting.cs" belongs to Protiguous@Protiguous.com
...
// 
// Project: "Librainian", "QueueWaiting.cs" was last formatted by Protiguous on 2020/01/31 at 12:24 AM.
...
namespace Librainian.Collections.Queues {
    ...
    public class QueueWaiting<T> : ABetterClassDispose, IEnumerable<T> where T : class {
        ...
        /// <summary>Pulls out the next <see cref="T" /> in the <see cref="Queue" /> or null.</summary>
        /// <returns></returns>
        [CanBeNull]
