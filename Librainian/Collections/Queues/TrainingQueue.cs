...
// 
// This source code contained in "TrainingQueue.cs" belongs to Protiguous@Protiguous.com and
...
// 
// Project: "Librainian", "TrainingQueue.cs" was last formatted by Protiguous on 2019/02/13 at 3:00 PM.
    ...
    public class TrainingQueue : ABetterClassDispose {
        ...
        public void Wait() {
            ...
            while ( !this.Items.Any() ) {
                this.Bob.WaitOne( timeout: TimeSpan.FromMilliseconds( 1234 ) );
            }
