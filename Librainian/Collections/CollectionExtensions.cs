...
namespace Librainian.Collections {
    ...
    public static class CollectionExtensions {
        ...
        public static void AddRange<T>([NotNull] this IProducerConsumerCollection<T> collection, [NotNull] IEnumerable<T> items) {
            ...
            Parallel.ForEach(source: items.AsParallel(), parallelOptions: ThreadingExtensions.AllCPUExceptOne, body: collection.Add);
        }
        ...
        public static Boolean AnyDuplicates<T>([NotNull] this IEnumerable<T> self) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "AnyDuplicates<T> called on a null IEnumerable<T>."); }
        ...
        public static Boolean AnyRelationship<T>([NotNull] this IEnumerable<T> self, Func<T, T, Boolean> relationshipFunc) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "AnyRelationship called on a null IEnumerable<T>."); }
        ...
        public static Boolean AtLeast<T>([NotNull] this IEnumerable<T> self, UInt64 minInstances, [NotNull] Func<T, Boolean> predicate) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "AtLeast called on a null IEnumerable<>."); }
        ...
        public static Boolean AtMost<T>([NotNull] this IEnumerable<T> self, UInt64 maxInstances, [NotNull] Func<T, Boolean> predicate) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "AtMost called on a null IEnumerable<>."); }
        ...
        public static IDictionary<T, Int32> CountInstances<T>([NotNull] this IEnumerable<T> self) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "CountInstances called on a null IEnumerable<T>."); }
        ...
        public static Int32 CountRelationship<T>([NotNull] this IEnumerable<T> self, Func<T, T, Boolean> relationshipFunc) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "CountRelationship called on a null IEnumerable<T>."); }
        ...
        public static KeyValuePair<T, T>? FirstRelationship<T>([NotNull] this IEnumerable<T> self, [NotNull] Func<T, T, Boolean> relationshipFunc) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "FirstRelationship called on a null IEnumerable<T>."); }

            if (relationshipFunc == null) { throw new ArgumentNullException(nameof(relationshipFunc)); }
            ...
            if (list != null) {
                ...
                foreach (var record in list) {
                    ...
                    foreach (var p in columns) {
                        if (p.GetValue(record, index: null) == null) { dr[columnName: p.Name] = DBNull.Value; }
        ...
        */
        ...
        public static IEnumerable<KeyValuePair<T, T>> WhereRelationship<T>([NotNull] this IEnumerable<T> self, [NotNull] Func<T, T, Boolean> relationshipFunc) {
            if (self == null) { throw new ArgumentNullException(nameof(self), "WhereRelationship called on a null IEnumerable<T>."); }
