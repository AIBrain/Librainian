...
//
// Project: "Librainian", "LockfreeQueue.cs" was last formatted by Protiguous on 2018/07/10 at 8:51 PM.
    ...
    public class LockfreeQueue<T> : IEnumerable<T> where T : class
    {
        ...
        public void Enqueue(T item)
        {
            ...
            while (!newNodeWasAdded)
            {
                ...
                if (oldTailNext == null) { newNodeWasAdded = Interlocked.CompareExchange(location1: ref this._tail.Next, newNode, comparand: null) == null; }
