...
namespace Librainian.Collections.Sets {
    ...
    public class ConcurrentSet<T> : ISet<T> {
        ...
        ///     <see cref="ICollection" /> is greater than the available space from
        ///     <paramref
        ///         name="arrayIndex" />
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="IEnumerator" /> that can be used to iterate through the
        ///     collection.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     true if the set object is a correct superset of
        ...
        ///     <see cref="ICollection" />; otherwise, false. This method also returns false if
        ///     <paramref name="item" /> is not
        ///     found in the original <see cref="ICollection" />.
        /// </returns>
        /// <param name="item">The object to remove from the <see cref="ICollection" />.</param>
        /// <exception cref="NotSupportedException">
        ///     The <see cref="ICollection" /> is
        ///     read-only.
        /// </exception>
        public Boolean Remove( T item ) => item != null && this.TryRemove( item );
