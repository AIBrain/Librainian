...
namespace Librainian.Collections {
	...
	public class BidirectionalDictionary<TSingle, TPlural> where TSingle : class where TPlural : class {
		...
		public virtual TPlural? GetPlural( [NotNull] TSingle value ) =>
			this.SingleToPlural.TryGetValue( value, out var second ) ? second : default( TPlural? );

		public virtual TSingle? GetSingle( [NotNull] TPlural value ) =>
			this.PluralToSingle.TryGetValue( value, out var first ) ? first : default( TSingle? );
