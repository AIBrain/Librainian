...
//
// Project: "Librainian", File: "StringKVPTable.cs" was last formatted by Protiguous on 2020/03/16 at 3:01 PM.
...
namespace Librainian.Persistence {
    ...
    [JsonObject]
    [SuppressMessage( category: "ReSharper", checkId: "NotNullMemberIsNotInitialized" )]
    public sealed class StringKVPTable : ABetterClassDispose, IDictionary<String, String> {
        ...
        public void Add( String key, [CanBeNull] String? value ) => this[ key: key ] = value;
        ...
        public Boolean Contains( KeyValuePair<String, String> item ) {
            if ( item.Value != null ) {
                ...
                var asItem = new KeyValuePair<String, String>( key: item.Key, value: value );
...
#pragma warning restore CA1043 // Use Integral Or String Argument For Indexers
            ...
            get {
                ...
                var key = Cache.BuildKey( things: keys );
        ...
        public StringKVPTable( Byte specialFolder, [CanBeNull] String? subFolder, [NotNull] String tableName ) : this(
            folder: new Folder( specialFolder: ( Environment.SpecialFolder )specialFolder, applicationName: subFolder, subFolder: tableName ) ) { }
        ...
        public StringKVPTable( [NotNull] Folder folder, [NotNull] String subFolder, [NotNull] String tableName ) : this( fullpath: Path.Combine( path1: folder.FullPath,
        ...
        private async Task<Boolean> TestForReadWriteAccess() {
            try {
                ...
                using var cancel = new CancellationTokenSource( delay: Seconds.Ten );

                await document.TryDeleting( delayBetweenRetries: Seconds.One, token: cancel.Token ).ConfigureAwait( continueOnCapturedContext: false );
        ...
        public void Add( (String key, String value) kvp ) => this[ key: kvp.key ] = kvp.value;
