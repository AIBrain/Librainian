...
// 
// File "Settings.cs" last formatted on 2020-08-14 at 8:44 PM.
...
namespace Librainian.Persistence {
	...
	public static class Settings {
		...
		/// <returns></returns>
		[CanBeNull]
		public static Object? GetObject( this TrimmedString location, TrimmedString key ) => AppRegistry.Get( location, key );
		...
		/// <returns></returns>
		[CanBeNull]
		public static Object? GetObject( this TrimmedString location, TrimmedString key, TrimmedString subkey ) => AppRegistry.Get( location, key, subkey );

		/*
		[CanBeNull]
		public static String? GetString( TrimmedString location, TrimmedString key ) {

			var o = location.GetObject( key );
