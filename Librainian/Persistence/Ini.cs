...
//
// Project: "Librainian", "Ini.cs" was last formatted by Protiguous on 2018/09/24 at 4:36 AM.
...
namespace Librainian.Persistence {
    ...
    public class Ini : IEquatable<Ini> {
        ...
        public Ini([NotNull] Document document, CancellationTokenSource cancellationSource = null) {
            ...
            if (cancellationSource == null) { cancellationSource = new CancellationTokenSource(delay: Seconds.Ten); }
