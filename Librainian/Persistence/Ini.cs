...
// 
// Project: "Librainian", "Ini.cs" was last formatted by Protiguous on 2018/11/19 at 8:55 PM.
		...
		public Task<Boolean> ReloadAsync( CancellationToken token = default ) {
			...
			return Task.Run( function: () => {
				...
				try {
					...
					var result = Parallel.ForEach( source: data.Keys.AsParallel(), parallelOptions: ThreadingExtensions.AllCPUExceptOne,
						body: section => Parallel.ForEach( source: data[ section ].Keys.AsParallel(), parallelOptions: ThreadingExtensions.AllCPUExceptOne,
