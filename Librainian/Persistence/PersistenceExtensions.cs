...
// 
// Project: "Librainian", "PersistenceExtensions.cs" was last formatted by Protiguous on 2018/09/16 at 10:31 AM.
...
namespace Librainian.Persistence {
    ...
    public static class PersistenceExtensions {
        ...
        public static Boolean Loader<TSource>( [NotNull] this String fullPathAndFileName, [CanBeNull] Action<TSource> onLoad = null, [CanBeNull] ProgressChangedEventHandler feedback = null ) where TSource : class {
            if ( fullPathAndFileName == null ) { throw new ArgumentNullException( nameof( fullPathAndFileName ) ); }
