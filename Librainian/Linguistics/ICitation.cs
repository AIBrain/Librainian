...
//
// File "ICitation.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
...
public interface ICitation {
	...
	/// <summary>A sentence, page, book, internet</summary>
	[JsonProperty]
	...
	public Boolean Add( [NotNull] Uri location ) {
		this.Location = location ?? throw new NullException( nameof( location ) );
