...
//
// Project: "Librainian", File: "UDC.cs" was last formatted by Protiguous on 2020/03/16 at 3:03 PM.
...
namespace Librainian.Linguistics {
    ...
    public class UDC {
        ...
        [NotNull]
        public static UDC Unknown { get; } = new UDC( notation: String.Empty );

        [NotNull]
        public String Notation { get; }

        public UDC( [NotNull] String notation ) => this.Notation = notation.Trimmed() ?? throw new InvalidOperationException( message: $"Invalid {nameof( this.Notation )}." );
