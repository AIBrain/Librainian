...
//
// File "BackgroundThread.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
/// <summary>
/// Accepts an <see cref="Action" /> to perform (in a loop) when the <see cref="signal" /> is Set ( <see cref="Proceed" />).
/// </summary>
