...
//
// This source code contained in "CustomAttribute.cs" belongs to Protiguous@Protiguous.com and
...
//
// Project: "Librainian", "CustomAttribute.cs" was last formatted by Protiguous on 2019/08/08 at 9:36 AM.
...
namespace Librainian.Threading {
    ...
    public class CustomAttribute : Attribute {
        ...
        static CustomAttribute() {
            MethodsList = new List<MethodInfo>( Assembly.GetExecutingAssembly().GetTypes().SelectMany( t => t.GetMethods() )
                .Where( m => m.GetCustomAttributes( typeof( CustomAttribute ), false ).Length > 0 ) );

            MethodsList.AddRange( Assembly.GetCallingAssembly().GetTypes().SelectMany( t => t.GetMethods() )
                .Where( m => m.GetCustomAttributes( typeof( CustomAttribute ), false ).Length > 0 ) );
        }
