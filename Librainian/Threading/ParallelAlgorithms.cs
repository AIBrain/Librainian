...
namespace Librainian.Threading
{
    ...
    public static class ParallelAlgorithms
    {
        ...
        public static TResult SpeculativeFor<TResult>(this Int32 fromInclusive, Int32 toExclusive, Func<Int32, TResult> body) => fromInclusive.SpeculativeFor(toExclusive, ThreadingExtensions.AllCPUExceptOne, body);
        ...
        /// <param name="body">  The function to execute for each element.</param>
        /// <returns>The result computed.</returns>
        public static TResult SpeculativeForEach<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, TResult> body) => source.SpeculativeForEach(ThreadingExtensions.AllCPUExceptOne, body);
        ...
        public static T SpeculativeInvoke<T>(params Func<T>[] functions) => ThreadingExtensions.AllCPUExceptOne.SpeculativeInvoke(functions);
        ...
        public static void Wavefront([NotNull] this Action<Int32, Int32, Int32, Int32> processBlock, Int32 numRows, Int32 numColumns, Int32 numBlocksPerRow, Int32 numBlocksPerColumn)
        {
            ...
            if (processBlock == null) { throw new ArgumentNullException(nameof(processBlock)); }
