...
//
// File "CPU.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
public static class CPU {
	...
	/// <summary>
	/// <para>
	/// Sets the <see cref="ParallelOptions.MaxDegreeOfParallelism" /> of a <see cref="ParallelOptions" /> to <see
	...
	/// <para>
	/// Sets the <see cref="ParallelOptions.MaxDegreeOfParallelism" /> of a <see cref="ParallelOptions" /> to <see
	/// cref="Environment.ProcessorCount" />-1.
	/// </para>
	/// <para>1 core to 1</para>
	...
	/// <summary>
	/// <para>
	/// Sets the <see cref="ParallelOptions.MaxDegreeOfParallelism" /> of a <see cref="ParallelOptions" /> to half of <see
	/// cref="Environment.ProcessorCount" />.
	/// </para>
	/// <para>1 core to 1?</para>
	/// <para>2 cores to 1</para>
	...
	/// <para>
	/// Sets the <see cref="ParallelOptions.MaxDegreeOfParallelism" /> of a <see cref="ParallelOptions" /> to <see
	/// cref="Environment.ProcessorCount" /> * 2.
	/// </para>
	...
	/// <summary>Set MaxDegreeOfParallelism to half of maximum CPU processors.</summary>
