...
// 
// File "AsyncLock.cs" last formatted on 2020-08-14 at 8:46 PM.
...
namespace Librainian.Threading {
	...
	public sealed class AsyncLock : ABetterClassDispose {
		...
		public Task<IDisposable> LockAsync() {
			...
			return wait.IsCompleted ? this._releaser : wait.ContinueWith( ( _, state ) => ( IDisposable )state, this._releaser.Result, CancellationToken.None,
