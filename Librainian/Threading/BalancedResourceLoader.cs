...
namespace Librainian.Threading {
    ...
    public class BalancedResourceLoader<T> : IResourceLoader<T> {
        ...
        public Int32 Available {
            get { return this._resourceLoaders.Sum( r => r.Available ); }
        }

        public Int32 Count {
            get { return this._resourceLoaders.Sum( r => r.Count ); }
        }

        public Int32 MaxConcurrency {
            get { return this._resourceLoaders.Sum( r => r.MaxConcurrency ); }
        }
        ...
        [NotNull]
        private readonly Queue<(TaskCompletionSource<T>, CancellationToken)> _queue = new Queue<(TaskCompletionSource<T>, CancellationToken)>();
