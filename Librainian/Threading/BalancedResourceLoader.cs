...
//
// File "BalancedResourceLoader.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
public class BalancedResourceLoader<T> : IResourceLoader<T> {
	...
	public BalancedResourceLoader( IList<IResourceLoader<T>> resourceLoaders ) =>
		this._resourceLoaders = resourceLoaders ?? throw new NullException( nameof( resourceLoaders ) );
