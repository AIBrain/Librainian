...
//
// Project: "Librainian", "Volatiles.cs" was last formatted by Protiguous on 2018/08/28 at 10:17 PM.
...
namespace Librainian.Threading
{
    ...
    public static class Volatiles
    {
        ...
        public struct Reference<T> where T : class
        {
            ...
            /// <param name="comparand">The comparand (expected value)</param>
            /// <returns></returns>
            public Boolean AtomicCompareExchange(T newValue, [CanBeNull] T comparand) => Interlocked.CompareExchange(location1: ref this._value, newValue, comparand: comparand) == comparand;
