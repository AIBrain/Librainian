...
//
// File "ObjectExtensions.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
/// <summary>
/// Code pulled from <see
/// cref="http://raw.githubusercontent.com/Burtsev-Alexey/net-object-deep-copy/master/ObjectExtensions.cs" />
/// </summary>
/// <remarks>TODO Needs some serious testing.</remarks>
[NeedsTesting]
public static class ObjectExtensions {
	...
	public static Object? GetPrivateFieldValue<T>( [DisallowNull] this T instance, String fieldName ) {
		if ( instance is null ) {
			throw new NullException( nameof( instance ) );
		}

		if ( String.IsNullOrWhiteSpace( fieldName ) ) {
			throw new NullException( nameof( fieldName ) );
		}
		...
		if ( info is null ) {
			throw new NullException( $"{type.FullName} does not contain the private field '{fieldName}'." );
		}
