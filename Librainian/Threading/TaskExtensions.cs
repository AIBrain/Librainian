...
// 
// File "TaskExtensions.cs" last touched on 2021-10-13 at 4:31 PM by Protiguous.
...
public static class TaskExtensions {
	...
	*/
	...
	/// <summary>
	///     Return items in <paramref name="self" /> until <paramref name="timeSpan" /> elapses.
	/// </summary>
	/// <typeparam name="T"></typeparam>
	...
	/// <summary>
	///     Return each item in <paramref name="self" /> until <paramref name="timeSpan" /> elapses.
	/// </summary>
	/// <typeparam name="T"></typeparam>
	/// <param name="self">    </param>
	/// <param name="timeSpan"></param>
