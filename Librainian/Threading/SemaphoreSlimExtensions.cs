...
//
// File "SemaphoreSlimExtensions.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
public static class SemaphoreSlimExtensions {
	...
	public static async Task<IDisposable> UseWaitAsync( this SemaphoreSlim semaphore, CancellationToken cancelToken = default ) {
		if ( semaphore is null ) {
			throw new NullException( nameof( semaphore ) );
		}
	...
	private class ReleaseWrapper : IDisposable {
		...
		public ReleaseWrapper( SemaphoreSlim semaphore ) => this._semaphore = semaphore ?? throw new NullException( nameof( semaphore ) );
