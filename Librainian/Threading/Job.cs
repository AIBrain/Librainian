...
namespace Librainian.Threading {
	...
	/// <summary>
	/// <para>A task with a maximum time to run before a cancel is thrown (<see cref="TaskCanceledException"/> which sometimes can be thrown as <see cref="OperationCanceledException"/>, I think).</para>
	/// </summary>
