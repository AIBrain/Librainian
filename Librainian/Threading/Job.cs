...
//
// File "Job.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
/// <summary>
/// <para>
/// A task with a maximum time to run before a cancel is thrown ( <see cref="TaskCanceledException" /> which sometimes can be
/// thrown as <see cref="OperationCanceledException" />, I think).
/// </para>
/// </summary>
[NeedsTesting]
public class Job<T> : ABetterClassDispose {
	...
	/// <summary>
	/// Move the <see cref="EstimatedTimeRemaining" /> TODO Needs tested..am I thinking right about this? Has no effect if the
	/// task is <see cref="IsDone" />.
	/// </summary>
	...
	/// <summary>
	/// Increase the <see cref="MaxRunningTime" /> by a <paramref name="amountOfTime" />. Has no effect if the task is done.
	/// </summary>
