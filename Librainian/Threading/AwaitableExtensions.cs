...
//
// Project: "Librainian", File: "AwaitableExtensions.cs" was last formatted by Protiguous on 2020/03/16 at 3:02 PM.
...
namespace ExtremeConfigAwait {
        ...
        public struct SynchronizationContextRemover : INotifyCompletion {
            ...
            public void OnCompleted( [CanBeNull] Action continuation ) {
                ...
                try {
                    ...
                    SynchronizationContext.SetSynchronizationContext( syncContext: prevContext );
                }
            }
        }
    }
    ...
    public static class AwaitableExtensions {
        ...
        private static void PrintContext( [CallerMemberName] [CanBeNull] String? callerName = null, [CallerLineNumber] Int32 line = 0 ) {
            ...
            if ( ctx != null ) {
                Console.WriteLine( format: "{0}:{1:D4} await context will be {2}:", arg0: callerName, arg1: line, arg2: ctx );
                Console.WriteLine( format: "    TSCHED:{0}", arg0: TaskScheduler.Current );
            }
            else {
                Console.WriteLine( format: "{0}:{1:D4} await context will be <NO CONTEXT>", arg0: callerName, arg1: line );
                Console.WriteLine( format: "    TSCHED:{0}", arg0: TaskScheduler.Current );
            }
        }
        ...
        public static ConfiguredTaskAwaitable PrintContext( this ConfiguredTaskAwaitable t, [CallerMemberName] [CanBeNull] String? callerName = null,
            ...
            PrintContext( callerName: callerName, line: line );
