...
//
// File "EasierSemaphore.cs" last formatted on 2021-11-30 at 7:22 PM by Protiguous.
...
public static class EasierSemaphore {
	...
	public readonly struct Token : IDisposable {
		...
		public Token( Semaphore semaphore ) => this._semaphore = semaphore ?? throw new NullException( nameof( semaphore ) );
