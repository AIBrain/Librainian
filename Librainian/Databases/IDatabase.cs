...
namespace Librainian.Databases {
	...
	public interface IDatabase {
		...
		ValueTask<Int32?> ExecuteNonQueryAsync( String query, CommandType commandType, params SqlParameter[] parameters );
		...
		/// <param name="parameters"> </param>
		/// <returns></returns>
		ValueTask<DataTableReader> ExecuteReaderAsyncDataReader( String query, CommandType commandType, params SqlParameter[] parameters );
		...
		/// <param name="parameters"> </param>
		/// <returns></returns>
		ValueTask<DataTable> ExecuteReaderDataTableAsync( String query, CommandType commandType, params SqlParameter[] parameters );
		...
		/// <param name="parameters"> </param>
		/// <returns></returns>
		ValueTask<TResult> ExecuteScalarAsync<TResult>( [NotNull] String query, CommandType commandType, params SqlParameter[] parameters );
		...
		/// <param name="table"></param>
		/// <param name="parameters"></param>
		ValueTask<Boolean> FillTableAsync( [NotNull] String sproc, CommandType commandType, [NotNull] DataTable table, params SqlParameter[] parameters );
		...
		/// <param name="commandType"></param>
		/// <param name="parameters"></param>
		ValueTask NonQueryAsync( [NotNull] String sproc, CommandType commandType, params SqlParameter[] parameters );

		DataTableReader QueryAdHoc( [NotNull] String sql, params SqlParameter[] parameters );

		ValueTask<DataTableReader> QueryAdHocAsync( [NotNull] String sql, params SqlParameter[] parameters );
		...
		ValueTask<SqlDataReader> QueryAsync( [NotNull] String sproc, CommandType commandType, params SqlParameter[] parameters );
		...
		ValueTask UseDatabaseAsync( [NotNull] String dbName );
