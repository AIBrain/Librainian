...
// 
// File "MMF.cs" last formatted on 2020-08-14 at 8:32 PM.
...
namespace Librainian.Databases.MMF {
	...
	internal class MMF {
		...
		[NotNull]
		public static String GetContent( [NotNull] MemoryMappedFile memoryMappedFile, Int64 beginningByteLocation, Int64 bytesToReadIn ) {
			...
			var content = Encoding.Unicode.GetString( contentArray );
