...
// 
// File "DatabaseExtensions.cs" last formatted on 2022-12-22 at 5:15 PM by Protiguous.
	...
	*/
	...
	public static Boolean AttemptQueryAgain<T>( this T exception, ref Int32 retriesLeft ) where T : Exception {
		...
		return exception.Message.Contains( "server was not found", StringComparison.OrdinalIgnoreCase ) ||
		       exception.Message.Contains( "was not accessible", StringComparison.OrdinalIgnoreCase ) ||
