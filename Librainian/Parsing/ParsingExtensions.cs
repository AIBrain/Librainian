...
namespace Librainian.Parsing {
    ...
    public static class ParsingExtensions {
        ...
        public static String DoubleQuote<T>( [CanBeNull] this T self ) =>
            $"{ParsingConstants.DoubleQuote}{self.Trimmed()}{ParsingConstants.DoubleQuote}";
        ...
        [CanBeNull]
        [Pure]
        public static Word? FirstWord( [CanBeNull] this String? sentence ) =>
		...
		/// <returns></returns>
		[Pure]
        public static Boolean Like( [CanBeNull] this String? left, [CanBeNull] String? right, CompareOptions compareOptions = CompareOptions.NullsAreNotEqual, StringComparison comparison = StringComparison.OrdinalIgnoreCase ) {
		...
		/// <returns></returns>
		[Pure]
		public static Boolean Same( [CanBeNull] this String? left, [CanBeNull] String? right, CompareOptions compareOptions = CompareOptions.NullsAreNotEqual,
			StringComparison comparison = StringComparison.Ordinal ) => left.Like( right, compareOptions, comparison );
