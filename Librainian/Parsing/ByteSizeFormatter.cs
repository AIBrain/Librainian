...
//
// File "ByteSizeFormatter.cs" last formatted on 2021-11-30 at 7:20 PM by Protiguous.
...
public class ByteSizeFormatter : Formatter {
	...
	/// <param name="bytes">
	/// When this method returns, contains the 64-bit signed integer value equivalent of the value contained in <paramref
	/// name="input" />, if the conversion succeeded, or zero if the conversion failed. The conversion fails if the <paramref
	/// name="input" /> parameter is null or Empty, or is not of the correct format. This parameter is passed uninitialized;
	...
	public override String Format( String? format, Object? arg, IFormatProvider? formatProvider ) {
		if ( format == null ) {
			throw new NullException( nameof( format ) );
		}
