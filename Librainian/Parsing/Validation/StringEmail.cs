...
//
// Project: "Librainian", "StringEmail.cs" was last formatted by Protiguous on 2019/08/08 at 9:25 AM.
...
namespace Librainian.Parsing.Validation {
    ...
    public class StringEmail : RegexString {
        ...
        protected override Boolean AllowNull => false;

        [NotNull]
        protected override String RegexValidation => @"^.+@.+\..+$";

        public override String Requirements => "be a valid email of the format <example>@<example>.<com>";

        public StringEmail( String value ) : base( value ) { }
