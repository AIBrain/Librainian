...
//
// File "ValidatedString.cs" last formatted on 2021-11-30 at 7:20 PM by Protiguous.
...
public class ValidatedString : IValidatedString {
	...
	public ValidatedString( String value, Func<String, Boolean> validationFunc ) {
		this.Value = value ?? throw new NullException( nameof( value ) );
		this.ValidateFunc = validationFunc ?? throw new NullException( nameof( validationFunc ) );
