...
// 
// File "StringAlphaNumeric.cs" last formatted on 2020-08-14 at 8:41 PM.
...
namespace Librainian.Parsing.Validation {
	...
	public class StringAlphaNumeric : RegexString {
		...
		[NotNull]
		public static explicit operator StringAlphaNumeric( [NotNull] String str ) => new StringAlphaNumeric( str );
