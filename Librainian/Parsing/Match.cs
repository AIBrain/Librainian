...
// 
// File "Match.cs" last formatted on 2020-08-14 at 8:41 PM.
...
namespace Librainian.Parsing {
	...
	public static class Match<T, TResult> {
		...
		public static Func<T, TResult> On<TCtx1, TCtx2>(
			[NotNull] Func<OpenMatchContext<T, TResult>, TCtx1> cond1,
			[NotNull] Func<TCtx1, TCtx2> cond2,
			[NotNull] Func<TCtx2, ClosedMatchContext> cond3
		...
		public static Func<T, TResult> On<TCtx1, TCtx2, TCtx3>(
			[NotNull] Func<OpenMatchContext<T, TResult>, TCtx1> cond1,
			[NotNull] Func<TCtx1, TCtx2> cond2,
			[NotNull] Func<TCtx2, TCtx3> cond3,
			[NotNull] Func<TCtx3, ClosedMatchContext> cond4
		...
		public static Func<T, TResult> On<TCtx1, TCtx2, TCtx3, TCtx4>(
			...
			[NotNull] Func<TCtx1, TCtx2> cond2,
			[NotNull] Func<TCtx2, TCtx3> cond3,
			[NotNull] Func<TCtx3, TCtx4> cond4,
			[NotNull] Func<TCtx4, ClosedMatchContext> cond5
		) where TCtx1 : MatchContext<T, TResult> where TCtx2 : MatchContext<T, TResult> where TCtx3 : MatchContext<T, TResult> where TCtx4 : MatchContext<T, TResult> {
		...
		private sealed class ContextImpl : OpenMatchContext<T, TResult> {
			...
			public ContextImpl( [NotNull] ContextImpl baseContext, [CanBeNull] MatchExpression newExpr ) =>
				this._matches = baseContext._matches.Concat( newExpr ).ToList().AsReadOnly();
