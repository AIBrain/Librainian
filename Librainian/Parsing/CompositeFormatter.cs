...
//
// Project: "Librainian", File: "CompositeFormatter.cs" was last formatted by Protiguous on 2020/03/16 at 2:59 PM.
...
namespace Librainian.Parsing {
    ...
    internal sealed class CompositeFormatter : Formatter {
        ...
        public CompositeFormatter( [CanBeNull] CultureInfo culture = null, [NotNull] params Formatter[] formatters ) : base( culture: culture ) =>
            this._formatters = new List<Formatter>( collection: formatters );

        /// <summary>Adds the specified formatter.</summary>
        /// <param name="formatter">The formatter.</param>
        public void Add( [CanBeNull] Formatter formatter ) => this._formatters.Add( item: formatter );
        ...
        public override String Format( [CanBeNull] String? format, [CanBeNull] Object arg, [CanBeNull] IFormatProvider formatProvider ) {
            return this._formatters.Select( selector: formatter => formatter?.Format( format: format, arg: arg, formatProvider: formatProvider ) )
