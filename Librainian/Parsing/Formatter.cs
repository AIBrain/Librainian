...
//
// File "Formatter.cs" last formatted on 2021-11-30 at 7:20 PM by Protiguous.
...
public abstract class Formatter : IFormatProvider, ICustomFormatter {
	...
	/// <returns>
	/// An instance of the object specified by <paramref name="formatType" />, if the IFormatProvider implementation can supply
	/// that type of object; otherwise, <see langword="null" /> .
	/// </returns>
