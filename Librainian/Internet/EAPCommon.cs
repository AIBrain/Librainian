...
// 
// File "EAPCommon.cs" last formatted on 2020-08-14 at 8:34 PM.
...
namespace Librainian.Internet {
	...
	public static class EapCommon {
		...
		public static void HandleCompletion<T>(
			[NotNull] this TaskCompletionSource<T> taskCompletionSource,
			[NotNull] AsyncCompletedEventArgs e,
			[NotNull] Func<T> getResult,
