	...
	public sealed class NetworkBrowser {
		...
		public static IEnumerable<NativeMethods.ServerInfo101> GetNetworkComputers() {
			...
			try {
				...
				var ret = NativeMethods.NetServerEnum( null, 100, out buffer, maxPreferredLength, ref entriesRead,
					ref totalEntries, NativeMethods.Sv101Types.SvTypeWorkstation | NativeMethods.Sv101Types.SvTypeServer, null,
					resHandle );
