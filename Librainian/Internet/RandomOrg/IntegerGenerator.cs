...
//
// Project: "Librainian", File: "IntegerGenerator.cs" was last formatted by Protiguous on 2020/03/16 at 2:55 PM.
    ...
    public static class RandomDotOrg {
        ...
        public static async Task<IEnumerable<Int32>> SequenceGenerator( this Int32 minValue, Int32 maxValue ) {
            ...
            if ( maxValue < minValue ) {
                CommonExtensions.Swap( left: ref minValue, right: ref maxValue );
            }
