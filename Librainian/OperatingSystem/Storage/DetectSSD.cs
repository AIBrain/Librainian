...
namespace Librainian.OperatingSystem.Storage {
    ...
    public static class DetectSSD {
        ...
        public static Boolean? IncursSeekPenalty( this Byte diskNumber ) {
            ...
            var querySeekPenaltyResult = NativeMethods.DeviceIoControl( hDrive, ioctlStorageQueryProperty, ref querySeekPenalty,
                ( UInt32 ) Marshal.SizeOf( querySeekPenalty ), ref querySeekPenaltyDesc,
                ( UInt32 ) Marshal.SizeOf( querySeekPenaltyDesc ), out var returnedQuerySeekPenaltySize,
                IntPtr.Zero );
