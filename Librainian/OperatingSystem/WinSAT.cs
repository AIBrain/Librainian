...
// 
// This source code contained in "WinSAT.cs" belongs to Protiguous@Protiguous.com and
...
// 
// Project: "Librainian", "WinSAT.cs" was last formatted by Protiguous on 2019/01/29 at 10:47 PM.
...
namespace Librainian.OperatingSystem {
    ...
    public static class WinSAT {
        ...
        private static (Decimal CpuScore, Decimal MemoryScore, Decimal GraphicsScore, Decimal GamingScore, Decimal DiskScore) ReadXML() {
            ...
            var newest = documents.Where( document => document.FullPath.Contains( "Formal.Assessment" ) ).OrderByDescending( document => document.LastWriteTime )
                .FirstOrDefault();
