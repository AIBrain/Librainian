...
//
// ***  Project "Librainian"  ***
// File "FileHistoryFileTests.cs" was last formatted by Protiguous on 2018/06/26 at 1:34 AM.
...
namespace Librainian.OperatingSystem.FileHistory {
	...
	public static class FileHistoryFileTests {
		...
		public static void RunTests() {
			...
			if ( !FileHistoryFileExtensions.TryParseFileHistoryFile( new Document( Example ), out var folder, out var filename, out var when ) ) {
