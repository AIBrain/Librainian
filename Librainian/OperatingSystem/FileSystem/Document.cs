...
namespace Librainian.OperatingSystem.FileSystem {
	...
	public class Document : ABetterClassDispose, IDocument {
        ...
        */
		...
		/// <returns></returns>
		[Pure]
		public async PooledValueTask<(Boolean success, TimeSpan timeElapsed)> Clone(
		...
		public Task Copy(
			[NotNull] IDocument destination,
			[CanBeNull] Action<(UInt64 bytesReceived, UInt64 totalBytesToReceive)>? onProgress,
			...
			return webClient.DownloadFileTaskAsync( uri, destination.FullPath )!;
		}
		...
		[NotNull]
		[Pure]
		public String JustName() => Path.GetFileNameWithoutExtension( this.FileName ) ?? String.Empty;
