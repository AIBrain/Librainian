...
//
// This source code contained in "FileAttributeData.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "Librainian", File: "FileAttributeData.cs" was last formatted by Protiguous on 2020/03/16 at 2:58 PM.
...
namespace Librainian.OperatingSystem.FileSystem {
    ...
    public struct FileAttributeData {
        ...
        public Boolean Refresh( [NotNull] String fullPath, Boolean throwOnError = true ) {
            ...
            var handle = NativeMethods.FindFirstFile( lpFileName: fullPath, lpFindData: out var data );

            if ( handle.IsInvalid ) {
                if ( throwOnError ) {
                    NativeMethods.HandleLastError( fullPath: fullPath );
                }
                else {
                    this.Reset();
