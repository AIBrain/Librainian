	...
	public static class IOExtensions {
		...
		public static async Task AppendTextAsync( [NotNull] this FileInfo fileInfo, [CanBeNull] String? text ) {
			...
			try {
				...
				var flushtask = sourceStream.FlushAsync();
		...
		[NotNull]
		[ItemCanBeNull]
		public static IEnumerable<DirectoryInfo?> BetterEnumerateDirectories(
			[CanBeNull] this DirectoryInfo? target,
		...
		public static void FindFiles(
			[NotNull] this DirectoryInfo startingFolder,
			[NotNull] IEnumerable<String> fileSearchPatterns,
		...
		///     <see cref="Pri.LongPath.FileSystemInfo.FullPath" /> .
		/// </summary>
		...
		/// <returns></returns>
		public static Boolean GrabEntireTree(
			[NotNull] this IFolder startingFolder,
			[CanBeNull] IEnumerable<String>? documentSearchPatterns,
			[NotNull] Action<Document> onEachDocumentFound,
			[CanBeNull] IProgress<Int64>? progressFolders,
			[CanBeNull] IProgress<Int64>? progressDocuments,
