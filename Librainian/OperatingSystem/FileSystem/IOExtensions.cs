...
// 
// Project: "Librainian", File: "IOExtensions.cs" was last formatted by Protiguous on 2020/03/18 at 10:27 AM.
    ...
    public static class IOExtensions {
        ...
        public static async Task AppendTextAsync( [NotNull] this FileInfo fileInfo, [CanBeNull] String? text ) {
            ...
            try {
                ...
                var write = sourceStream.WriteAsync( encodedText, 0, length );
                ...
                do {
                    ...
                    switch ( searchOption ) {
                        case SearchOption.AllDirectories: {
                            ...
                            foreach ( var info in subInfo.BetterEnumerateDirectories( searchPattern, searchOption ) ) {
                                yield return info;
                            }
                        ...
                        default: throw new ArgumentOutOfRangeException( nameof( searchOption ), searchOption, null );
                    }
        ...
        public static UInt32? GetFileSizeOnDisk( [NotNull] this FileInfo info ) {
            UInt32 clusterSize;
            var driveLetter = info.Directory.Root.FullPath.TrimEnd( '\\' );
            ...
            var losize = NativeMethods.GetCompressedFileSizeW( info.FullPath, out var hosize );
        ...
        /// <summary>Given the <paramref name="path" /> and <paramref name="searchPattern" /> pick any one file and return the <see cref="Pri.LongPath.FileSystemInfo.FullPath" /> .</summary>
        ...
        public static Boolean IsProtected( [NotNull] this FileSystemInfo fileSystemInfo ) {
            ...
            try {
                ds = new DirectorySecurity( fileSystemInfo.FullPath, AccessControlSections.Access );
            }
            catch ( UnauthorizedAccessException ) {
                return true;
            }
        ...
        public static async Task<String> ReadTextAsync( [NotNull] String filePath, Int32? bufferSize = 4096, Int32? fileMissingRetries = 10, TimeSpan? retryDelay = null ) {
            ...
            if ( File.Exists( filePath ) ) {
                try {
                    using ( var sourceStream = new FileStream( filePath, FileMode.Open, FileAccess.Read, FileShare.Read, bufferSize.Value, true ) ) {
