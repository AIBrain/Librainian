...
// 
// File "DefragExtensions.cs" last formatted on 2020-08-14 at 8:39 PM.
	...
	public static class DefragExtensions {
		...
		private static String Defrag( [CanBeNull] Disk disk ) {
			...
			var info = new ProcessStartInfo {
				FileName = path, Arguments = String.Format( "{{{0}}} /O /V /M " + Environment.ProcessorCount, disk ), UseShellExecute = false, CreateNoWindow = true,
