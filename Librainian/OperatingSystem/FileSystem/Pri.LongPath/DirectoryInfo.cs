...
//
// Project: "Librainian", File: "DirectoryInfo.cs" was last formatted by Protiguous on 2020/03/16 at 2:57 PM.
    ...
    public class DirectoryInfo : FileSystemInfo {
        ...
        public override Boolean Exists {
            get {
                ...
                return this.state == State.Initialized && this.data.fileAttributes.HasFlag( flag: FileAttributes.Directory );
            }
        }
        ...
        public DirectoryInfo( [NotNull] String path ) : base( fullPath: path.ThrowIfBlank().GetFullPath() ) =>
