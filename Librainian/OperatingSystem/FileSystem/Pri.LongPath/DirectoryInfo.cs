...
namespace Librainian.OperatingSystem.FileSystem.Pri.LongPath {
    ...
    public class DirectoryInfo : FileSystemInfo {
        ...
        public DirectoryInfo CreateSubdirectory( [NotNull] String path ) {
            ...
            if ( String.Compare( this.FullPath, 0, newFullPath, 0, this.FullPath.Length,
        ...
        public IEnumerable<DirectoryInfo> EnumerateDirectories( [NotNull] String searchPattern ) =>
            Directory.EnumerateFileSystemEntries( this.FullPath, searchPattern, true, false,
                SearchOption.TopDirectoryOnly ).Select( directory => new DirectoryInfo( directory ) );

        [NotNull]
        [ItemNotNull]
        public IEnumerable<DirectoryInfo> EnumerateDirectories( [NotNull] String searchPattern, SearchOption searchOption ) =>
            Directory.EnumerateFileSystemEntries( this.FullPath, searchPattern, true, false, searchOption )
                     .Select( directory => new DirectoryInfo( directory ) );

        [NotNull]
        [ItemNotNull]
        public IEnumerable<DirectoryInfo> EnumerateDirectories() =>
            Directory.EnumerateFileSystemEntries( this.FullPath, "*", true, false,
                SearchOption.TopDirectoryOnly ).Select( directory => new DirectoryInfo( directory ) );
        ...
        public IEnumerable<FileInfo> EnumerateFiles( [NotNull] String searchPattern ) =>
            Directory.EnumerateFileSystemEntries( this.FullPath, searchPattern, false, true,
                SearchOption.TopDirectoryOnly ).Select( e => new FileInfo( e ) );

        [NotNull]
        [ItemNotNull]
        public IEnumerable<FileInfo> EnumerateFiles( [NotNull] String searchPattern, SearchOption searchOption ) =>
            Directory.EnumerateFileSystemEntries( this.FullPath, searchPattern, false, true, searchOption )
                     .Select( e => new FileInfo( e ) );

        [NotNull]
        [ItemNotNull]
        public IEnumerable<FileSystemInfo> EnumerateFileSystemInfos() =>
            Directory.EnumerateFileSystemEntries( this.FullPath )
        ...
        public IEnumerable<FileSystemInfo> EnumerateFileSystemInfos( [NotNull] String searchPattern ) =>
            Directory.EnumerateFileSystemEntries( this.FullPath, searchPattern, true, true,
        ...
        public IEnumerable<FileInfo> GetFiles( [NotNull] String searchPattern ) =>
            Directory.GetFiles( this.FullPath, searchPattern ).Select( path => new FileInfo( path ) );
        ...
        public IEnumerable<FileInfo> GetFiles() =>
            Directory.EnumerateFileSystemEntries( this.FullPath, "*", false, true,
                SearchOption.TopDirectoryOnly ).Select( path => new FileInfo( path ) );
        ...
        public IEnumerable<FileSystemInfo> GetFileSystemInfos() =>
            Directory.EnumerateFileSystemEntries( this.FullPath, "*", true, true,
                         SearchOption.TopDirectoryOnly )
                     .Select( e => e.Exists() ? new DirectoryInfo( e ) : ( FileSystemInfo ) new FileInfo( e ) );
