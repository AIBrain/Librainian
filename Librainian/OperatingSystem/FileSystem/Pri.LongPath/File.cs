...
namespace Librainian.OperatingSystem.FileSystem.Pri.LongPath {
    ...
    public static class File {
        ...
        ///     invalid characters as defined in <see cref="Librainian.OperatingSystem.FileSystem.Pri.LongPath.Path.GetInvalidPathChars()" />.
        ///     <para>
        ///         -or-
        ///     </para>
        ...
        [NotNull]
        public static FileStream Create( [NotNull] String path, Int32 bufferSize ) => Open( path.ThrowIfBlank(), FileMode.Create, FileAccess.ReadWrite, FileShare.None, bufferSize, FileOptions.None );

        [NotNull]
        public static FileStream Create( [NotNull] String path, Int32 bufferSize, FileOptions options ) => Open( path.ThrowIfBlank(), FileMode.Create, FileAccess.ReadWrite, FileShare.None, bufferSize, options );
        ...
        [NotNull]
        public static FileStream Open( [NotNull] String path, FileMode mode ) => Open( path.ThrowIfBlank(), mode, mode == FileMode.Append ? FileAccess.Write : FileAccess.ReadWrite, FileShare.None );
        ...
        /// </exception>
        [NotNull]
        public static FileStream Open( [NotNull] String path, FileMode mode, FileAccess access ) => Open( path.ThrowIfBlank(), mode, access, FileShare.None, 0, FileOptions.None );
        ...
        /// </exception>
        [NotNull]
        public static FileStream Open( [NotNull] String path, FileMode mode, FileAccess access, FileShare share ) => Open( path.ThrowIfBlank(), mode, access, share, 0, FileOptions.None );
        ...
        public static void Replace( [NotNull] String sourceFileName, [NotNull] String destinationFileName, [NotNull] String destinationBackupFileName ) => Replace( sourceFileName.ThrowIfBlank(), destinationFileName.ThrowIfBlank(), destinationBackupFileName.ThrowIfBlank(), false );

        public static void Replace( [NotNull] String sourceFileName, [NotNull] String destinationFileName, [NotNull] String destinationBackupFileName, Boolean ignoreMetadataErrors ) {
        ...
        public static void SetLastAccessTime( [NotNull] String path, DateTime lastAccessTime ) => SetLastAccessTimeUtc( path.ThrowIfBlank(), lastAccessTime.ToUniversalTime() );
        ...
        public static void SetLastWriteTime( [NotNull] this String path, DateTime lastWriteTime ) => SetLastWriteTimeUtc( path.ThrowIfBlank(), lastWriteTime.ToUniversalTime() );
