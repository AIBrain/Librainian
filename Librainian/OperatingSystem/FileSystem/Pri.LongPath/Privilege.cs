...
// 
// File "Privilege.cs" last formatted on 2020-08-14 at 8:39 PM.
						...
						if ( success ) {
							...
							if ( success ) {
								...
								if ( !NativeMethods.DuplicateTokenEx( processHandle,
																	  ...
																	  IntPtr.Zero, NativeMethods.SecurityImpersonationLevel.Impersonation,
																	  NativeMethods.TokenType.Impersonation, ref this.threadHandle ) ) {
									error = Marshal.GetLastWin32Error();
									success = false;
								}
							}
