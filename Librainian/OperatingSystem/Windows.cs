...
// 
// Project: "Librainian", "Windows.cs" was last formatted by Protiguous on 2018/11/12 at 5:51 AM.
...
namespace Librainian.OperatingSystem {
	...
	public static class Windows {
		...
		public static async Task<Boolean> RestartServiceAsync( String serviceName, TimeSpan timeout ) =>
			await StartServiceAsync( serviceName: serviceName, timeout: timeout ).ConfigureAwait( false ) && await StopServiceAsync( serviceName: serviceName, timeout: timeout ).ConfigureAwait( false );
