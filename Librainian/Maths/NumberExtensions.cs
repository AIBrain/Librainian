...
// 
// Project: "Librainian", File: "NumberExtensions.cs" was last formatted by Protiguous on 2020/03/18 at 10:24 AM.
...
namespace Librainian.Maths {
    ...
    public static class NumberExtensions {
        ...
        private static readonly Byte[] BitReverseTable256 = {
            ...
            ,
        ...
        /// <summary>Guts of <see cref="To(DateTime,DateTime,TimeSpan?)" />.</summary>
        ...
        /// <summary>Return each <see cref="DateTime" /> between <paramref name="from" /> and <paramref name="to" />, stepped by a <see cref="TimeSpan" /> ( <paramref name="step" />).</summary>
        /// <param name="from"></param>
        /// <param name="to">  </param>
        /// <param name="step"></param>
        /// <returns></returns>
        ...
        /// <example>
        /// var now = DateTime.UtcNow; var then = now.AddMinutes( 10 ); var minutes = now.To( then, TimeSpan.FromMinutes( 1 ) ); foreach ( var dateTime in minutes ) {
