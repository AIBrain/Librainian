...
//
// File "ZeroToOne.cs" last formatted on 2021-11-30 at 7:19 PM by Protiguous.
...
public record ZeroToOne {
	...
	/// <summary>
	/// Return a new <see cref="ZeroToOne" /> with the value of <paramref name="left" /> moved closer to the value of <paramref
	/// name="right" /> .
	/// </summary>
	...
	/// <summary>Attempt to parse <paramref name="value" />, otherwise return null.</summary>
	/// <param name="value"></param>
