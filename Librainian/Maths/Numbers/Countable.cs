...
// 
// Project: "Librainian", File: "Countable.cs" was last formatted by Protiguous on 2020/03/18 at 10:24 AM.
...
namespace Librainian.Maths.Numbers {
    ...
    public class Countable<TKey> : ABetterClassDispose, IEnumerable<Tuple<TKey, BigInteger>> {
        ...
        public void Trim() =>
            Parallel.ForEach( this.Dictionary.Where( pair => ( pair.Value == default( BigInteger ) ) || ( pair.Value == BigInteger.Zero ) ), CPU.AllCPUExceptOne, pair => {
                if ( !( pair.Key is null ) ) {
