...
namespace Librainian.Maths.Numbers
{
    ...
    public struct BigDecimal : IComparable, IComparable<BigDecimal>, IConvertible, /*IFormattable,*/ IEquatable<BigDecimal>
    {
        ...
        */
        ...
        // // all whitespace or none? if ( String.IsNullOrWhiteSpace( value ) ) { whyParseFailed = "'value' == null or contained only whitespace"; return false; }

        // value = value.Trim(); if ( String.IsNullOrWhiteSpace( value ) ) { whyParseFailed = "'value' == null or contained only whitespace"; return false; }
