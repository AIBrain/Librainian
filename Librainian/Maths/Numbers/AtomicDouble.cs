...
//
// File "AtomicDouble.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
	...
	public Double Value {
		...
		set {
			if ( Double.IsNaN( value ) ) {
				throw new InvalidOperationException( $"{nameof( value )} is not a double." );
			}

			if ( Double.IsInfinity( value ) ) {
				throw new InvalidOperationException( $"{nameof( value )} cannot be infinity." );
			}
