...
// 
// Project: "Librainian", "Randem.cs" was last formatted by Protiguous on 2018/11/23 at 12:17 AM.
	...
	public static partial class Randem {
		...
		public static TimeSpan NextTimeSpan( this Int32 minMilliseconds, Int32 maxMilliseconds ) =>
			TimeSpan.FromMilliseconds(
				minMilliseconds > maxMilliseconds ? Instance().Next( minValue: maxMilliseconds, maxValue: minMilliseconds ) : Instance().Next( minValue: minMilliseconds, maxValue: maxMilliseconds ) );
		...
		public static String RandomString( Int32 length = 10, Boolean lowerCase = true, Boolean upperCase = false, Boolean numbers = false, Boolean symbols = false ) {
			var charPool = String.Concat( str0: lowerCase ? ParsingExtensions.EnglishAlphabetLowercase : String.Empty, str1: upperCase ? ParsingExtensions.EnglishAlphabetUppercase : String.Empty,
