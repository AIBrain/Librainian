...
//
// This source code contained in "BigIntegerRange.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "Librainian", File: "BigIntegerRange.cs" was last formatted by Protiguous on 2020/03/16 at 2:56 PM.
...
namespace Librainian.Maths.Ranges {
    ...
    public struct BigIntegerRange {
        ...
        public Boolean IsInside( BigIntegerRange range ) => this.IsInside( x: range.Min ) && this.IsInside( x: range.Max );
        ...
        public Boolean IsOverlapping( BigIntegerRange range ) => this.IsInside( x: range.Min ) || this.IsInside( x: range.Max );
    }
}