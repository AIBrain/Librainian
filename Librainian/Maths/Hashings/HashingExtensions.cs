...
//
// Project: "Librainian", "HashingExtensions.cs" was last formatted by Protiguous on 2018/07/13 at 1:16 AM.
...
namespace Librainian.Maths.Hashings
{
    ...
    public static class HashingExtensions
    {
        ...
        public static Int32 CalcHash([NotNull] this Document document)
        {
            ...
            if (fileInfo == null) { throw new NullReferenceException("fileInfo"); }
        ...
        [NotNull]
        public static Task<Int32> CalcHashInt32Async([NotNull] this Document document, CancellationToken token) => Task.Run(document.CalcHashInt32, token);
