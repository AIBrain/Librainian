...
//
// File "ArbitraryDecimal.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
...
public class ArbitraryDecimal {
	...
	/// <summary>
	/// Shifts the System.Decimal point; a negative value makes the System.Decimal expansion bigger (as fewer digits come after
	/// the System.Decimal place) and a positive value makes the System.Decimal expansion smaller.
	/// </summary>
	...
	public override String ToString() {
		...
		// Simplest case - nothing after the System.Decimal point, and last real digit is non-zero, eg value=35
		if ( this._decimalPoint == 0 ) {
			return new String( digitString );
		}

		// Fairly simple case - nothing after the System.Decimal point, but some 0s to add, eg value=350
		if ( this._decimalPoint < 0 ) {
		...
		// Most complicated case - part of the String comes before the System.Decimal point, part comes after it, eg 3.5
		return
