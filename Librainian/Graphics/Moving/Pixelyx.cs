...
// 
// This source code contained in "Pixelyx.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "Librainian", File: "Pixelyx.cs" was last formatted by Protiguous on 2020/03/18 at 10:28 AM.
...
namespace Librainian.Graphics.Moving {
    ...
    public class Pixelyx : IEquatable<Pixelyx> {
        ...
        public static Boolean Equal( [CanBeNull] Pixelyx left, [CanBeNull] Pixelyx right ) {
            ...
            return ( left.Alpha == right.Alpha ) && ( left.Red == right.Red ) && ( left.Green == right.Green ) && ( left.Blue == right.Blue ) && ( left.X == right.X ) &&
                   ( left.Y == right.Y );
        }
