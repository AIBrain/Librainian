...
//
// File "EFV.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
...
/// <summary> Experimental Full Video </summary> <remarks> Just for fun & learning. Prefer compression over [decoding/display]
/// speed (assuming local cpu will be 'faster' than network transfer speed). Compressions must be lossless. Allow 'pages' of
/// animation, each with their own delay. Default should be page 0 = 0 delay. Checksums are used on each <see cref="Pixelyx" />
/// to guard against (detect but not fix) corruption. </remarks>
[JsonObject]
public class Efv {
