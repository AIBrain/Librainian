...
//
// File "Frame.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
...
public class Frame : IEquatable<Frame> {
	...
	/// <summary>
	/// Returns a value that indicates whether two <see cref="T:Librainian.Graphics.Imaging.Frame" /> objects have different values.
	/// </summary>
	...
	/// <summary>
	/// Returns a value that indicates whether the values of two <see cref="T:Librainian.Graphics.Imaging.Frame" /> objects are equal.
	/// </summary>
	/// <param name="left">The first value to compare.</param>
	/// <param name="right">The second value to compare.</param>
	/// <returns>
