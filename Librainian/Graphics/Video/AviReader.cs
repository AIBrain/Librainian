...
// 
// File "AviReader.cs" last formatted on 2020-08-14 at 8:34 PM.
...
namespace Librainian.Graphics.Video {
	...
	public class AviReader : ABetterClassDispose {
		...
		public void Open( [CanBeNull] String? fileName ) {
			...
			var bih = new Avi.Bitmapinfoheader {
				biBitCount = 24, biClrImportant = 0, biClrUsed = 0, biCompression = 0, biHeight = ( Int32 )this._streamInfo.rcFrame.bottom,
				biWidth = ( Int32 )this._streamInfo.rcFrame.right, biPlanes = 1
			};
