...
public static class ManipulationExtensions {
	...
	public static Bitmap? LoadAndResize( this String document, Single multiplier ) => new Document( document ).LoadAndResize( multiplier );

	public static Bitmap? LoadAndResize( this Document document, Single multiplier ) {
