...
//
// This source code contained in "StreamException.cs" belongs to Protiguous@Protiguous.com and
...
//
// Project: "Librainian", "StreamException.cs" was last formatted by Protiguous on 2018/07/10 at 9:00 PM.
...
namespace Librainian.Exceptions {
	...
	public class StreamException : Exception {
		...
		protected StreamException( [NotNull] SerializationInfo info, StreamingContext context ) : base( info, context ) {
			if ( info == null ) { throw new ArgumentNullException( paramName: nameof( info ) ); }
		}
