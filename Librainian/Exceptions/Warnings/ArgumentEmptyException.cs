...
// 
// File "ArgumentEmptyException.cs" last formatted on 2021-02-26 at 6:05 AM.
...
namespace Librainian.Exceptions.Warnings {
	...
	/// <summary>
	///     Thrown when the string parameter is null, empty, or whitespace.
	/// </summary>
	[Serializable]
	public class ArgumentEmptyException : Warning {
