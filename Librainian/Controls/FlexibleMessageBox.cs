...
//
// This source code contained in "FlexibleMessageBox.cs" belongs to Protiguous@Protiguous.com and
...
//
// Project: "Librainian", "FlexibleMessageBox.cs" was last formatted by Protiguous on 2018/10/22 at 4:47 AM.
...
namespace Librainian.Controls {
    ...
    */
	...
	public class FlexibleMessageBox {
		...
		///     0.2 - 1.0
		///     where: 0.2 means: The FlexibleMessageBox can be at most half as high as the working area. 1.0 means: The
		///     FlexibleMessageBox can
		///     be as high as the working area. Default is: 90% of the working area height.
		/// </summary>
		...
		///     0.2 - 1.0
		///     where: 0.2 means: The FlexibleMessageBox can be at most half as wide as the working area. 1.0 means: The
		///     FlexibleMessageBox can
		///     be as wide as the working area. Default is: 70% of the working area width.
		/// </summary>
		...
		public static DialogResult Show( String text ) => FlexibleMessageBoxForm.ShowDialog( null, text, String.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1 );
		...
		/// <param name="text"> The text.</param>
		/// <returns>The dialog result.</returns>
		public static DialogResult Show( IWin32Window owner, String text ) => FlexibleMessageBoxForm.ShowDialog( owner, text, String.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1 );
		...
		/// <returns>The dialog result.</returns>
		public static DialogResult Show( String text, String caption ) => FlexibleMessageBoxForm.ShowDialog( null, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1 );
		...
		/// <summary>
		///     The form to show the customized message box. It is defined as an internal class to keep the public interface of the
		///     FlexibleMessageBox clean.
		/// </summary>
		private class FlexibleMessageBoxForm : Form {
			...
			///     height or
			///     width. 1.0 means: 100 percent of the working area height or width.
			/// </summary>
			...
			private static void richTextBoxMessage_LinkClicked( Object sender, [NotNull] LinkClickedEventArgs e ) {
				try {
			...
			/// <summary>
			///     Calculate the dialogs start size (Try to auto-size width to show longest text row). Also set the maximum dialog
			///     size.
			/// </summary>
			/// <param name="flexibleMessageBoxForm">The FlexibleMessageBox dialog.</param>
			...
			private static void SetDialogSizes( [NotNull] FlexibleMessageBoxForm flexibleMessageBoxForm, String text, String caption ) {
			...
			private void FlexibleMessageBoxForm_KeyUp( Object sender, [NotNull] KeyEventArgs e ) {
				...
				if ( e.Control && ( e.KeyCode == Keys.C || e.KeyCode == Keys.Insert ) ) {
					...
					var textForClipboard = STANDARD_MESSAGEBOX_SEPARATOR_LINES + this.Text + Environment.NewLine + STANDARD_MESSAGEBOX_SEPARATOR_LINES + this._richTextBoxMessage.Text + Environment.NewLine +
										   STANDARD_MESSAGEBOX_SEPARATOR_LINES + buttonsTextLine.Replace( "&", String.Empty ) + Environment.NewLine + STANDARD_MESSAGEBOX_SEPARATOR_LINES;
			...
			/// <summary>
			///     Erforderliche Methode für die Designerunterstützung. Der Inhalt der Methode darf nicht mit dem Code-Editor geändert
			///     werden.
			/// </summary>
			private void InitializeComponent() {
				...
				this._richTextBoxMessage.DataBindings.Add( new Binding( "Text", this._flexibleMessageBoxFormBindingSource, "MessageText", true, DataSourceUpdateMode.OnPropertyChanged ) );
