...
//
// This source code contained in "QuestionBox.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "Librainian", File: "QuestionBox.cs" was last formatted by Protiguous on 2020/03/16 at 2:54 PM.
...
namespace Librainian.Controls {
    ...
    public partial class QuestionBox : Form {
        ...
        public QuestionBox( [NotNull] String question ) {
            if ( question is null ) {
                throw new ArgumentNullException( paramName: nameof( question ) );
            }

            this.InitializeComponent();
            this.Visible( value: false );
            this.richTextBoxQuestion.Text( value: question.Limit( maxlength: this.richTextBoxQuestion.MaxLength ) );
        }
        ...
        private void QuestionBox_Load( [CanBeNull] Object sender, [CanBeNull] EventArgs e ) {
            this.Visible( value: true );      //fix per http://stackoverflow.com/a/18619181/956364
