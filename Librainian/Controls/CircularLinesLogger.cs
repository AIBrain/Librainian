...
//
// File "CircularLinesLogger.cs" last formatted on 2021-11-30 at 7:16 PM by Protiguous.
...
/// <summary>A circular buffer style logging class which stores N items for display in a Rich Text Box.</summary>
...
public class CircularLinesLogger : ICircularLinesLogger {
	...
	/// <summary>Create an instance of the Logger class which stores <paramref name="maximumEntries" /> log entries.</summary>
	public CircularLinesLogger( UInt32 maximumEntries = 256 ) {
	...
	/// <summary>Adds <paramref name="text" /> as a log entry.</summary>
	public void AddToLog( String text ) => this.AddToLog( text, this._defaultColor );

	/// <summary>Adds <paramref name="text" /> as a log entry, and specifies a color to display it in.</summary>
	...
	/// <summary>
	/// Retrieve the contents of the log as rich text, suitable for populating a <see
	/// cref="System.Windows.Forms.RichTextBox.Rtf" /> property.
	/// </summary>
