...
// 
// File "CircularLinesLogger.cs" last touched on 2021-10-13 at 4:24 PM by Protiguous.
	...
	public void AddToLog( String text, Color entryColor ) {
		lock ( this._logLock ) {
			...
			var logEntry = new LogEntry {
				EntryId = this._entryNumber, EntryTimeStamp = DateTime.Now, EntryText = text, EntryColor = entryColor
			};
