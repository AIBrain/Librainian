...
//
// This source code contained in "DynamicExtensions.cs" belongs to Protiguous@Protiguous.com
...
//
// ***  Project "Librainian"  ***
// File "DynamicExtensions.cs" was last formatted by Protiguous on 2018/06/26 at 12:49 AM.
...
namespace Librainian.AmazedSaint {
	...
	public static class DynamicExtensions {
		...
		public static XElement XElementFromElastic( [NotNull] ElasticObject elastic ) {
			...
			foreach ( var a in elastic.GetAttributes().Where( a => a.Value.InternalValue != null ) ) {
			...
			foreach ( var child in elastic.GetElements().Select( XElementFromElastic ) ) {
				exp.Add( child );
			}
