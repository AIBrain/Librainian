...
//
// Project: "Librainian", "Document.cs" was last formatted by Protiguous on 2019/01/29 at 9:59 PM.
...
namespace Librainian.ComputerSystem.FileSystem {
    ...
    [JsonObject]
    public class Document : ABetterClassDispose, IComparable<Document>, IEquatable<Document>, IEnumerable<Byte> {
        ...
        public IEnumerable<Byte> AsBytes( FileOptions options = FileOptions.SequentialScan ) {
            ...
            using ( var stream = new FileStream( path: this.FullPath, mode: FileMode.Open, access: FileAccess.Read, share: FileShare.Read,
                bufferSize: Constants.Sizes.OneMegaByte, options: options ) ) {
        ...
        public String CRC64Hex() {
            try {
                ...
                using ( var fileStream = new FileStream( path: this.FullPath, mode: FileMode.Open, access: FileAccess.Read, share: FileShare.Read,
                    bufferSize: Constants.Sizes.OneMegaByte ) ) {
