...
//
// ***  Project "Librainian"  ***
// File "DocumentExtensions.cs" was last formatted by Protiguous on 2018/06/26 at 12:54 AM.
...
namespace Librainian.ComputerSystem.FileSystem {
	...
	public static class DocumentExtensions {
		...
		private static async Task InternalCopyWithProgress( [NotNull] Document source, [NotNull] Document destination, [CanBeNull] IProgress<Single> progress, [CanBeNull] IProgress<TimeSpan> eta,
			[NotNull] Char[] buffer, Single bytesToBeCopied, Stopwatch begin ) {
