...
//
// Project: "Librainian", "Folder.cs" was last formatted by Protiguous on 2018/11/11 at 4:17 AM.
...
namespace Librainian.ComputerSystem.FileSystem {
	...
	public class Folder : IEquatable<Folder> {
		...
		/// <returns></returns>
		[ItemNotNull]
		public IEnumerable<Folder> BetterGetFolders( [CanBeNull] String searchPattern = "*", Boolean randomize = false ) {
		...
		[CanBeNull]
		public Folder GetParent() => this.Info.Parent == null ? null : new Folder( this.Info.Parent );
