...
// 
// Project: "Librainian", "Folder.cs" was last formatted by Protiguous on 2018/10/22 at 5:37 PM.
...
namespace Librainian.ComputerSystem.FileSystem {
    ...
    public class Folder : IEquatable<Folder> {
        ...
        public Folder( String fullPath ) {
            ...
            fullPath = fullPath.CleanFileAndPath();
        ...
        public static Boolean TryParse( [CanBeNull] String path, [CanBeNull] out Folder folder ) {
            ...
            try {
                ...
                path = path.CleanFileAndPath().Trim();
