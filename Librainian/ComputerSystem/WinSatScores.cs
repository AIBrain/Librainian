...
// 
// This source code contained in "WinSatScores.cs" belongs to Protiguous@Protiguous.com and
...
// 
// Project: "Librainian", "WinSatScores.cs" was last formatted by Protiguous on 2019/11/25 at 3:28 PM.
...
namespace Librainian.ComputerSystem {
    ...
    public class WinSatScores {
        ...
        [NotNull]
        private ManagementObjectSearcher Instance => this.Searcher.Value ?? throw new InvalidOperationException( $"Unable to use {nameof( ManagementObjectSearcher )}." );
