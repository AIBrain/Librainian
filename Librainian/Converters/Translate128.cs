...
// 
// File "Translate128.cs" last formatted on 2020-08-14 at 8:32 PM.
...
namespace Librainian.Converters {
	...
	public struct Translate128 {
		...
		public Translate128( Guid guid ) {
			this.FourBytes = default( FourBytes );
			this.EightBytesLow = default( EightBytes );
			this.EightBytesHigh = default( EightBytes );
			this.Lower = default( Translate64 );
			this.Higher = default( Translate64 );
			this.Guid = guid;
		}
