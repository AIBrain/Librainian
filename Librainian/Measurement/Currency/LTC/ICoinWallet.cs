...
// 
// File "ICoinWallet.cs" last formatted on 2020-08-14 at 8:37 PM.
...
namespace Librainian.Measurement.Currency.LTC {
	...
	public interface ICoinWallet {
		...
		/// <summary>
		///     Attempt to <see cref="CoinWallet.TryWithdraw(BTC.ICoin,UInt64)" /> one or more <see cref="ICoin" /> from this
		///     <see cref="CoinWallet" /> .
		/// </summary>
