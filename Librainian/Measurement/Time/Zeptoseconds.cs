...
//
// File "Zeptoseconds.cs" last formatted on 2021-11-30 at 7:20 PM by Protiguous.
...
public record Zeptoseconds( BigDecimal Value ) : IQuantityOfTime, IComparable<Zeptoseconds> {
	...
	/// <summary>Return this value in <see cref="Yoctoseconds" />.</summary>
	...
	/// <summary>Return this value in <see cref="Attoseconds" />.</summary>
