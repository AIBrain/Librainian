...
//
// File "Attoseconds.cs" last formatted on 2021-11-30 at 7:19 PM by Protiguous.
...
public record Attoseconds( BigDecimal Value ) : IQuantityOfTime {
	...
	/// <remarks>
	/// (approximately) – half-life of beryllium-8, maximum time available for the triple-alpha process for the synthesis of
	/// carbon and heavier elements in stars
	/// </remarks>
