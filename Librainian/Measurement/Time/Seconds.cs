...
// 
// File "Seconds.cs" last formatted on 2020-04-03.
...
namespace Librainian.Measurement.Time {
    ...
    [Immutable]
    public record Seconds( Rational Value ) : IQuantityOfTime {
        ...
        public static Seconds Five { get; } = new( 5 );
        ...
        public static Seconds Seven { get; } = new( 7 );

        /// <summary><see cref="Ten" /><see cref="Seconds" />.</summary>
        public static Seconds Ten { get; } = new( 10 );

        /// <summary><see cref="Thirteen" /><see cref="Seconds" />.</summary>
        public static Seconds Thirteen { get; } = new( 13 );

        /// <summary><see cref="Thirty" /><see cref="Seconds" />.</summary>
        public static Seconds Thirty { get; } = new( 30 );

        /// <summary><see cref="Three" /><see cref="Seconds" />.</summary>
        public static Seconds Three { get; } = new( 3 );

        /// <summary><see cref="Twenty" /><see cref="Seconds" />.</summary>
        public static Seconds Twenty { get; } = new( 20 );

        /// <summary><see cref="Two" /><see cref="Seconds" />.</summary>
        public static Seconds Two { get; } = new( 2 );

        /// <summary></summary>
        public static Seconds Zero { get; } = new( 0 );

        public IQuantityOfTime ToFinerGranularity() => this.ToMilliseconds();

        public PlanckTimes ToPlanckTimes() => new( ( this.Value * ( Rational )PlanckTimes.InOneSecond ).WholePart );

        public Seconds ToSeconds() => new( this.Value );
        public IQuantityOfTime ToCoarserGranularity() => throw new NotImplementedException();
        ...
        public static Seconds Combine( Seconds left, Rational seconds ) => new( left.Value + seconds );
