...
// 
// File "Weeks.cs" last formatted on 2020-11-28.
...
namespace Librainian.Measurement.Time {
    ...
    public record Weeks( Rational Value ) : IQuantityOfTime, IComparable<Weeks>, IComparable<IQuantityOfTime> {
        /// <summary>52</summary>
        ...
        public IQuantityOfTime ToFinerGranularity() => new( this.Value * Days.InOneWeek );
        ...
        public override String ToString() => this.Value.IsOne ? $"{this.Value} week" : $"{this.Value} weeks";
