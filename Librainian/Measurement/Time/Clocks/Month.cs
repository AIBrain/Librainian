...
// 
// This source code contained in "Month.cs" belongs to Protiguous@Protiguous.com and
...
namespace Librainian.Measurement.Time.Clocks {
	...
	public struct Month : IComparable<Month>, IClockPart {
		...
		public static Month Maximum { get; } = new Month( 31 );

		public static Month Minimum { get; } = new Month( 1 );
		...
		public static implicit operator Month( Byte value ) => new Month( value );
