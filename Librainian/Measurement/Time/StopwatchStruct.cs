...
//
// File "StopwatchStruct.cs" last formatted on 2021-11-30 at 7:19 PM by Protiguous.
...
/// reference types on the managed heap. Because of native calls to QueryPerformanceCounter, this struct will only work on
/// Windows. Note: because this is a struct, instances will be passed by value. This means every time you assign an instance to
/// another variable, or pass it as a parameter, a copy is made. Calling methods like Stop() on one copy, will not have any
/// effect on other copies. Unless you are comfortable with the implications of a pass-by-value mutable struct, it is highly
/// recommended that you only assign each instance to one variable, and do not pass it to other methods.
/// </summary>
/// <copyright>
///     bret@atlantisflight.org
/// </copyright>
...
public struct StopwatchStruct {
	...
	/// <summary>
	/// Stops the stopwatch, if it was running. Calculates the elapsed ticks since it was last started, and adds them to <see
	/// cref="ElapsedCounts" />.
	/// </summary>
	public void Stop() {
		if ( !this.IsRunning ) {
...
public static class StopwatchDLLs {
	...
	/// QueryPerformanceCounter. See: https://msdn.microsoft.com/en-us/library/windows/desktop/ms644905(v=vs.85).aspx
	/// </summary>
