...
//
// File "PlanckTimes.cs" last formatted on 2021-11-30 at 7:19 PM by Protiguous.
...
/// <para>
/// where: \hbar = h / 2 \pi is the reduced Planck constant (sometimes h is used instead of \hbar in the definition[1]) G =
/// gravitational constant c = speed of light in a vacuum s is the SI unit of time, the second. The two digits between
/// parentheses denote the standard error of the estimated value.
/// </para>
/// </summary>
...
public record PlanckTimes( BigInteger Value ) : IQuantityOfTime, IComparable<IQuantityOfTime> {
	...
	/// Meaning Less than zero This instance precedes <paramref name="other" /> in the sort order. Zero This instance occurs in
	/// the same position in the sort order as <paramref name="other" />. Greater than zero This instance follows <paramref
