namespace Librainian.Measurement.Time {
	...
	public static class TimeExtensions {
		...
		/// <summary>
		///     Returns the given <see cref="DateTime" /> with hour and minutes and seconds and milliseconds set At given
		///     values.
		/// </summary>
		/// <param name="current">     The current <see cref="DateTime" /> to be changed.</param>
		/// <param name="hour">        The hour to set time to.</param>
		...
		///     2013-01-05T06:40:20.005 If the next month doesn't have that many days the
		...
		///     exist in next year in same month, number of missing days
		...
		public static DateTime ParseJsonDate( [NotNull] this String input, [CanBeNull] CultureInfo culture ) {
			...
			if ( Int64.TryParse( input, out var unix ) ) {
				return Epochs.Unix.AddSeconds( unix );
			}
		...
		///     2009-12-20T06:40:20.005 If the previous month doesn't have that many days
		...
		///     not exist in previous year in same month, number of
