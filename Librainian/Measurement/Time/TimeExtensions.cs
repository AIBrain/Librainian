...
//
// File "TimeExtensions.cs" last formatted on 2021-11-30 at 7:19 PM by Protiguous.
...
public static class TimeExtensions {
	...
	/// <summary>The ISO 8601 format string. <remarks><span>Doesn't make a good filename because of the :</span></remarks></summary>
	...
	public static DateTime Average( this IEnumerable<DateTime> dates ) {
		if ( dates is null ) {
			throw new NullException( nameof( dates ) );
		}
	...
	/// <summary>Decreases the <see cref="DateTime" /> by given <see cref="TimeSpan" /> value.</summary>
	...
	/// <summary> <para>Determines if the specified year is a leap year.</para> </summary> <param name="year">Year to
	/// test.</param> <copyright> Tommy Dugger & Jared Chavez </copyright>
	...
	/// <summary>
	/// Returns the next month keeping the time component intact. Eg, 2012-12-05T06:40:20.005 = &gt; 2013-01-05T06:40:20.005 If
	/// the next month doesn't have that many days the last day of the next month is used. Eg, 2013-01-31T06:40:20.005 = &gt; 2013-02-28T06:40:20.005
	/// </summary>
	/// <param name="current">The DateTime to adjust</param>
	...
	/// <summary>
	/// Returns the same date (same Day, Month, Hour, Minute, Second etc) in the next calendar year. If that day does not exist
	/// in next year in same month, number of missing days is added to the last day in same month next year.
	/// </summary>
	...
	/// <summary>
	/// Returns the same date (same Day, Month, Hour, Minute, Second etc) in the previous calendar year. If that day does not
	/// exist in previous year in same month, number of missing days is added to the last day in same month previous year.
	/// </summary>
	...
	/// <summary>
	/// Returns the original <see cref="DateTime" /> with Hour, Minute and Second parts changed to supplied hour, minute and
	/// second parameters.
	/// </summary>
	...
	/// <summary>
	/// Returns the original <see cref="DateTime" /> with Hour, Minute, Second and Millisecond parts changed to supplied hour,
	...
	/// <summary>
	/// <para>
	/// Throws an <see cref="OverflowException" /> if the <paramref name="value" /> is lower than <see cref="Decimal.MinValue"
	/// /> or higher than <see cref="Decimal.MaxValue" /> .
	/// </para>
	/// </summary>
	...
	public static TimeSpan TimeStatement( this Action? action ) {
