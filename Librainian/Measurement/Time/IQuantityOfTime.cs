...
//
// File "IQuantityOfTime.cs" last formatted on 2021-11-30 at 7:19 PM by Protiguous.
...
public interface IQuantityOfTime {
	...
	/// <summary>Example: Seconds to Minutes.</summary>
	[DebuggerStepThrough]
	[Pure]
	IQuantityOfTime ToCoarserGranularity();

	/// <summary>Example: Hours to Minutes.</summary>
	[DebuggerStepThrough]
	[Pure]
