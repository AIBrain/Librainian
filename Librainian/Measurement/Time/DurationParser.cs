...
// 
// File "DurationParser.cs" last formatted on 2020-08-14 at 8:38 PM.
...
namespace Librainian.Measurement.Time {
	...
	/// <summary>
	///     Provides some ways to parse a duration of time from a string. Duration strings are formatted as a positive numeric
	///     value followed by a unit. The possible types of units,
	///     and their possible unit names, are: second - s, sec, secs, second, seconds minute - m, min, mins, minute, minutes
	///     hour - h, hr, hrs, hour, hours day - d, day, days week - w, wk,
	...
	public static class DurationParser {
		...
		[NotNull]
		private static Regex Regex { get; } = new( "(?<Value>[\\-0-9]+)\\s*(?<Unit>[a-z]+)",
