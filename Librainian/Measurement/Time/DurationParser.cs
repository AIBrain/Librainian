...
//
// This source code contained in "DurationParser.cs" belongs to Protiguous@Protiguous.com
...
//
// ***  Project "Librainian"  ***
// File "DurationParser.cs" was last formatted by Protiguous on 2018/06/26 at 1:29 AM.
...
namespace Librainian.Measurement.Time {
	...
	public static class DurationParser {
		...
		private static Regex Regex { get; } =
			new Regex( "(?<Value>[\\-0-9]+)\\s*(?<Unit>[a-z]+)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant );
