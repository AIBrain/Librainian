...
//
// File "Benchmark.cs" last formatted on 2021-11-30 at 7:20 PM by Protiguous.
...
/// <summary>
/// Originally based upon the idea from <see
/// cref="http://github.com/EBrown8534/Framework/blob/master/Evbpc.Framework/Utilities/BenchmarkResult.cs" />.
/// </summary>
...
public static class Benchmark {
	...
	public static AorB WhichIsFaster( Action methodA, Action methodB, TimeSpan? runfor = null ) {
		if ( methodA is null ) {
			throw new NullException( nameof( methodA ) );
		}

		if ( methodB is null ) {
			throw new NullException( nameof( methodB ) );
		}
		...
		return a > b ? AorB.MethodA :
			b > a ? AorB.MethodB : AorB.Same;
	}
}