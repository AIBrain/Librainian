...
//
// Project: "Librainian", File: "Hertz.cs" was last formatted by Protiguous on 2020/03/16 at 2:57 PM.
...
namespace Librainian.Measurement.Frequency {
    ...
    public class Hertz {
        ...
        public Hertz( UInt64 frequency ) : this( frequency: ( Decimal )frequency ) { }

        public Hertz( Double frequency ) : this( frequency: ( Decimal )frequency ) { }

        [NotNull]
        public static implicit operator SpanOfTime( [NotNull] Hertz hertz ) => new Seconds( value: 1.0m / hertz.Value );

        public static implicit operator TimeSpan( [NotNull] Hertz hertz ) => TimeSpan.FromSeconds( value: ( Double )( 1.0m / hertz.Value ) );
