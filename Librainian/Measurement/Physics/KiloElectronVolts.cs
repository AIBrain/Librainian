...
namespace Librainian.Measurement.Physics {
	...
	[Immutable]
	public record KiloElectronVolts(BigDecimal Value ) : IComparable<MilliElectronVolts>, IComparable<ElectronVolts>, IComparable<KiloElectronVolts>, IComparable<MegaElectronVolts>,
