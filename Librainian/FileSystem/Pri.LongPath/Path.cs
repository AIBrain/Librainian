	...
	public static class Path {
		...
		public static void ThrowIfInvalidPathChars([JetBrains.Annotations.NotNull] ref String path) {
			...
			if (String.IsNullOrEmpty(path.Trim())) {
				throw new ArgumentNullException(nameof(path), $"{nameof(path)} cannot be null or whitespace.");
			}
			*/
		...
		[JetBrains.Annotations.NotNull]
		public static String Combine([JetBrains.Annotations.NotNull] this String path1, [JetBrains.Annotations.NotNull] String path2) {
		...
		[JetBrains.Annotations.NotNull]
		public static String Combine([JetBrains.Annotations.NotNull] this String path1, [JetBrains.Annotations.NotNull] String path2,
			[JetBrains.Annotations.NotNull] String path3) => Combine(path1, path2).Combine(path3);
		...
		[JetBrains.Annotations.NotNull]
		public static String Combine([JetBrains.Annotations.NotNull][ItemNotNull] params String[] paths) {
			if (paths == null) {
