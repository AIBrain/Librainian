...
namespace Librainian.FileSystem.Pri.LongPath {
	...
	public static class File {
		...
		[NotNull]
		public static StreamWriter AppendText( [NotNull] String path ) => CreateStreamWriter( path, true );
		...
		///     <see langword="true" /> if <paramref name="destinationPath" /> should be overwritten if it
		///     refers to an existing file, otherwise, <see langword="false" />.
		/// </param>
		...
		///     <paramref name="sourcePath" /> and/or <paramref name="destinationPath" /> is an empty string (""), contains only
		///     white space, or contains one
		///     or more invalid characters as defined in <see cref="Path.GetInvalidPathChars" />.
		///     <para>-or-</para>
		///     <paramref name="sourcePath" /> and/or <paramref name="destinationPath" /> contains one or more components that
		///     exceed the drive-defined maximum length. For example, on
		///     Windows-based platforms, components must not exceed 255 characters.
		/// </exception>
		/// <exception cref="PathTooLongException">
		///     <paramref name="sourcePath" /> and/or <paramref name="destinationPath" /> exceeds the system-defined maximum
		///     length. For example, on
		...
		///     <paramref name="overwrite" /> is false and <paramref name="destinationPath" /> refers to a file that already
		///     exists.
		///     <para>-or-</para>
		///     <paramref name="sourcePath" /> and/or <paramref name="destinationPath" /> is a directory.
		///     <para>-or-</para>
		///     <paramref name="overwrite" /> is true and <paramref name="destinationPath" /> refers to a file that already exists
		///     and is in use.
		///     <para>-or-</para>
		...
		[NotNull]
		public static FileStream Create( [NotNull] String path ) => Create( path, Common.DefaultBufferSize );
		...
		/// <returns>
		///     <see langword="true" /> if <paramref name="path" /> refers to an existing file; otherwise,
		///     <see langword="false" />.
		/// </returns>
		/// <remarks>
		///     Note that this method will return false if any error occurs while trying to determine if the specified file exists.
		///     This includes situations that would normally result in
		///     thrown exceptions including (but not limited to); passing in a file name with invalid or too many characters, an
		///     I/O error such as a failing or missing disk, or if the caller does
		...
		/// <param name="access">
		///     One of the <see cref="FileAccess" /> value that specifies the operations that can be performed on
		///     the file.
		/// </param>
		/// <param name="mode">
		///     One of the <see cref="FileMode" /> values that specifies whether a file is created if one does not exist, and
		///     determines whether the contents of existing files
		...
		///     The caller does not have the required access permissions.
		///     <para>-or-</para>
		///     <paramref name="path" /> refers to a file that is read-only and <paramref name="access" /> is not
		...
		/// </param>
		/// <param name="share">
		///     One of the <see cref="FileShare" /> values specifying the type of access other threads have to the
		///     file.
		/// </param>
		/// <returns>A <see cref="FileStream" /> that provides access to the file specified in <paramref name="path" />.</returns>
		/// <exception cref="ArgumentNullException"><paramref name="path" /> is <see langword="null" />.</exception>
		...
		///     An <see cref="Int32" /> containing the number of bytes to buffer for reads and writes to the file, or 0 to
		///     specified the default buffer size,
		///     DefaultBufferSize.
		/// </param>
		/// <param name="options">
		///     One or more of the <see cref="FileOptions" /> values that describes how to create or overwrite
		///     the file.
		/// </param>
		/// <returns>A <see cref="FileStream" /> that provides access to the file specified in <paramref name="path" />.</returns>
		/// <exception cref="ArgumentNullException"><paramref name="path" /> is <see langword="null" />.</exception>
