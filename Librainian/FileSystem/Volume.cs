...
//
// File "Volume.cs" last formatted on 2021-11-30 at 7:17 PM by Protiguous.
...
public class Volume : Device {
	...
	public String? GetLogicalDrive() {
		...
		var deviceClass = ( VolumeDeviceClass )this.DeviceClass;
		return deviceClass.LogicalDrives.TryGetValue( volumeName, out var logicalDrive ) ? logicalDrive : null;
	}
