...
//
// File "FolderBag.cs" last formatted on 2021-11-30 at 7:17 PM by Protiguous.
...
public class FolderBag : IEnumerable<Folder> {
	...
	public Boolean Add( String folderpath ) {
		if ( folderpath == null ) {
			throw new NullException( nameof( folderpath ) );
		}
	...
	public UInt64 AddRange( IEnumerable<String> folderpaths ) {
		if ( folderpaths is null ) {
			throw new NullException( nameof( folderpaths ) );
		}
