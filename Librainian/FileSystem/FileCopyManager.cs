...
//
// File "FileCopyManager.cs" last formatted on 2021-11-30 at 7:17 PM by Protiguous.
...
public class FileCopyManager {
	...
	/// <summary>Each <see cref="SourceFilesToBeCopied" /> still needs to be awaited.</summary>
	...
	public async Task LoadFilesToBeCopied(
		...
		if ( sourceFiles is null ) {
			throw new NullException( nameof( sourceFiles ) );
		}
