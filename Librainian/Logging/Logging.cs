...
// 
// This source code contained in "LoggingExtensions.cs" belongs to Protiguous@Protiguous.com and
...
// 
// Project: "Librainian", "LoggingExtensions.cs" was last formatted by Protiguous on 2018/10/11 at 6:39 PM.
...
namespace Librainian.Logging {
    ...
    public static class Logging {
        ...
        public static void Break<T>( this T obj, [CanBeNull] String message = null ) {
        ...
        public static (Color fore, Color back) Colors( this LoggingLevel loggingLevel ) {
            ...
            switch ( loggingLevel ) {
                ...
                case LoggingLevel.SubspaceTear: {
                    return ( Color.HotPink, Color.Aqua ); //hotpink might actually look okay, lol.
                }
        ...
        public static void Debug( this String message ) => Logger.Debug( message );

        public static void Debug( this Exception exception ) => Logger.Debug( exception );

        public static void Debug<T>( this T message ) => Logger.Debug( message );

        public static void Diagnostic( this String message ) => Logger.Info( message );

        public static void Diagnostic( this Exception exception ) => Logger.Info( exception );

        public static void Diagnostic<T>( this T message ) => Logger.Info( message );

        public static void Error( this String message ) => Logger.Error( message );

        public static void Error( this Exception exception ) => Logger.Error( exception );

        public static void Error<T>( this T message ) => Logger.Error( message );

        public static void Fatal( this String message ) => Logger.Fatal( message );

        public static void Fatal( this Exception exception ) => Logger.Fatal( exception );

        public static void Fatal<T>( this T message ) => Logger.Fatal( message );

        public static void Info( this String message ) => Logger.Info( message );

        public static void Info( this Exception exception ) => Logger.Info( exception );

        public static void Info<T>( this T message ) => Logger.Info( message );
            ...
            target = new RichTextBoxTarget {
                ...
                Layout =
                    new CsvLayout {
                        ...
                        Columns = {
                            new CsvColumn( "Time", layout: "${longdate}" ),
                            new CsvColumn( "Message", layout: "${message}" )
                        }
                    },
