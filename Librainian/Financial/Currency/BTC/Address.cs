...
namespace Librainian.Financial.Currency.BTC {
    ...
    public class Address {
        ...
        public static ThreadLocal<SHA256> SHA256 { get; } = new( () => new SHA256Managed() );
        ...
        public Hash EitherHash {
            get {
                ...
                return this._scriptHash ?? throw new InvalidOperationException();
            }
        }
        ...
        public override Boolean Equals( Object? obj ) {
            if ( obj is Address address ) {
                return this.EitherHash.HashBytes.SequenceEqual( address.EitherHash.HashBytes );
            }
