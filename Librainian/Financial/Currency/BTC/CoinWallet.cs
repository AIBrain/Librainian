...
//
// File "CoinWallet.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
...
/// <summary>
/// My first go at a thread-safe CoinWallet class for bitcoin coins. It's more pseudocode for learning than for production..
/// Use at your own risk. Any tips or ideas? Any dos or dont's? Email me!
/// </summary>
[JsonObject]
...
public class CoinWallet : ABetterClassDispose, IEnumerable<KeyValuePair<ICoin, UInt64>>, ICoinWallet {
	...
	/// <summary>
	/// Create an empty wallet with the given <paramref name="id" />. If the given <paramref name="id" /> is null or <see
	/// cref="Guid.Empty" />, a new random <paramref name="id" /> is generated.
	/// </summary>
	/// <param name="id"></param>
