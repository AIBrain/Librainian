...
//
// File "ICoinWallet.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
...
public interface ICoinWallet {
	...
	/// <summary>
	/// Attempt to <see cref="CoinWallet.TryWithdraw(ICoin,UInt64)" /> one or more <see cref="ICoin" /> from this <see
	/// cref="CoinWallet" /> .
	/// </summary>
