...
//
// Project: "Librainian", "Wallet.cs" was last formatted by Protiguous on 2018/07/10 at 9:04 PM.
...
namespace Librainian.Financial.Containers.Wallets
{
    ...
    public class Wallet : ABetterClassDispose, IEnumerable<KeyValuePair<IDenomination, UInt64>>
    {
        ...
        {
            if (bankNote == null) { throw new ArgumentNullException(nameof(bankNote)); }
        ...
        {
            if (denomination == null) { throw new ArgumentNullException(nameof(denomination)); }
