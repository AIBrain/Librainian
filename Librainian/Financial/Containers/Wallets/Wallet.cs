...
//
// File "Wallet.cs" last formatted on 2021-11-30 at 7:18 PM by Protiguous.
...
/// <summary>
/// My go at a thread-safe Wallet class for US dollars and coins. It's more pseudocode for learning than for production.. Use
/// at your own risk. Any tips or ideas? Any dos or don'ts? Email me!
/// </summary>
...
public class Wallet : ABetterClassDispose, IEnumerable<(IDenomination, UInt64)> {
	...
	/// <summary>
	/// Attempt to <see cref="TryWithdraw(IBankNote,UInt64)" /> one or more <see cref="IBankNote" /> from this <see
	/// cref="Wallet" />.
	/// </summary>
