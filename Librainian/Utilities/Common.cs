...
namespace Librainian {
	...
	public static class Common {
		...
		/// <summary>
		/// Returns a new <typeparamref name="T" /> that is the value of <paramref name="self" />, constrained between <paramref name="min" /> and <paramref name="max" />.
		/// </summary>
		...
		/// <para>If <paramref name="left" /> is equal to <paramref name="right" /> then return null for classes or the default value for value types.</para>
