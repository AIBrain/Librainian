...
//
// File "GuidUtility.cs" last formatted on 2021-11-30 at 7:17 PM by Protiguous.
...
public static class GuidUtility {
	...
	/// <remarks>
	/// See <a href="http://code.logos.com/blog/2011/04/generating_a_deterministic_guid.html">Generating a deterministic
	/// GUID</a> .
	/// </remarks>
	...
	public static Guid Create( Guid namespaceId, String name, Int32 version ) {
		...
		// set the four most significant bits (bits 12 through 15) of the time_hi_and_version field to the appropriate 4-bit
