...
//
// ***  Project "Librainian"  ***
// File "DerivedSerializableExceptionWithAdditionalCustomProperty.cs" was last formatted by Protiguous on 2018/06/26 at 1:02 AM.
...
namespace Librainian.Extensions {
	...
	public sealed class DerivedSerializableExceptionWithAdditionalCustomProperty : SerializableExceptionWithCustomProperties {
		...
		public DerivedSerializableExceptionWithAdditionalCustomProperty( String message, String username, String resourceName, IList<String> validationErrors, Exception innerException ) : base( message,
			resourceName, validationErrors, innerException ) =>
			this.Username = username;
