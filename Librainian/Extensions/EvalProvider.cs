...
// 
// File "EvalProvider.cs" last formatted on 2020-08-14 at 8:33 PM.
...
namespace Librainian.Extensions {
	...
	public static class EvalProvider {
		...
		/// <returns></returns>
		[NotNull]
		public static Func<T, TResult> CreateEvalMethod<T, TResult>(
			[CanBeNull] String? code,
			[CanBeNull] String[] usingStatements = null,
