...
namespace Librainian.Extensions {
	...
	public static class Types {
		...
		public static Boolean CanAssignValue( [NotNull] this PropertyInfo p, [CanBeNull] Object value ) => value == null ? p.IsNullable() : p.PropertyType.IsInstanceOfType( value );
		...
		public static Boolean IsBlittable( [NotNull] this Type @this ) {
			if ( @this == null ) { throw new ArgumentNullException( nameof( @this ), "IsBlittable called on a null Type." ); }
		...
		public static Boolean IsNumeric( [NotNull] this Type @this ) {
			if ( @this == null ) { throw new ArgumentNullException( nameof( @this ), "IsNumeric called on a null Type." ); }
