...
//
// File "Utility.cs" last formatted on 2021-11-30 at 7:17 PM by Protiguous.
...
public static class Utility {
	...
	/// <summary>
	/// Copy from one stream to another. Example: using(var stream = response.GetResponseStream()) using(var ms = new
	/// MemoryStream()) { stream.CopyTo(ms); // Do something with copied data }
	/// </summary>
