...
// 
// File "BooleanPredicateBuilder.cs" last formatted on 2020-08-14 at 8:33 PM.
...
namespace Librainian.Extensions {
	...
	public static class BooleanPredicateBuilder {
		...
		[NotNull]
		public static Expression<Func<T, Boolean>> And<T>( [NotNull] this Expression<Func<T, Boolean>> a, [NotNull] Expression<Func<T, Boolean>> b ) =>
			Expression.Lambda<Func<T, Boolean>>( Expression.AndAlso( a.Body, Expression.Invoke( b, a.Parameters ) ), a.Parameters );
