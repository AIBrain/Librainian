...
// 
// This source code contained in "NativeWin32.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "NativeWin32.cs" was last formatted by Protiguous on 2020/03/16 at 3:10 PM.
...
namespace Librainian.OperatingSystem {
    ...
    public static class NativeWin32 {
        ...
        [DllImport( dllName: "kernel32.dll", ExactSpelling = true, SetLastError = true, CharSet = CharSet.Auto )]
        ...
        [DllImport( dllName: "kernel32.dll", EntryPoint = "DeviceIoControl", SetLastError = true )]
        ...
        [DllImport( dllName: "kernel32.dll", CharSet = CharSet.Auto, SetLastError = true, BestFitMapping = false )]
        ...
        [DllImport( dllName: "user32.dll", EntryPoint = "GetDesktopWindow" )]
        public static extern IntPtr GetDesktopWindow();

        [DllImport( dllName: "kernel32.dll", SetLastError = true, PreserveSig = true )]
        ...
        public static String GetErrorMessage( Int32 code ) {
            var message = new StringBuilder( capacity: 255 );

            FormatMessage( dwFlags: FORMAT_MESSAGE_FROM_SYSTEM, lpSource: IntPtr.Zero, dwMessageId: ( UInt32 ) code, dwLanguageId: 0, lpBuffer: message,
                nSize: ( UInt32 ) message.Capacity, arguments: IntPtr.Zero );
        ...
        /// </summary>
        [DllImport( dllName: "netapi32.dll", EntryPoint = "NetApiBufferFree" )]
        ...
        [DllImport( dllName: "netapi32.dll", EntryPoint = "NetServerEnum" )]
        ...
        [DllImport( dllName: "shlwapi.dll", CharSet = CharSet.Auto )]
