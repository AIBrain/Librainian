...
// 
// Project: "LibrainianCore", File: "DocumentCopyStatistics.cs" was last formatted by Protiguous on 2020/03/16 at 3:09 PM.
...
namespace Librainian.OperatingSystem.FileSystem {
    ...
    public class DocumentCopyStatistics {
        ...
        public Double BytesPerMillisecond() {
            if ( Math.Abs( value: this.TimeTaken.TotalMilliseconds ) < Double.Epsilon ) {
                return 0;
            }
        ...
        public Double MegabytesPerSecond() {
            if ( Math.Abs( value: this.TimeTaken.TotalSeconds ) < Double.Epsilon ) {
                return 0;
            }
