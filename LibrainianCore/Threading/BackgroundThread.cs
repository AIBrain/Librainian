...
// 
// This source code contained in "BackgroundThread.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "BackgroundThread.cs" was last formatted by Protiguous on 2020/03/16 at 3:12 PM.
...
namespace Librainian.Threading {
    ...
    public class BackgroundThread : ABetterClassDispose {
        ...
        [NotNull]
        public AutoResetEvent Signal { get; } = new AutoResetEvent( initialState: true );
        ...
        public BackgroundThread( [NotNull] Action loop, Boolean autoStart, [NotNull] out CancellationTokenSource cancellationTokenSource ) {
            ...
            this.thread = new Thread( start: () => {
                while ( !this.Token.IsCancellationRequested ) {
                    if ( this.Signal.WaitOne( timeout: Seconds.Five ) ) {
                        try {
