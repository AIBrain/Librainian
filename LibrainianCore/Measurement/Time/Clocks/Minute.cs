...
// 
// This source code contained in "Minute.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "Minute.cs" was last formatted by Protiguous on 2020/03/16 at 3:07 PM.
...
namespace Librainian.Measurement.Time.Clocks {
    ...
    public struct Minute : IClockPart {
        ...
        public static Minute Maximum { get; } = new Minute( value: MaxValue );

        public static Minute Minimum { get; } = new Minute( value: MinValue );
        ...
        public static implicit operator Minute( SByte value ) => new Minute( value: value );
