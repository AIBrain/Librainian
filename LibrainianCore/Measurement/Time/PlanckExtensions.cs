...
// 
// This source code contained in "PlanckExtensions.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "PlanckExtensions.cs" was last formatted by Protiguous on 2020/03/16 at 3:08 PM.
...
namespace Librainian.Measurement.Time {
    ...
    public static class PlanckExtensions {
        ...
        public static BigInteger PullPlancks( this Double constant, ref BigInteger planckTimes ) {
            ...
            var pullPlancks = planckTimes / ( Rational ) constant;
            planckTimes -= ( pullPlancks * ( Rational ) constant ).WholePart;

            return pullPlancks.WholePart;
        }
