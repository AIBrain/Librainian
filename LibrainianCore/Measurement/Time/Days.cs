...
// 
// Project: "LibrainianCore", File: "Days.cs" was last formatted by Protiguous on 2020/03/16 at 3:08 PM.
...
namespace Librainian.Measurement.Time {
    ...
    public struct Days : IComparable<Days>, IQuantityOfTime, IEquatable<Days> {
        ...
        public Boolean Equals( Days other ) => Equals( objA: this.Value, objB: other.Value );
        ...
        public override Boolean Equals( Object obj ) {
            ...
            return obj is Days days && this.Equals( other: days );
        }
