...
// 
// This source code contained in "Time.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "Time.cs" was last formatted by Protiguous on 2020/03/16 at 3:08 PM.
...
namespace Librainian.Measurement.Time {
    ...
    public struct Time {
        ...
        public static Time Zero = new Time( hour: Hour.Minimum, minute: Minute.Minimum, second: Second.Minimum, millisecond: Millisecond.Minimum );
        ...
        public Time( SByte hour = 0, SByte minute = 0, SByte second = 0, Int16 millisecond = 0, Int16 microsecond = 0 ) : this() {
            this.Hour = new Hour( value: hour );
            this.Minute = minute;
            this.Second = second;
            this.Millisecond = millisecond;
            this.Microsecond = new Microsecond( value: microsecond );
        }
        ...
        public static explicit operator Time( DateTime dateTime ) =>
            new Time( hour: ( SByte ) dateTime.Hour, minute: ( SByte ) dateTime.Minute, second: ( SByte ) dateTime.Second, millisecond: ( Int16 ) dateTime.Millisecond );
