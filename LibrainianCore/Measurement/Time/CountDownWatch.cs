...
// 
// Project: "LibrainianCore", File: "CountDownWatch.cs" was last formatted by Protiguous on 2020/03/16 at 3:07 PM.
...
namespace Librainian.Measurement.Time {
    ...
    public class CountDownWatch {
        ...
        public void Start() {
            ...
            this.Timer = FluentTimer.Start( timer: this.Countdown.Create( onTick: () => {
                this.Stop();
                this.Liftoff();
            } ).Once() );
        }
