...
// 
// Project: "LibrainianCore", File: "Extensions.cs" was last formatted by Protiguous on 2020/03/16 at 3:07 PM.
...
namespace Librainian.Measurement.Physics {
    ...
    public static class Extensions {
        ...
        public static String Simpler( this ElectronVolts volts ) {
            ...
            return list.OrderBy( keySelector: s => s.Length ).First();
        }
        ...
        public static MegaElectronVolts Sum( [NotNull] this IEnumerable<ElectronVolts> volts ) {
            ...
            return volts.Aggregate( seed: MegaElectronVolts.Zero, func: ( current, electronVolts ) => current + electronVolts.ToMegaElectronVolts() );
        }
