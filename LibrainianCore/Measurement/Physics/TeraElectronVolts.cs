...
// 
// This source code contained in "TeraElectronVolts.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "TeraElectronVolts.cs" was last formatted by Protiguous on 2020/03/16 at 3:07 PM.
...
namespace Librainian.Measurement.Physics {
    ...
    public struct TeraElectronVolts : IComparable<MilliElectronVolts>, IComparable<ElectronVolts>, IComparable<MegaElectronVolts>, IComparable<TeraElectronVolts> {
        ...
        /// <summary></summary>
        public static readonly TeraElectronVolts One = new TeraElectronVolts( units: 1m );

        /// <summary></summary>
        public static readonly TeraElectronVolts Zero = new TeraElectronVolts( units: 0m );
        ...
        public static TeraElectronVolts operator *( TeraElectronVolts left, Rational right ) => new TeraElectronVolts( units: left.Value * right );

        public static TeraElectronVolts operator *( Rational left, TeraElectronVolts right ) => new TeraElectronVolts( units: left * right.Value );

        public static TeraElectronVolts operator +( GigaElectronVolts left, TeraElectronVolts right ) =>
            new TeraElectronVolts( units: left.ToTeraElectronVolts().Value + right.Value );

        public static TeraElectronVolts operator +( TeraElectronVolts left, TeraElectronVolts right ) => new TeraElectronVolts( units: left.Value + right.Value );

        public static Boolean operator <( TeraElectronVolts left, TeraElectronVolts right ) => left.Value.CompareTo( other: right.Value ) < 0;

        public static Boolean operator >( TeraElectronVolts left, TeraElectronVolts right ) => left.Value.CompareTo( other: right.Value ) > 0;

        public Int32 CompareTo( ElectronVolts other ) => this.Value.CompareTo( other: other.ToTeraElectronVolts().Value );

        public Int32 CompareTo( MegaElectronVolts other ) => this.Value.CompareTo( other: other.ToTeraElectronVolts().Value );

        public Int32 CompareTo( MilliElectronVolts other ) => this.Value.CompareTo( other: other.ToTeraElectronVolts().Value );

        public Int32 CompareTo( TeraElectronVolts other ) => this.Value.CompareTo( other: other.Value );
