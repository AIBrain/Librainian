...
// 
// This source code contained in "Benchmark.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "Benchmark.cs" was last formatted by Protiguous on 2020/03/16 at 3:08 PM.
...
namespace Librainian.Measurement {
    ...
    public static class Benchmark {
        ...
        public static AorB WhichIsFaster( [NotNull] Action methodA, [NotNull] Action methodB, TimeSpan? runfor = null ) {
            ...
            var a = methodA.GetBenchmark( runFor: runfor );

            var b = methodB.GetBenchmark( runFor: runfor );
