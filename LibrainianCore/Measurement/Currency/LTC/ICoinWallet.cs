...
// 
// This source code contained in "ICoinWallet.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "ICoinWallet.cs" was last formatted by Protiguous on 2020/03/16 at 3:07 PM.
...
namespace Librainian.Measurement.Currency.LTC {
    ...
    public interface ICoinWallet {
        ...
        /// <summary>Attempt to <see cref="CoinWallet.TryWithdraw(BTC.ICoin,UInt64)" /> one or more <see cref="ICoin" /> from this <see cref="CoinWallet" /> .</summary>
