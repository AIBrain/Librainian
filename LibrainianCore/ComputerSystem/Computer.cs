...
//
// Project: "LibrainianCore", File: "Computer.cs" was last formatted by Protiguous on 2020/03/16 at 3:03 PM.
...
namespace Librainian.ComputerSystem {
    ...
    public class Computer {
        ...
        public IEnumerable<String> GetVersions() =>
            AppDomain.CurrentDomain.GetAssemblies().Select( selector: assembly => $"Assembly: {assembly.GetName().Name}, {assembly.GetName().Version}" );
