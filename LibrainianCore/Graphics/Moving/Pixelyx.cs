...
//
// Project: "LibrainianCore", File: "Pixelyx.cs" was last formatted by Protiguous on 2020/03/16 at 3:05 PM.
...
namespace Librainian.Graphics.Moving {
    ...
    public class Pixelyx : IEquatable<Pixelyx> {
        ...
        public Boolean Equals( Pixelyx other ) => Equal( left: this, right: other );
