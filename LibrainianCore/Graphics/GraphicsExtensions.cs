...
//
// This source code contained in "GraphicsExtensions.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "LibrainianCore", File: "GraphicsExtensions.cs" was last formatted by Protiguous on 2020/03/16 at 3:05 PM.
...
namespace Librainian.Graphics {
    ...
    public static class GraphicsExtensions {
        ...
        public static RAMP GetGamma() {
            ...
            if ( NativeMethods.GetDeviceGammaRamp( hDC: NativeMethods.GetDC( hWnd: IntPtr.Zero ), lpRamp: ref ramp ) ) {
                _gotGamma = true;

                return ramp;
            }

            throw new InvalidOperationException( message: "Unable to obtain Gamma setting." );
        }
        ...
        public static void ResetGamma() {
            if ( _gotGamma ) {
                NativeMethods.SetDeviceGammaRamp( hDC: NativeMethods.GetDC( hWnd: IntPtr.Zero ), lpRamp: ref DefaultRamp );
            }
            else {
                throw new InvalidOperationException( message: "Unable to obtain Gamma setting on this device." );
            }
        }

        public static void SetGamma( Int32 gamma ) {
            if ( gamma.Between( startInclusive: 1, endInclusive: 256 ) ) {
                var ramp = new RAMP {
                    Red = new UInt16[ 256 ],
                ...
                NativeMethods.SetDeviceGammaRamp( hDC: NativeMethods.GetDC( hWnd: IntPtr.Zero ), lpRamp: ref ramp );
            }
        }
