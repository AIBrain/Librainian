...
//
// This source code contained in "CoordinateU64.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "LibrainianCore", File: "CoordinateU64.cs" was last formatted by Protiguous on 2020/03/16 at 3:04 PM.
...
namespace Librainian.Graphics.DDD {
    ...
    public struct CoordinateU64 : IEquatable<CoordinateU64>, IComparable<CoordinateU64> {
        ...
        public static readonly UInt64 Maximum = ( UInt64 )Math.Pow( x: UInt64.MaxValue, y: 1.0 / 3.0 );
        ...
        public CoordinateU64( UInt64Range x ) : this( x: x.Min.Next( maxValue: x.Max ), y: Minimum.Next( maxValue: Maximum ), z: Minimum.Next( maxValue: Maximum ) ) { }

        public CoordinateU64( UInt64Range x, UInt64Range y, UInt64Range z ) : this( x: x.Min.Next( maxValue: x.Max ), y: y.Min.Next( maxValue: y.Max ),
            z: z.Min.Next( maxValue: z.Max ) ) { }
        ...
        public CoordinateU64( UInt64 x, UInt64 y, UInt64 z ) {
            this.X = Math.Max( val1: Minimum, val2: Math.Min( val1: Maximum, val2: x ) );
            this.Y = Math.Max( val1: Minimum, val2: Math.Min( val1: Maximum, val2: y ) );
            this.Z = Math.Max( val1: Minimum, val2: Math.Min( val1: Maximum, val2: z ) );
        ...
        public static UInt64 Distance( CoordinateU64 left, CoordinateU64 right ) {
            ...
            return ( UInt64 )Math.Sqrt( d: num1 * num1 + num2 * num2 + num3 * num3 );
        }
        ...
        public static implicit operator PointF( CoordinateU64 coordinate ) => new PointF( x: coordinate.X, y: coordinate.Y );
        ...
        public static CoordinateU64 Normalize( CoordinateU64 coordinate ) {
            ...
            return new CoordinateU64( x: ( UInt64 )( coordinate.X * num ), y: ( UInt64 )( coordinate.Y * num ), z: ( UInt64 )( coordinate.Z * num ) );
        }

        public static CoordinateU64 operator -( CoordinateU64 v1, CoordinateU64 v2 ) => new CoordinateU64( x: v1.X - v2.X, y: v1.Y - v2.Y, z: v1.Z - v2.Z );
        ...
        [Pure]
        public Int32 CompareTo( CoordinateU64 other ) => this.SquareLength.CompareTo( value: other.SquareLength );
        ...
        /// <returns></returns>
        public Boolean Equals( CoordinateU64 other ) => Equals( left: this, right: other );
        ...
        public override Boolean Equals( Object obj ) {
            ...
            return obj is CoordinateU64 u64 && Equals( left: this, right: u64 );
        }

        /// <summary>preCalc hash of <see cref="X" />, <see cref="Y" />, and <see cref="Z" />. (I have no clue if GetHashCode is called once for immutable objects..?)</summary>
        public override Int32 GetHashCode() => this.X.GetHashMerge( objectB: this.Y.GetHashMerge( objectB: this.Z ) );
