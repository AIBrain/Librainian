...
// 
// This source code contained in "MkModel.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "MkModel.cs" was last formatted by Protiguous on 2020/03/16 at 3:10 PM.
        ...
        public String GenerateRandomCorpus( Int32 numberOfWords ) {
            ...
            while ( numberOfWords.Any() ) {
                ...
                foreach ( var w in randomChain ) {
                    corpus.Append( value: $"{w}{ParsingConstants.Singlespace}" );
