...
// 
// Project: "LibrainianCore", File: "ParagraphExtensions.cs" was last formatted by Protiguous on 2020/03/16 at 3:10 PM.
...
namespace Librainian.Parsing {
    ...
    public static class ParagraphExtensions {
        ...
        public static String FakeLatinSentence( UInt16 wordCount ) {
            var words = Sentence.Parse( sentence: FakeLatin.Split( separator: ' ' ).OrderBy( keySelector: s => Randem.Next() ).Take( count: wordCount )
                                                           .ToStrings( separator: " " ) );
