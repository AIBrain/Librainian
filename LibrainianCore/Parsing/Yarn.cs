namespace LibrainianCore.Parsing {
  ...
  //
  // The Yarn class represents a static string of characters.  Many of
  // the Yarn methods perform some type of transformation on the current
  // instance and return the result as a new Yarn. All comparison methods are
  // implemented as a part of Yarn.  As with arrays, character positions
  // (indices) are zero-based.
  //
  // When passing a null string into a constructor in VJ and VC, the null should be
  // explicitly type cast to a Yarn.
  // For Example:
  // Yarn s = new Yarn((Yarn)null);
  // Console.WriteLine(s);

  /// <summary>
  /// No infringment intended on Microsoft's String class.
  /// This class is purely for learning purposes.
  /// </summary>
  [ComVisible( true )]
  [Serializable]
  public sealed class Yarn : IComparable<Yarn>, ICloneable, IConvertible, IEnumerable<Char>, IEquatable<Yarn>
    {

    /// <summary>
    /// These fields map directly onto the fields in an EE StringObject.  See object.h for the layout.
    /// </summary>
    [NonSerialized] private Int32 m_stringLength;
    ...
    /// </summary>
    private const Int32 TrimHead = 0;

    /// <summary>
    /// These are defined in Com99/src/vm/COMStringCommon.h and must be kept in sync.
    /// </summary>
    private const Int32 TrimTail = 1;

    /// <summary>
    /// These are defined in Com99/src/vm/COMStringCommon.h and must be kept in sync.
    /// </summary>
    private const Int32 TrimBoth = 2;

    /// <summary>
    ///The Empty constant holds the empty string value. It is initialized by the EE during startup.
    ///It is treated as intrinsic by the JIT as so the static constructor would never run.
    /// Leaving it uninitialized would confuse debuggers.
    /// We need to call the Yarn constructor so that the compiler doesn't mark this as a literal.
    /// Marking this as a literal would mean that it doesn't show up as a field which we can access from native.
    /// </summary>
    public static readonly Yarn Empty;
    ...
    //
    public static Yarn Join( Yarn separator, params Yarn[] value ) {
      if ( value == null ) {
    ...
    [ComVisible( false )]
    public static Yarn Join( Yarn separator, params Object[] values ) {
      if ( values == null ) {
    ...
    [ComVisible( false )]
    public static Yarn Join<T>( Yarn separator, IEnumerable<T> values ) {
      if ( values == null ) {
        throw new ArgumentNullException( nameof( values ) );
      }

      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.EndContractBlock();
    ...
    [ComVisible( false )]
    public static Yarn Join( Yarn separator, IEnumerable<Yarn> values ) {
      if ( values == null ) {
        throw new ArgumentNullException( nameof( values ) );
      }
      ...
      using ( IEnumerator<Yarn> en = values.GetEnumerator() ) {
        if ( !en.MoveNext() ) {
          return Empty;
        }
...
#else
    private const Int32 charPtrAlignConst = 1;
    private const Int32 alignConst = 3;
#endif

    internal Char FirstChar => this.m_firstChar;

    // Joins an array of strings together as one string with a separator between each original string.
    //
    [System.Security.SecuritySafeCritical]  // auto-generated
    public unsafe static Yarn Join( Yarn separator, Yarn[] value, Int32 startIndex, Int32 count ) {
      ...
      for ( Int32 stringToJoinIndex = startIndex; stringToJoinIndex <= endIndex; stringToJoinIndex++ ) {
      ...
      fixed ( Char* pointerToJointString = &jointString.m_firstChar ) {
        ...
        for ( Int32 stringToJoinIndex = startIndex + 1; stringToJoinIndex <= endIndex; stringToJoinIndex++ ) {
          charBuffer.AppendString( separator );
          charBuffer.AppendString( value[ stringToJoinIndex ] );
        }
        Contract.Assert( *( pointerToJointString + charBuffer.Length ) == '\0', "Yarn must be null-terminated!" );
      }
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    private unsafe static Int32 CompareOrdinalIgnoreCaseHelper( Yarn strA, Yarn strB ) {
      Contract.Requires( strA != null );
      Contract.Requires( strB != null );
      Contract.EndContractBlock();
      Int32 length = Math.Min( strA.Length, strB.Length );
      ...
      fixed ( Char* ap = &strA.m_firstChar ) {
        fixed ( Char* bp = &strB.m_firstChar ) {
          ...
          while ( length != 0 ) {
            ...
            if ( ( UInt32 )( charA - 'a' ) <= ( UInt32 )( 'z' - 'a' ) ) {
              charA -= 0x20;
            }

            if ( ( UInt32 )( charB - 'a' ) <= ( UInt32 )( 'z' - 'a' ) ) {
              charB -= 0x20;
            }
    ...
    internal static extern Int32 nativeCompareOrdinalEx( Yarn strA, Int32 indexA, Yarn strB, Int32 indexB, Int32 count );
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    unsafe internal static extern Int32 nativeCompareOrdinalIgnoreCaseWC( Yarn strA, SByte* strBBytes );
    //
    ...
    internal unsafe static String SmallCharToUpper( String strIn ) {
      ...
      // less than 0x80.
      //
      Int32 length = strIn.Length;
      Yarn strOut = FastAllocateString( length );
    ...
    private unsafe static Boolean EqualsHelper( Yarn strA, Yarn strB ) {
      Contract.Requires( strA != null );
      Contract.Requires( strB != null );
      Contract.Requires( strA.Length == strB.Length );

      Int32 length = strA.Length;
      ...
      fixed ( Char* ap = &strA.m_firstChar ) {
        fixed ( Char* bp = &strB.m_firstChar ) {
          ...
          while ( length >= 10 ) {
            ...
            if ( *( Int32* )( a + 2 ) != *( Int32* )( b + 2 ) ) {
              return false;
            }

            if ( *( Int32* )( a + 4 ) != *( Int32* )( b + 4 ) ) {
              return false;
            }

            if ( *( Int32* )( a + 6 ) != *( Int32* )( b + 6 ) ) {
              return false;
            }

            if ( *( Int32* )( a + 8 ) != *( Int32* )( b + 8 ) ) {
              return false;
            }
          ...
          // This depends on the fact that the Yarn objects are
    ...
    private unsafe static Boolean EqualsIgnoreCaseAsciiHelper( Yarn strA, Yarn strB ) {
      Contract.Requires( strA != null );
      Contract.Requires( strB != null );
          ...
          while ( length != 0 ) {
            ...
            if ( charA == charB ||
                 ( ( charA | 0x20 ) == ( charB | 0x20 ) &&
                   ( UInt32 )( ( charA | 0x20 ) - 'a' ) <= ( UInt32 )( 'z' - 'a' ) ) ) {
              a++;
              b++;
              length--;
            }
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    private unsafe static Int32 CompareOrdinalHelper( Yarn strA, Yarn strB ) {
      Contract.Requires( strA != null );
      Contract.Requires( strB != null );
    ...
    [Pure]
    [ReliabilityContract( Consistency.WillNotCorruptState, Cer.MayFail )]
    public Boolean Equals( Yarn value ) {
      if ( this == null )                        //this is necessary to guard against reverse-pinvokes and
      {
        throw new NullReferenceException();  //other callers who do not use the callvirt instruction
      }
    ...
    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    public Boolean Equals( Yarn value, StringComparison comparisonType ) {
    ...
    // Determines whether two Strings match.
    [Pure]
    public static Boolean Equals( Yarn a, Yarn b ) {
    ...
    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Boolean Equals( Yarn a, Yarn b, StringComparison comparisonType ) {
      if ( comparisonType < StringComparison.CurrentCulture || comparisonType > StringComparison.OrdinalIgnoreCase ) {
        throw new ArgumentException( Environment.GetResourceString( "NotSupported_StringComparison" ), nameof( comparisonType ) );
      }
    ...
    public static Boolean operator ==( Yarn a, Yarn b ) => Equals( a, b );
    ...
    [IndexerName( "Chars" )]
    public extern Char this[ Int32 index ] {
      [ResourceExposure( ResourceScope.None )]
      [MethodImpl( MethodImplOptions.InternalCall )]
    ...
    //
    [System.Security.SecuritySafeCritical]  // auto-generated
    unsafe public void CopyTo( Int32 sourceIndex, Char[] destination, Int32 destinationIndex, Int32 count ) {
      if ( destination == null ) {
    ...
    //
    [System.Security.SecuritySafeCritical]  // auto-generated
    unsafe public Char[] ToCharArray( Int32 startIndex, Int32 length ) {
    ...
    [Pure]
    public static Boolean IsNullOrEmpty( Yarn value ) => ( value == null || value.Length == 0 );

    [Pure]
    public static Boolean IsNullOrWhiteSpace( Yarn value ) {
      if ( value == null ) {
        return true;
      }
    ...
    public override Int32 GetHashCode() {
      ...
      unsafe {
        fixed ( Char* src = this ) {
          ...
          Contract.Assert( ( ( Int32 )src ) % 4 == 0, "Managed string should start at 4 bytes boundary" );
          ...
          // value from GetHashCode to disk or count on Yarn A 
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ReliabilityContract( Consistency.WillNotCorruptState, Cer.MayFail )]
    internal Int32 GetLegacyNonRandomizedHashCode() {
      unsafe {
        fixed ( Char* src = this ) {
          Contract.Assert( src[ this.Length ] == '\0', "src[this.Length] == '\\0'" );
          Contract.Assert( ( ( Int32 )src ) % 4 == 0, "Managed string should start at 4 bytes boundary" );
    ...
    //
    public Yarn[] Split( params Char[] separator ) {
      Contract.Ensures( Contract.Result<Yarn[]>() != null );
      return this.SplitInternal( separator, Int32.MaxValue, StringSplitOptions.None );
    }
    ...
    // the substring that follows the occurence.  On the other hand, if the separator
    // is not found, the array of strings will contain this instance as its only element.
    // If the spearator is the empty string (i.e., Yarn.Empty), then
    // whitespace (i.e., Character.IsWhitespace) is used as the separator.
    // If there are more than count different strings, the last n-(count-1)
    // elements are concatenated and added as the last Yarn.
    //
    ...
    [ComVisible( false )]
    public Yarn[] Split( Char[] separator, StringSplitOptions options ) {
      Contract.Ensures( Contract.Result<Yarn[]>() != null );
      return this.SplitInternal( separator, Int32.MaxValue, options );
    }

    [ComVisible( false )]
    public Yarn[] Split( Char[] separator, Int32 count, StringSplitOptions options ) {
      Contract.Ensures( Contract.Result<Yarn[]>() != null );
      return this.SplitInternal( separator, count, options );
    }

    [ComVisible( false )]
    internal Yarn[] SplitInternal( Char[] separator, Int32 count, StringSplitOptions options ) {
      if ( count < 0 ) {
      ...
      Int32[] sepList = new Int32[ this.Length ];
      Int32 numReplaces = this.MakeSeparatorList( separator, ref sepList );

      //Handle the special case of no replaces and special count.
      if ( 0 == numReplaces || count == 1 ) {
        Yarn[] stringArray = new Yarn[ 1 ];
        stringArray[ 0 ] = this;
        return stringArray;
      }
    ...
    [ComVisible( false )]
    public Yarn[] Split( Yarn[] separator, StringSplitOptions options ) {
      Contract.Ensures( Contract.Result<Yarn[]>() != null );
      return this.Split( separator, Int32.MaxValue, options );
    }

    [ComVisible( false )]
    public Yarn[] Split( Yarn[] separator, Int32 count, StringSplitOptions options ) {
      if ( count < 0 ) {
        throw new ArgumentOutOfRangeException( "count",
            Environment.GetResourceString( "ArgumentOutOfRange_NegativeCount" ) );
      }
      ...
      if ( options < StringSplitOptions.None || options > StringSplitOptions.RemoveEmptyEntries ) {
        throw new ArgumentException( Environment.GetResourceString( "Arg_EnumIllegalVal", ( Int32 )options ) );
      }
      Contract.EndContractBlock();
      ...
      Int32[] sepList = new Int32[ this.Length ];
      Int32[] lengthList = new Int32[ this.Length ];
      Int32 numReplaces = this.MakeSeparatorList( separator, ref sepList, ref lengthList );
    ...
    private Yarn[] InternalSplitKeepEmptyEntries( Int32[] sepList, Int32[] lengthList, Int32 numReplaces, Int32 count ) {
      ...
      count--;
      Int32 numActualReplaces = ( numReplaces < count ) ? numReplaces : count;

      //Allocate space for the new array.
      //+1 for the string from the end of the last replace to the end of the Yarn.
      Yarn[] splitStrings = new Yarn[ numActualReplaces + 1 ];

      for ( Int32 i = 0; i < numActualReplaces && currIndex < this.Length; i++ ) {
        splitStrings[ arrIndex++ ] = this.Substring( currIndex, sepList[ i ] - currIndex );
        currIndex = sepList[ i ] + ( ( lengthList == null ) ? 1 : lengthList[ i ] );
      }

      //Handle the last string at the end of the array if there is one.
      if ( currIndex < this.Length && numActualReplaces >= 0 ) {
        splitStrings[ arrIndex ] = this.Substring( currIndex );
      }
    ...
    // This function will not keep the Empty Yarn 
    private Yarn[] InternalSplitOmitEmptyEntries( Int32[] sepList, Int32[] lengthList, Int32 numReplaces, Int32 count ) {
      Contract.Requires( numReplaces >= 0 );
      Contract.Requires( count >= 2 );
      Contract.Ensures( Contract.Result<Yarn[]>() != null );
      ...
      Int32 maxItems = ( numReplaces < count ) ? ( numReplaces + 1 ) : count;
      Yarn[] splitStrings = new Yarn[ maxItems ];

      Int32 currIndex = 0;
      Int32 arrIndex = 0;

      for ( Int32 i = 0; i < numReplaces && currIndex < this.Length; i++ ) {
      ...
      Yarn[] stringArray = splitStrings;
      if ( arrIndex != maxItems ) {
        stringArray = new Yarn[ arrIndex ];
        for ( Int32 j = 0; j < arrIndex; j++ ) {
    ...
    //--------------------------------------------------------------------    
    [System.Security.SecuritySafeCritical]  // auto-generated
    private unsafe Int32 MakeSeparatorList( Char[] separator, ref Int32[] sepList ) {
      Int32 foundCount = 0;

      if ( separator == null || separator.Length == 0 ) {
        fixed ( Char* pwzChars = &this.m_firstChar ) {
          //If they passed null or an empty string, look for whitespace.
          for ( Int32 i = 0; i < this.Length && foundCount < sepList.Length; i++ ) {
        ...
        Int32 sepListCount = sepList.Length;
        Int32 sepCount = separator.Length;
        ...
        fixed ( Char* pwzChars = &this.m_firstChar, pSepChars = separator ) {
          for ( Int32 i = 0; i < this.Length && foundCount < sepListCount; i++ ) {
            Char* pSep = pSepChars;
            for ( Int32 j = 0; j < sepCount; j++, pSep++ ) {
              if ( pwzChars[ i ] == *pSep ) {
                sepList[ foundCount++ ] = i;
                break;
              }
    ...
    //--------------------------------------------------------------------    
    [System.Security.SecuritySafeCritical]  // auto-generated
    private unsafe Int32 MakeSeparatorList( Yarn[] separators, ref Int32[] sepList, ref Int32[] lengthList ) {
      Contract.Assert( separators != null && separators.Length > 0, "separators != null && separators.Length > 0" );

      Int32 foundCount = 0;
      Int32 sepListCount = sepList.Length;
      Int32 sepCount = separators.Length;

      fixed ( Char* pwzChars = &this.m_firstChar ) {
        for ( Int32 i = 0; i < this.Length && foundCount < sepListCount; i++ ) {
          for ( Int32 j = 0; j < separators.Length; j++ ) {
            Yarn separator = separators[ j ];
            if ( IsNullOrEmpty( separator ) ) {
              continue;
            }
            Int32 currentSepLength = separator.Length;
            if ( pwzChars[ i ] == separator[ 0 ] && currentSepLength <= this.Length - i ) {
    ...
    //
    public Yarn Substring( Int32 startIndex ) => this.Substring( startIndex, this.Length - startIndex );

    // Returns a substring of this string.
    //
    [System.Security.SecuritySafeCritical]  // auto-generated
    public Yarn Substring( Int32 startIndex, Int32 length ) {
    ...
    [System.Security.SecurityCritical]  // auto-generated
    unsafe String InternalSubString( Int32 startIndex, Int32 length ) {
      ...
      Yarn result = FastAllocateString( length );
    ...
    [Pure]
    public Yarn Trim( params Char[] trimChars ) {
    ...
    public Yarn TrimStart( params Char[] trimChars ) {
      if ( null == trimChars || trimChars.Length == 0 ) {
    ...
    public Yarn TrimEnd( params Char[] trimChars ) {
      if ( null == trimChars || trimChars.Length == 0 ) {
    ...
    // ptr is null, a 0-length string (like Yarn.Empty) is returned.
    //
    [System.Security.SecurityCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [CLSCompliant( false ), MethodImpl( MethodImplOptions.InternalCall )]
    unsafe public extern Yarn( Char* value );
    [System.Security.SecurityCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [CLSCompliant( false ), MethodImpl( MethodImplOptions.InternalCall )]
    unsafe public extern Yarn( Char* value, Int32 startIndex, Int32 length );

    [System.Security.SecurityCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [CLSCompliant( false ), MethodImpl( MethodImplOptions.InternalCall )]
    unsafe public extern Yarn( SByte* value );
    [System.Security.SecurityCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [CLSCompliant( false ), MethodImpl( MethodImplOptions.InternalCall )]
    unsafe public extern Yarn( SByte* value, Int32 startIndex, Int32 length );

    [System.Security.SecurityCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [CLSCompliant( false ), MethodImpl( MethodImplOptions.InternalCall )]
    unsafe public extern Yarn( SByte* value, Int32 startIndex, Int32 length, Encoding enc );

    [System.Security.SecurityCritical]  // auto-generated
    unsafe static private Yarn CreateString( SByte* value, Int32 startIndex, Int32 length, Encoding enc ) {
      if ( enc == null ) {
        return new Yarn( value, startIndex, length ); // default to ANSI
      }
    ...
    [System.Security.SecurityCritical]  // auto-generated
    unsafe static internal Yarn CreateStringFromEncoding(
        Byte* bytes, Int32 byteLength, Encoding encoding ) {
      Contract.Requires( bytes != null );
      Contract.Requires( byteLength >= 0 );

      // Get our string length
      Int32 stringLength = encoding.GetCharCount( bytes, byteLength, null );
      ...
      Yarn s = FastAllocateString( stringLength );
      fixed ( Char* pTempChars = &s.m_firstChar ) {
        Int32 doubleCheck = encoding.GetChars( bytes, byteLength, pTempChars, stringLength, null );
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    unsafe internal Int32 GetBytesFromEncoding( Byte* pbNativeBuffer, Int32 cbNativeBuffer, Encoding encoding ) {
      // encoding == Encoding.UTF8
      fixed ( Char* pwzChar = &this.m_firstChar ) {
        return encoding.GetBytes( pwzChar, this.m_stringLength, pbNativeBuffer, cbNativeBuffer );
      }
    }

    [System.Security.SecuritySafeCritical]  // auto-generated
    unsafe internal Int32 ConvertToAnsi( Byte* pbNativeBuffer, Int32 cbNativeBuffer, Boolean fBestFit, Boolean fThrowOnUnmappableChar ) {
      Contract.Assert( cbNativeBuffer >= ( this.Length + 1 ) * Marshal.SystemMaxDBCSCharSize, "Insufficient buffer length passed to ConvertToAnsi" );

      const UInt32 CP_ACP = 0;
      Int32 nb;

      const UInt32 WC_NO_BEST_FIT_CHARS = 0x00000400;

      UInt32 flgs = ( fBestFit ? 0 : WC_NO_BEST_FIT_CHARS );
      UInt32 DefaultCharUsed = 0;
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public Yarn Normalize( NormalizationForm normalizationForm ) {
#if !FEATURE_NORM_IDNA_ONLY
      if ( this.IsAscii() ) {
        // If its FastSort && one of the 4 main forms, then its already normalized
        if ( normalizationForm == NormalizationForm.FormC ||
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    internal extern static Yarn FastAllocateString( Int32 length );

    [System.Security.SecuritySafeCritical]  // auto-generated
    unsafe private static void FillStringChecked( Yarn dest, Int32 destPos, Yarn src ) {
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    public extern Yarn( Char[] value, Int32 startIndex, Int32 length );
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    public extern Yarn( Char[] value );

    [System.Security.SecurityCritical]  // auto-generated
    internal static unsafe void wstrcpy( Char* dmem, Char* smem, Int32 charCount ) {
      Buffer.Memcpy( ( Byte* )dmem, ( Byte* )smem, charCount * 2 ); // 2 used everywhere instead of sizeof(char)
    }

    [System.Security.SecuritySafeCritical]  // auto-generated
    private Yarn CtorCharArray( Char[] value ) {
      if ( value != null && value.Length != 0 ) {
        Yarn result = FastAllocateString( value.Length );
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    private Yarn CtorCharArrayStartLength( Char[] value, Int32 startIndex, Int32 length ) {
      if ( value == null ) {
        throw new ArgumentNullException( nameof( value ) );
      }
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    private Yarn CtorCharCount( Char c, Int32 count ) {
      if ( count > 0 ) {
        Yarn result = FastAllocateString( count );
        if ( c != 0 ) {
          unsafe {
            fixed ( Char* dest = result ) {
              Char* dmem = dest;
              while ( ( ( UInt32 )dmem & 3 ) != 0 && count > 0 ) {
                *dmem++ = c;
                count--;
              }
    ...
    [System.Security.SecurityCritical]  // auto-generated
    private static unsafe Int32 wcslen( Char* ptr ) {
      Char* end = ptr;
      ...
      Int32 count = ( Int32 )( end - ptr );

      return count;
    }

    [System.Security.SecurityCritical]  // auto-generated
    private unsafe Yarn CtorCharPtr( Char* ptr ) {
      if ( ptr == null ) {
        return Empty;
      }
    ...
    [System.Security.SecurityCritical]  // auto-generated
    private unsafe Yarn CtorCharPtrStartLength( Char* ptr, Int32 startIndex, Int32 length ) {
      if ( length < 0 ) {
        throw new ArgumentOutOfRangeException( "length", Environment.GetResourceString( "ArgumentOutOfRange_NegativeLength" ) );
      }
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    public extern Yarn( Char c, Int32 count );
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Yarn strB ) => CultureInfo.CurrentCulture.CompareInfo.Compare( strA, strB, CompareOptions.None );
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Yarn strB, Boolean ignoreCase ) {
      if ( ignoreCase ) {
    ...
    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Int32 Compare( Yarn strA, Yarn strB, StringComparison comparisonType ) {
      // Single comparison to check if comparisonType is within [CurrentCulture .. OrdinalIgnoreCase]
      if ( ( UInt32 )( comparisonType - StringComparison.CurrentCulture ) >
          ( UInt32 )( StringComparison.OrdinalIgnoreCase - StringComparison.CurrentCulture ) ) {
        throw new ArgumentException( Environment.GetResourceString( "NotSupported_StringComparison" ), nameof( comparisonType ) );
      }
      Contract.EndContractBlock();
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Yarn strB, CultureInfo culture, CompareOptions options ) {
      if ( culture == null ) {
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Yarn strB, Boolean ignoreCase, CultureInfo culture ) {
      if ( culture == null ) {
        throw new ArgumentNullException( nameof( culture ) );
      }
      Contract.EndContractBlock();
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Int32 indexA, Yarn strB, Int32 indexB, Int32 length ) {
      Int32 lengthA = length;
      Int32 lengthB = length;
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Int32 indexA, Yarn strB, Int32 indexB, Int32 length, Boolean ignoreCase ) {
      Int32 lengthA = length;
      Int32 lengthB = length;
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Int32 indexA, Yarn strB, Int32 indexB, Int32 length, Boolean ignoreCase, CultureInfo culture ) {
      if ( culture == null ) {
        throw new ArgumentNullException( nameof( culture ) );
      }
      Contract.EndContractBlock();
    ...
    //
    [Pure]
    public static Int32 Compare( Yarn strA, Int32 indexA, Yarn strB, Int32 indexB, Int32 length, CultureInfo culture, CompareOptions options ) {
      if ( culture == null ) {
        throw new ArgumentNullException( nameof( culture ) );
      }
      Contract.EndContractBlock();
    ...
    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Int32 Compare( Yarn strA, Int32 indexA, Yarn strB, Int32 indexB, Int32 length, StringComparison comparisonType ) {
      if ( comparisonType < StringComparison.CurrentCulture || comparisonType > StringComparison.OrdinalIgnoreCase ) {
        throw new ArgumentException( Environment.GetResourceString( "NotSupported_StringComparison" ), nameof( comparisonType ) );
      }
      Contract.EndContractBlock();
    ...
    // greater than all non-Yarn objects.  Note that this means sorted 
    ...
    public Int32 CompareTo( Object value ) {
      ...
      return Compare( this, ( Yarn )value, StringComparison.CurrentCulture );
    }

    // Determines the sorting relation of StrB to the current instance.
    //
    [Pure]
    public Int32 CompareTo( Yarn strB ) {
      if ( strB == null ) {
        return 1;
      }
    ...
    //
    [Pure]
    public static Int32 CompareOrdinal( Yarn strA, Yarn strB ) {
      if ( ( Object )strA == ( Object )strB ) {
        return 0;
      }
    ...
    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Int32 CompareOrdinal( Yarn strA, Int32 indexA, Yarn strB, Int32 indexB, Int32 length ) {
      if ( strA == null || strB == null ) {
        if ( ( Object )strA == ( Object )strB ) { //they're both null;
          return 0;
        }
    ...
    [Pure]
    public Boolean Contains( String value ) => ( this.IndexOf( ( Char ) value, ( Int32 ) StringComparison.Ordinal ) >= 0 );
    ...
    //        
    [Pure]
    public Boolean EndsWith( Yarn value ) => this.EndsWith( value, StringComparison.CurrentCulture );

    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ComVisible( false )]
    public Boolean EndsWith( Yarn value, StringComparison comparisonType ) {
      if ( ( Object )value == null ) {
        throw new ArgumentNullException( nameof( value ) );
      }
    ...
    [Pure]
    public Boolean EndsWith( Yarn value, Boolean ignoreCase, CultureInfo culture ) {
      if ( null == value ) {
        throw new ArgumentNullException( nameof( value ) );
      }
      Contract.EndContractBlock();
    ...
    [Pure]
    internal Boolean EndsWith( Char value ) {
      Int32 thisLen = this.Length;
      if ( thisLen != 0 ) {
    ...
    //
    [Pure]
    public Int32 IndexOf( Char value ) => this.IndexOf( value, 0, this.Length );

    [Pure]
    public Int32 IndexOf( Char value, Int32 startIndex ) => this.IndexOf( value, startIndex, this.Length - startIndex );

    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    public extern Int32 IndexOf( Char value, Int32 startIndex, Int32 count );
    ...
    //
    [Pure]
    public Int32 IndexOfAny( Char[] anyOf ) => this.IndexOfAny( anyOf, 0, this.Length );

    [Pure]
    public Int32 IndexOfAny( Char[] anyOf, Int32 startIndex ) => this.IndexOfAny( anyOf, startIndex, this.Length - startIndex );

    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    public extern Int32 IndexOfAny( Char[] anyOf, Int32 startIndex, Int32 count );
    ...
    //
    [Pure]
    public Int32 IndexOf( Yarn value ) => this.IndexOf( value, StringComparison.CurrentCulture );
    ...
    //
    [Pure]
    public Int32 IndexOf( Yarn value, Int32 startIndex ) => this.IndexOf( value, startIndex, StringComparison.CurrentCulture );
    ...
    //
    [Pure]
    public Int32 IndexOf( Yarn value, Int32 startIndex, Int32 count ) {
    ...
    [Pure]
    public Int32 IndexOf( Yarn value, StringComparison comparisonType ) => this.IndexOf( value, 0, this.Length, comparisonType );

    [Pure]
    public Int32 IndexOf( Yarn value, Int32 startIndex, StringComparison comparisonType ) => this.IndexOf( value, startIndex, this.Length - startIndex, comparisonType );

    [Pure]
    [System.Security.SecuritySafeCritical]
    public Int32 IndexOf( Yarn value, Int32 startIndex, Int32 count, StringComparison comparisonType ) {
      // Validate inputs
      if ( value == null ) {
        throw new ArgumentNullException( nameof( value ) );
      }
    ...
    //
    [Pure]
    public Int32 LastIndexOf( Char value ) => this.LastIndexOf( value, this.Length - 1, this.Length );

    [Pure]
    public Int32 LastIndexOf( Char value, Int32 startIndex ) => this.LastIndexOf( value, startIndex, startIndex + 1 );

    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    public extern Int32 LastIndexOf( Char value, Int32 startIndex, Int32 count );
    ...
    //ForceInline ... Jit can't recognize Yarn.get_Length to determine that this is "fluff"
    [Pure]
    public Int32 LastIndexOfAny( Char[] anyOf ) => this.LastIndexOfAny( anyOf, this.Length - 1, this.Length );

    //ForceInline ... Jit can't recognize Yarn.get_Length to determine that this is "fluff"
    [Pure]
    public Int32 LastIndexOfAny( Char[] anyOf, Int32 startIndex ) => this.LastIndexOfAny( anyOf, startIndex, startIndex + 1 );

    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    public extern Int32 LastIndexOfAny( Char[] anyOf, Int32 startIndex, Int32 count );
    ...
    //
    [Pure]
    public Int32 LastIndexOf( Yarn value ) => this.LastIndexOf( value, this.Length - 1, this.Length, StringComparison.CurrentCulture );

    [Pure]
    public Int32 LastIndexOf( Yarn value, Int32 startIndex ) => this.LastIndexOf( value, startIndex, startIndex + 1, StringComparison.CurrentCulture );

    [Pure]
    public Int32 LastIndexOf( Yarn value, Int32 startIndex, Int32 count ) {
      if ( count < 0 ) {
        throw new ArgumentOutOfRangeException( "count", Environment.GetResourceString( "ArgumentOutOfRange_Count" ) );
      }
      Contract.EndContractBlock();
    ...
    [Pure]
    public Int32 LastIndexOf( Yarn value, StringComparison comparisonType ) => this.LastIndexOf( value, this.Length - 1, this.Length, comparisonType );

    [Pure]
    public Int32 LastIndexOf( Yarn value, Int32 startIndex, StringComparison comparisonType ) => this.LastIndexOf( value, startIndex, startIndex + 1, comparisonType );

    [Pure]
    [System.Security.SecuritySafeCritical]
    public Int32 LastIndexOf( Yarn value, Int32 startIndex, Int32 count, StringComparison comparisonType ) {
      if ( value == null ) {
        throw new ArgumentNullException( nameof( value ) );
      }
    ...
    //
    [Pure]
    public Yarn PadLeft( Int32 totalWidth ) => this.PadHelper( totalWidth, ' ', false );

    [Pure]
    public Yarn PadLeft( Int32 totalWidth, Char paddingChar ) => this.PadHelper( totalWidth, paddingChar, false );

    [Pure]
    public Yarn PadRight( Int32 totalWidth ) => this.PadHelper( totalWidth, ' ', true );

    [Pure]
    public Yarn PadRight( Int32 totalWidth, Char paddingChar ) => this.PadHelper( totalWidth, paddingChar, true );

    [System.Security.SecuritySafeCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    private extern Yarn PadHelper( Int32 totalWidth, Char paddingChar, Boolean isRightPadded );

    // Determines whether a specified string is a prefix of the current instance
    //
    [Pure]
    public Boolean StartsWith( Yarn value ) {
      if ( ( Object )value == null ) {
        throw new ArgumentNullException( nameof( value ) );
      }
      Contract.EndContractBlock();
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ComVisible( false )]
    public Boolean StartsWith( Yarn value, StringComparison comparisonType ) {
      if ( ( Object )value == null ) {
        throw new ArgumentNullException( nameof( value ) );
      }
    ...
    [Pure]
    public Boolean StartsWith( Yarn value, Boolean ignoreCase, CultureInfo culture ) {
      if ( null == value ) {
        throw new ArgumentNullException( nameof( value ) );
      }
      Contract.EndContractBlock();
    ...
    [Pure]
    public Yarn ToLower( CultureInfo culture ) {
      if ( culture == null ) {
        throw new ArgumentNullException( nameof( culture ) );
      }
      Contract.Ensures( Contract.Result<Yarn>() != null );
    ...
    [Pure]
    public Yarn ToUpper( CultureInfo culture ) {
      if ( culture == null ) {
        throw new ArgumentNullException( nameof( culture ) );
      }
      Contract.Ensures( Contract.Result<Yarn>() != null );
    ...
    public Yarn ToString( IFormatProvider provider ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.EndContractBlock();
      return this;
    }
    ...
    private static Boolean IsBOMWhitespace( Char c ) {
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    private Yarn TrimHelper( Int32 trimType ) {
      //end will point to the first non-trimmed character on the right
      //start will point to the first non-trimmed character on the Left
      Int32 end = this.Length - 1;
      Int32 start = 0;
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    private Yarn TrimHelper( Char[] trimChars, Int32 trimType ) {
      //end will point to the first non-trimmed character on the right
      //start will point to the first non-trimmed character on the Left
      Int32 end = this.Length - 1;
      Int32 start = 0;
    ...
    [System.Security.SecurityCritical]  // auto-generated
    private Yarn CreateTrimmedString( Int32 start, Int32 end ) {
      ...
      return this.InternalSubString( start, len );
    }

    [System.Security.SecuritySafeCritical]  // auto-generated
    public Yarn Insert( Int32 startIndex, Yarn value ) {
      if ( value == null ) {
        throw new ArgumentNullException( nameof( value ) );
      }
      ...
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.Ensures( Contract.Result<Yarn>().Length == this.Length + value.Length );
      Contract.EndContractBlock();
      Int32 oldLength = this.Length;
      Int32 insertLength = value.Length;
      // In case this computation overflows, newLength will be negative and FastAllocateString throws OutOfMemoryException
      Int32 newLength = oldLength + insertLength;
      if ( newLength == 0 ) {
        return Empty;
      }

      Yarn result = FastAllocateString( newLength );
      unsafe {
        fixed ( Char* srcThis = &this.m_firstChar ) {
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    private extern Yarn ReplaceInternal( Char oldChar, Char newChar );

    public Yarn Replace( Char oldChar, Char newChar ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.Ensures( Contract.Result<Yarn>().Length == this.Length );
      Contract.EndContractBlock();
    ...
    // a new Yarn has to be allocated since Strings are immutable
    [System.Security.SecuritySafeCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    private extern Yarn ReplaceInternal( Yarn oldValue, Yarn newValue );

    public Yarn Replace( Yarn oldValue, Yarn newValue ) {
      if ( oldValue == null ) {
        throw new ArgumentNullException( nameof( oldValue ) );
      }

      // Note that if newValue is null, we treat it like Yarn.Empty.
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.EndContractBlock();

      String s = this.ReplaceInternal( oldValue, newValue );
#if FEATURE_LEGACYNETCF
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public Yarn Remove( Int32 startIndex, Int32 count ) {
      if ( startIndex < 0 ) {
      ...
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.Ensures( Contract.Result<Yarn>().Length == this.Length - count );
      Contract.EndContractBlock();
      Int32 newLength = this.Length - count;
      if ( newLength == 0 ) {
        return Empty;
      }
    ...
    public static Yarn Format( Yarn format, Object arg0 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      return FormatHelper( null, format, new ParamsArray( arg0 ) );
    }

    public static Yarn Format( Yarn format, Object arg0, Object arg1 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      return FormatHelper( null, format, new ParamsArray( arg0, arg1 ) );
    }

    public static Yarn Format( Yarn format, Object arg0, Object arg1, Object arg2 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      return FormatHelper( null, format, new ParamsArray( arg0, arg1, arg2 ) );
    }

    public static Yarn Format( Yarn format, params Object[] args ) {
      if ( args == null ) {
    ...
    public static Yarn Format( IFormatProvider provider, Yarn format, Object arg0 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      return FormatHelper( provider, format, new ParamsArray( arg0 ) );
    }

    public static Yarn Format( IFormatProvider provider, Yarn format, Object arg0, Object arg1 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      return FormatHelper( provider, format, new ParamsArray( arg0, arg1 ) );
    }

    public static Yarn Format( IFormatProvider provider, Yarn format, Object arg0, Object arg1, Object arg2 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      return FormatHelper( provider, format, new ParamsArray( arg0, arg1, arg2 ) );
    }

    public static Yarn Format( IFormatProvider provider, Yarn format, params Object[] args ) {
      if ( args == null ) {
        // To preserve the original exception behavior, throw an exception about format if both
        // args and format are null. The actual null check for format is in FormatHelper.
        throw new ArgumentNullException( ( format == null ) ? "format" : "args" );
    ...
    private static Yarn FormatHelper( IFormatProvider provider, Yarn format, ParamsArray args ) {
      if ( format == null ) {
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    unsafe public static Yarn Copy( Yarn str ) {
      if ( str == null ) {
    ...
    public static Yarn Concat( Object arg0 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.EndContractBlock();
    ...
    public static Yarn Concat( Object arg0, Object arg1 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.EndContractBlock();
    ...
    public static Yarn Concat( Object arg0, Object arg1, Object arg2 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.EndContractBlock();
    ...
    [CLSCompliant( false )]
    public static Yarn Concat( Object arg0, Object arg1, Object arg2, Object arg3, __arglist ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.EndContractBlock();
    ...
    public static Yarn Concat( params Object[] args ) {
      if ( args == null ) {
      ...
      Yarn[] sArgs = new Yarn[ args.Length ];
      Int32 totalLength = 0;
    ...
    [ComVisible( false )]
    public static Yarn Concat<T>( IEnumerable<T> values ) {
      if ( values == null ) {
        throw new ArgumentNullException( nameof( values ) );
      }
    ...
    [ComVisible( false )]
    public static Yarn Concat( IEnumerable<Yarn> values ) {
      if ( values == null ) {
        throw new ArgumentNullException( nameof( values ) );
      }
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Yarn Concat( Yarn str0, Yarn str1 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.Ensures( Contract.Result<Yarn>().Length ==
      ...
      Int32 str0Length = str0.Length;

      Yarn result = FastAllocateString( str0Length + str1.Length );
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Yarn Concat( Yarn str0, Yarn str1, Yarn str2 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.Ensures( Contract.Result<Yarn>().Length ==
          ( str0 == null ? 0 : str0.Length ) +
          ( str1 == null ? 0 : str1.Length ) +
      ...
      Int32 totalLength = str0.Length + str1.Length + str2.Length;

      Yarn result = FastAllocateString( totalLength );
      FillStringChecked( result, 0, str0 );
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Yarn Concat( Yarn str0, Yarn str1, Yarn str2, Yarn str3 ) {
      Contract.Ensures( Contract.Result<Yarn>() != null );
      Contract.Ensures( Contract.Result<Yarn>().Length ==
          ( str0 == null ? 0 : str0.Length ) +
          ( str1 == null ? 0 : str1.Length ) +
      ...
      Int32 totalLength = str0.Length + str1.Length + str2.Length + str3.Length;
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    private static Yarn ConcatArray( Yarn[] values, Int32 totalLength ) {
      Yarn result = FastAllocateString( totalLength );
      Int32 currPos = 0;

      for ( Int32 i = 0; i < values.Length; i++ ) {
        Contract.Assert( ( currPos <= totalLength - values[ i ].Length ),
                        "[Yarn.ConcatArray](currPos <= totalLength - values[i].Length)" );
    ...
    public static Yarn Concat( params Yarn[] values ) {
      if ( values == null ) {
        throw new ArgumentNullException( nameof( values ) );
      }
      ...
      Yarn[] internalValues = new Yarn[ values.Length ];
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Yarn Intern( Yarn str ) {
      if ( str == null ) {
        throw new ArgumentNullException( nameof( str ) );
      }
      Contract.Ensures( Contract.Result<Yarn>().Length == str.Length );
      Contract.Ensures( str.Equals( Contract.Result<Yarn>() ) );
      Contract.EndContractBlock();
    ...
    [Pure]
    [System.Security.SecuritySafeCritical]  // auto-generated
    public static Yarn IsInterned( Yarn str ) {
      if ( str == null ) {
        throw new ArgumentNullException( nameof( str ) );
      }
      Contract.Ensures( Contract.Result<Yarn>() == null || Contract.Result<Yarn>().Length == str.Length );
      Contract.EndContractBlock();
    ...
    public TypeCode GetTypeCode() => TypeCode.Yarn;

    /// <internalonly/>
    Boolean IConvertible.ToBoolean( IFormatProvider provider ) => Convert.ToBoolean( this, provider );
    ...
    /// <internalonly/>
    Int16 IConvertible.ToInt16( IFormatProvider provider ) => Convert.ToInt16( this, provider );

    /// <internalonly/>
    UInt16 IConvertible.ToUInt16( IFormatProvider provider ) => Convert.ToUInt16( this, provider );

    /// <internalonly/>
    Int32 IConvertible.ToInt32( IFormatProvider provider ) => Convert.ToInt32( this, provider );

    /// <internalonly/>
    UInt32 IConvertible.ToUInt32( IFormatProvider provider ) => Convert.ToUInt32( this, provider );

    /// <internalonly/>
    Int64 IConvertible.ToInt64( IFormatProvider provider ) => Convert.ToInt64( this, provider );

    /// <internalonly/>
    UInt64 IConvertible.ToUInt64( IFormatProvider provider ) => Convert.ToUInt64( this, provider );

    /// <internalonly/>
    Single IConvertible.ToSingle( IFormatProvider provider ) => Convert.ToSingle( this, provider );
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    internal extern Boolean IsFastSort();
    // Is this a string that only contains characters < 0x80.
    [System.Security.SecurityCritical]  // auto-generated
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    internal extern Boolean IsAscii();
    ...
    [ResourceExposure( ResourceScope.None )]
    [MethodImpl( MethodImplOptions.InternalCall )]
    internal extern Boolean TryGetTrailByte( out Byte data );

#if !FEATURE_CORECLR
    public CharEnumerator GetEnumerator() {
      Contract.Ensures( Contract.Result<CharEnumerator>() != null );
      Contract.EndContractBlock();
      BCLDebug.Perf( false, "Avoid using Yarn's CharEnumerator until C# special cases foreach on Yarn - use the indexed property on Yarn instead." );
    ...
    // Copies the source Yarn (byte buffer) to the destination IntPtr memory allocated with len bytes.
    [System.Security.SecurityCritical]  // auto-generated
    internal unsafe static void InternalCopy( Yarn src, IntPtr dest, Int32 len ) {
      if ( len == 0 ) {
        return;
      }
