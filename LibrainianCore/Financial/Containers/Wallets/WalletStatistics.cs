...
//
// This source code contained in "WalletStatistics.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "LibrainianCore", File: "WalletStatistics.cs" was last formatted by Protiguous on 2020/03/16 at 3:04 PM.
...
namespace Librainian.Financial.Containers.Wallets {
    ...
    public class WalletStatistics : ABetterClassDispose {
        ...
        [NotNull]
        private readonly ReaderWriterLockSlim _depositLock = new ReaderWriterLockSlim( recursionPolicy: LockRecursionPolicy.SupportsRecursion );

        [NotNull]
        private readonly ReaderWriterLockSlim _withwrawLock = new ReaderWriterLockSlim( recursionPolicy: LockRecursionPolicy.SupportsRecursion );
        ...
        public Decimal AllTimeDeposited {
            get {
                if ( this._depositLock.TryEnterReadLock( timeout: Seconds.Ten ) ) {
                    try {
