...
//
// This source code contained in "ShoppingItem.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "LibrainianCore", File: "ShoppingItem.cs" was last formatted by Protiguous on 2020/03/16 at 3:04 PM.
    ...
    public class ShoppingItem {
        ...
        public ShoppingItem( ItemCategory category, Guid itemID ) {
            if ( category == ItemCategory.Invalid ) {
                throw new ArgumentNullException( paramName: nameof( category ) );
            }

            if ( itemID == Guid.Empty ) {
                throw new InvalidParameterException( message: "", inner: new ArgumentNullException( paramName: nameof( itemID ) ) );
            }
        ...
        public Boolean IsValidData() => this.Category != ItemCategory.Invalid && !this.ItemID.Equals( g: Guid.Empty );
    }
}