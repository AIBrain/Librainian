...
//
// This source code contained in "TreeNodeList.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
//
// Project: "LibrainianCore", File: "TreeNodeList.cs" was last formatted by Protiguous on 2020/03/16 at 3:03 PM.
...
namespace Librainian.Collections.Trees {
    ...
    public class TreeNodeList<T> : List<TreeNode<T>> {
        ...
        [NotNull]
        public TreeNode<T> Add( [CanBeNull] T value ) => this.Add( node: new TreeNode<T>( value: value ) );
