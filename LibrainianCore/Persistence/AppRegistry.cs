...
namespace LibrainianCore.Persistence {
    ...
    public static class AppRegistry {
        ...
        static AppRegistry() {
            ...
            var compName = MediaTypeNames.Application.CompanyName.Trimmed();
            ...
            if ( TheCompany is null ) {
                throw new ArgumentEmptyException( $"Application {nameof( AppRegistry )} folder {nameof( MediaTypeNames.Application.CompanyName )} is null!" );
            }

            var product = MediaTypeNames.Application.ProductName.Trimmed();
            ...
            if ( TheApplication is null ) {
                throw new ArgumentEmptyException( $"Application {nameof( AppRegistry )} folder {nameof( MediaTypeNames.Application.ProductName )} is null!" );
            }
        }
