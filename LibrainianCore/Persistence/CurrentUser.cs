...
//
// This source code contained in "CurrentUser.cs" belongs to Protiguous@Protiguous.com and
...
namespace LibrainianCore.Persistence {
    ...
    public static class CurrentUser {
        ...
        /// <value></value>
        [NotNull]
        internal static RegistryKey App => Protiguous.CreateSubKey( MediaTypeNames.Application.ProductName, true );
