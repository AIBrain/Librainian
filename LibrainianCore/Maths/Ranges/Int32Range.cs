...
// 
// Project: "LibrainianCore", File: "Int32Range.cs" was last formatted by Protiguous on 2020/03/16 at 3:06 PM.
...
namespace Librainian.Maths.Ranges {
    ...
    public struct Int32Range {
        ...
        public static readonly Int32Range ZeroAndOne = new Int32Range( min: 0, max: 1 );
        ...
        public Boolean IsInside( Int32Range range ) => this.IsInside( x: range.Min ) && this.IsInside( x: range.Max );
        ...
        public Boolean IsOverlapping( Int32Range range ) => this.IsInside( x: range.Min ) || this.IsInside( x: range.Max );
