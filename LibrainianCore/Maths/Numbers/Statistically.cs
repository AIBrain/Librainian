...
// 
// Project: "LibrainianCore", File: "Statistically.cs" was last formatted by Protiguous on 2020/03/16 at 3:06 PM.
...
namespace Librainian.Maths.Numbers {
    ...
    public class Statistically {
        ...
        public Boolean IsProtiguous => this.IsUpper && !this.Downs.Near( target: 0 ) && !this.Ups.Near( target: 0 );
        ...
        public static Statistically Undecided = new Statistically( ups: 0.5, downs: 0.5 );
        ...
        public static void Reset( [NotNull] Statistically statistically, Double newUps = 0.0, Double newDowns = 0.0 ) {
            ...
            statistically.IncrementUps( byAmount: newUps );
            statistically.IncrementDowns( byAmount: newDowns );
        }

        public void Add( [NotNull] Statistically other ) {
            this.IncrementUps( byAmount: other.Ups );
            this.IncrementDowns( byAmount: other.Downs );
        }
