...
// 
// Project: "LibrainianCore", File: "ZeroToOne.cs" was last formatted by Protiguous on 2020/03/16 at 3:06 PM.
...
namespace Librainian.Maths.Numbers {
    ...
    public class ZeroToOne {
        ...
        [NotNull]
        public static ZeroToOne Combine( [CanBeNull] ZeroToOne value1, [CanBeNull] ZeroToOne value2 ) => new ZeroToOne( value: ( value1 + value2 ) / 2f );
        ...
        [NotNull]
        public static ZeroToOne Parse( [NotNull] String value ) => new ZeroToOne( value: Single.Parse( s: value ) );

        /// <summary>Attempt to parse <paramref name="value" />, otherwise return <see cref="MinValue" />.</summary>
        /// <param name="value"></param>
        /// <returns></returns>
        [NotNull]
        public static ZeroToOne TryParse( [NotNull] String value ) => Single.TryParse( s: value, result: out var result ) ? result : MinValue;
