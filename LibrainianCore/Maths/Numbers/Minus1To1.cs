...
// 
// This source code contained in "Minus1To1.cs" belongs to Protiguous@Protiguous.com unless otherwise specified or the original license has been overwritten
...
// 
// Project: "LibrainianCore", File: "Minus1To1.cs" was last formatted by Protiguous on 2020/03/16 at 3:06 PM.
...
namespace Librainian.Maths.Numbers {
    ...
    public struct Minus1To1 {
        ...
        public static Minus1To1 Combine( Minus1To1 value1, Minus1To1 value2 ) => new Minus1To1( value: ( value1 + value2 ) / 2f );

        public static implicit operator Minus1To1( Single value ) => new Minus1To1( value: value );

        public static implicit operator Single( Minus1To1 special ) => special.Value;

        public static Minus1To1 Parse( [NotNull] String value ) => new Minus1To1( value: Single.Parse( s: value ) );
