...
// 
// Project: "Librainian", "RegistryServer.cs" was last formatted by Protiguous on 2019/12/04 at 10:35 PM.
...
namespace LibrainianCore.Extensions {
    ...
    public class RegistryServer : IEqualityComparer<RegistryKey> /*, IInitializable*/, IEnumerable<RegistryKey> {
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public Boolean Equals( [System.Diagnostics.CodeAnalysis.NotNull] RegistryKey x, [System.Diagnostics.CodeAnalysis.NotNull] RegistryKey y ) {
            if ( x is null ) {
        ...
        private static Boolean TryOpenSubKey( [System.Diagnostics.CodeAnalysis.NotNull] RegistryKey startFrom, String name, [CanBeNull] out RegistryKey itemOut ) {
            var bIsOk = false;
            itemOut = null;
