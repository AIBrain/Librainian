...
//
// "Librainian2/WaitTime.cs" was last cleaned by Rick on 2014/08/08 at 2:27 PM
...
namespace Librainian.Extensions {
    ...
    public static class WaitTime {
        ...
        public static TimeSpan Cap( this TimeSpan waitTime ) {
            return waitTime > MaxValue ? MaxValue : waitTime;
        }

        public static DateTime Deadline( this TimeSpan waitTime ) {
