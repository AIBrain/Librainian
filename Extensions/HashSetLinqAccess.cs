...
//
// "Librainian/HashSetLinqAccess.cs" was last cleaned by Protiguous on 2018/05/12 at 1:22 AM
...
namespace Librainian.Extensions {
    ...
    /// <summary>
    /// This extension method class will add a ToHashSet <typeparamref name="&gt;"/> in exactly the same way it is provided by the others: ToList(), ToArray(), ToDictionary().. Now ToHashSet() is available.
