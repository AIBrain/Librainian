...
namespace Librainian.Extensions {
    ...
    public static class Types {
        ...
        */
        ...
        public static bool CanAssignValue( this PropertyInfo p, object value ) => value == null ? p.IsNullable() : p.PropertyType.IsInstanceOfType( value );

        public static bool IsNullable( this PropertyInfo p ) => p.PropertyType.IsNullable();

        public static bool IsNullable( this Type t ) => !t.IsValueType || Nullable.GetUnderlyingType( t ) != null;
