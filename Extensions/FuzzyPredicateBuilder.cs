...
//
// "Librainian2/FuzzyPredicateBuilder.cs" was last cleaned by Rick on 2014/08/08 at 2:26 PM
...
namespace Librainian.Extensions {
    ...
    public static class FuzzyPredicateBuilder {
        ...
        public static Expression<Func<TTT, Boolean>> Or<TTT>( this Expression<Func<TTT, Single>> expr1, Expression<Func<TTT, Single>> expr2 ) {
            return Expression.Lambda<Func<TTT, Boolean>>( body: Expression.GreaterThanOrEqual( expr1.Body, Expression.Invoke( expr2, expr1.Parameters ) ), parameters: expr1.Parameters );
        }
