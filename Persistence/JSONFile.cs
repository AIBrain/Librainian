...
//
// "Librainian/JSONFile.cs" was last cleaned by Rick on 2016/06/18 at 10:56 PM
    ...
    public class JSONFile {
        ...
        public IReadOnlyDictionary<String, String> this[ [CanBeNull] String section ] {
            ...
            get {
                ...
                return this.Data.TryGetValue( section, out result ) ? result : null;
            }
        }
        ...
        public String this[ [CanBeNull] String section, [CanBeNull] String key ] {
            ...
            get {
                ...
                return this.Data[ section ].TryGetValue( key, out value ) ? value : null;
            }
        ...
        public Boolean Add( INIFile iniFile ) {
            ...
            Parallel.ForEach( iniFile.Sections.AsParallel(), ThreadingExtensions.CPUIntensive, section => {
                ...
                if ( null != dictionary ) {
                    Parallel.ForEach( dictionary.AsParallel(), ThreadingExtensions.CPUIntensive, pair => {
                        this.Add( section, pair );
                    } );
                }
            } );
        ...
        public Task<Boolean> Read( CancellationToken cancellationToken = default( CancellationToken ) ) {
            ...
            return Task.Run( () => {
                ...
                try {
                    ...
                    var result = Parallel.ForEach( data.Keys.AsParallel(), ThreadingExtensions.CPUIntensive, section => {
                        Parallel.ForEach( data[ section ].Keys.AsParallel(), ThreadingExtensions.CPUIntensive, key => {
        ...
        public override String ToString() {
            return $"{this.Sections.Count()} sections, {this.AllKeys.Count()} keys";
        }
        ...
        public Boolean TryRemove( String section, String key ) {
            ...
            String value;
            return this.Data[ section ].TryRemove( key, out value );
        }
