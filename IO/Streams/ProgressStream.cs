...
// 
// "Librainian 2015/ProgressStream.cs" was last cleaned by Rick on 2015/01/21 at 11:08 AM
#endregion
...
namespace Librainian.IO.Streams {
    ...
    public sealed class ProgressStream : ContainerStream {
        ...
        public override int Read( byte[] buffer, int offset, int count ) {
            ...
            var newProgress = ( int ) ( 1024.0D * ( ( this.Position / ( Double ) this.Length ) ) );
            if ( newProgress <= this._lastProgress || ( DateTime.UtcNow - this._lastProgressUpdate ) < Seconds.One ) {
                return amountRead;
            }
