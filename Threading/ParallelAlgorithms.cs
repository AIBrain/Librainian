...
// 
// "Librainian/ParallelAlgorithms.cs" was last cleaned by Rick on 2015/06/12 at 3:14 PM
...
namespace Librainian.Threading {
    ...
    public static class ParallelAlgorithms {
        ...
        public static TResult SpeculativeFor<TResult>(this Int32 fromInclusive, Int32 toExclusive, Func<Int32, TResult> body) => fromInclusive.SpeculativeFor( toExclusive, ThreadingExtensions.ParallelOptions, body );
        ...
        /// <param name="body">The function to execute for each element.</param>
        /// <returns>The result computed.</returns>
        public static TResult SpeculativeForEach<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, TResult> body) => source.SpeculativeForEach( ThreadingExtensions.ParallelOptions, body );
        ...
        public static T SpeculativeInvoke<T>(params Func<T>[] functions) => ThreadingExtensions.ParallelOptions.SpeculativeInvoke( functions );
        ...
        public static void Wavefront(this Action<Int32, Int32> processRowColumnCell, Int32 numRows, Int32 numColumns) {
            ...
            // Wait for the last task to be done. ReSharper disable once PossibleNullReferenceException
