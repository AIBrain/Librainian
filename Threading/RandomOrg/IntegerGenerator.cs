...
//
// ========================================================= This section of source code, "IntegerGenerator.cs", belongs to Rick@AIBrain.org and Protiguous@Protiguous.com unless otherwise specified OR the original license
...
//
// "Librainian/IntegerGenerator.cs" was last cleaned by Protiguous on 2018/05/15 at 4:23 AM.
                            ...
                            if ( col > 0 && col <= ColMax ) {
                                if ( inbase == 2 || inbase == 8 || inbase == 10 || inbase == 16 ) {
                                    ...
                                    foreach ( var s in Regex.Split( toParse, @"\D" ) ) {
                                        try {
                                            if ( !s.IsNullOrWhiteSpace() ) { this._ints.Add( Convert.ToInt32( s, inbase ) ); }
                                        }
                                        catch { }
                                    }
                                }
