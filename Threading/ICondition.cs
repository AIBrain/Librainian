...
// 
// "Librainian2/ICondition.cs" was last cleaned by Rick on 2014/08/08 at 2:31 PM
#endregion
...
namespace Librainian.Threading {
    ...
    ///             variables
    ///         </b>
    ///         ) provide a means for one thread to suspend execution (to
    ...
    public interface ICondition // BACKPORT_3_1
    {
        ...
        ///         <list type="bullet">
        ///             <item>
        ///                 Some other thread invokes the <see cref="Signal()" /> method
        ///                 for this <see cref="ICondition" /> and the current thread happens to
        ///                 be chosen as the thread to be awakened.
        ///             </item>
        ///             <item>
        ///                 Some other thread invokes the <see cref="SignalAll()" />}
        ///                 method for this <see cref="ICondition" />.
        ///             </item>
        ///             <item>
        ///                 Some other thread <see cref="Thread.Interrupt()" /> is called
        ...
        ///             <item>
        ///                 <see cref="Thread.Interrupt()" /> is called while waiting
        ...
        ///         <list type="bullet">
        ///             <item>
        ///                 Some other thread invokes the <see cref="Signal" /> method for this
        ///                 <c>Condition</c> and the current thread happens to be chosen as the
        ///                 thread to be awakened; or
        ///             </item>
        ///             <item>
        ///                 Some other thread invokes the <see cref="SignalAll" /> method for this
        ///                 <c>Condition</c>; or
        ///             </item>
        ///             <item>
        ///                 Some other thread <see cref="Thread.Interrupt">interrupts</see> the
        ...
        ///             <item>
        ///                 is <see cref="Thread.Interrupt">interrupts</see> while waiting
        ///                 and interruption of thread suspension is supported,
        ///             </item>
        ///         </list>
        ...
        ///             </item>
        ///             <item>
        ///                 Some other thread invokes the <see cref="SignalAll()" />} method
        ///                 for this <see cref="ICondition" />.
        ///             </item>
        ///             <item>A '<b>spurious wakeup</b>' occurs.</item>
        ///         </list>
        ///     </para>
