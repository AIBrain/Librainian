...
namespace Librainian.AmazedSaint {
    ...
    public class ElasticObject : DynamicObject, IElasticHierarchyWrapper, INotifyPropertyChanged {
        ...
        public String InternalName { get { return this._elasticProvider.InternalName; } set { this._elasticProvider.InternalName = value; } }

        public ElasticObject InternalParent { get { return this._elasticProvider.InternalParent; } set { this._elasticProvider.InternalParent = value; } }

        public object InternalValue { get { return this._elasticProvider.InternalValue; } set { this._elasticProvider.InternalValue = value; } }
