...
//
// =========================================================
// This section of source code, "HttpProcessor.cs",
...
//
// "Librainian/Librainian/HttpProcessor.cs" was last cleaned by Protiguous on 2018/05/15 at 10:43 PM.
...
namespace Librainian.Internet.Servers {
    ...
    public class HttpProcessor : ABetterClassDispose {
        ...
        ///     "/articles/science/moon.html?date=2011-10-21", pathParts would be { "articles", "science", "moon.html" }
        /// </summary>
        public String[] PathParts;

        /// <summary>
        ///     A SortedList mapping lower-case keys to values of parameters. This list is populated if and only if the request was
        ///     a POST request with mimetype "application/x-www-form-urlencoded".
        /// </summary>
        ...
        /// <summary>
        ///     A SortedList mapping keys to values of parameters. No character case conversion is applied in this list. This list
        ///     is populated if and only if the request was a POST request with mimetype "application/x-www-form-urlencoded".
        /// </summary>
        public SortedList<String, String> RawPostParams = new SortedList<String, String>();

        /// <summary>
        ///     A SortedList mapping keys to values of parameters. No character case conversion is applied in this list. This list
        ///     is populated parameters that were appended to the url (the query String). e.g. if the url is
        ...
        /// <summary>
        ///     The path to and name of the requested page, not including the first '/' For example, if the URL was
        ///     "/articles/science/moon.html?date=2011-10-21", requestedPage would be "articles/science/moon.html"
        /// </summary>
        ...
        ///     interprets a value of "1" or "true" (case insensitive) as being true. Any other parameter value is
        ...
        /// </summary>
        /// <param name="code">
        ///     (OPTIONAL) The http error code (including explanation entity). For example: "404 Not Found"
        ///     where 404 is the error code and "Not Found" is the explanation.
        /// </param>
        /// <param name="description">
        ///     (OPTIONAL) A description String to send after the headers as the response. This is typically shown to the remote
