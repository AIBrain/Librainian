...
namespace Librainian.Internet.Servers {
    ...
    public class HttpProcessor : ABetterClassDispose {
        ...
        /// <summary>The HttpServer instance that accepted this request.</summary>
        public readonly HttpServer Srv;

        /// <summary>The underlying tcpClient which handles the network connection.</summary>
        public readonly TcpClient TcpClient;

        /// <summary>The base Uri for this Server, containing its host name and port.</summary>
        public Uri BaseUriThisServer;

        /// <summary>The Http method used. i.e. "POST" or "GET"</summary>
        public String HttpMethod;

        /// <summary>The protocol version String sent by the client. e.g. "HTTP/1.1"</summary>
        ...
        public static Boolean GetIsLanConnection( HttpProcessor httpProcessor ) {
            ...
            if ( ( remoteBytes == null ) || ( remoteBytes.Length != 4 ) ) {
                ...
                // If the first 3 bytes of any local address matches the first 3 bytes of the local
                // address, then the remote address is in the same class C range as this address.
        ...
        /// <summary>Parses the http headers</summary>
