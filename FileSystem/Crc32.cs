...
//
// "Librainian/Crc32.cs" was last cleaned by Rick on 2016/06/18 at 10:51 PM
...
namespace Librainian.FileSystem {
    ...
    ///     It is not secure enough for new applications. If you need to call multiple times for the
    ///     same data either use the HashAlgorithm interface or remember that the result of one Compute
    ///     call needs to be ~ (XOR) before being passed in as the seed for the next Compute call.
    /// </remarks>
    /// <copyright>
    ///     Copyright (c) Damien Guard. All rights reserved. Licensed under the Apache License.
