...
//
// =========================================================
// This section of source code, "Folder.cs",
...
//
// "Librainian/Librainian/Folder.cs" was last cleaned by Protiguous on 2018/05/15 at 10:41 PM.
...
namespace Librainian.FileSystem {
    ...
    public class Folder : IEquatable<Folder> {
        ...
        ///     <para>To compare the path of two <see cref="Folder" /> use
        ...
        public Boolean Create() {
            try {
                ...
                if ( this.Info.Parent != null && !this.Info.Parent.Exists ) { new Folder( this.Info.Parent.FullName ).Create(); }
