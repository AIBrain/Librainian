...
//
// "Librainian/BigInt.cs" was last cleaned by Rick on 2016/06/18 at 10:52 PM
...
namespace Librainian.Maths.Numbers {
    ...
    public class BigInt {
        ...
        public BigInt( String number ) {
            this.Integer = CalculateBigInteger( number );
        }

        public BigInt( List<Int32> list ) {
            this.Integer = list;
        }

        public List<Int32> Integer {
            get;
        }
