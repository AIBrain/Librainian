...
//  
// "Librainian/BigIntegerRange.cs" was last cleaned by Rick on 2015/08/05 at 1:38 PM
...
namespace Librainian.Maths {
    ...
    public struct BigIntegerRange {
        ...
        /// </returns>
        public Boolean IsInside( BigIntegerRange range ) { return this.IsInside( range.Min ) && this.IsInside( range.Max ); }
