...
// 
// "Librainian/VotallyI.cs" was last cleaned by Rick on 2015/06/12 at 3:01 PM
...
namespace Librainian.Maths {
    ...
    /// <summary>
    /// <para>Keep count of Yes or No votes.</para></summary>
    ...
    public class VotallyI {
        ...
        /// <summary>
        /// <para>Increments the votes for candidate <see cref="No" /> by <paramref name="votes" />.</para></summary>
        public void VoteNo(UInt64 votes = 1) => this.No += votes;

        /// <summary>
        /// <para>Increments the votes for candidate <see cref="Yes" /> by <paramref name="votes" />.</para></summary>
