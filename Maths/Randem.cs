...
//
// "Librainian/Librainian/Randem.cs" was last formatted by Protiguous on 2018/05/24 at 7:23 PM.
...
namespace Librainian.Maths {
    ...
    internal static class Request {
        ...
        public static WebRequest Create( String uri ) {
            var request = WebRequest.Create( requestUriString: uri ); //TODO WebClient
            request.Proxy = null;
    ...
    public static class Randem {
        ...
        public static Decimal NextDecimal() {
            do {
                try { return Instance.NextDecimal(); }
