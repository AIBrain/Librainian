...
// 
// "Librainian/Percentage.cs" was last cleaned by Rick on 2015/06/12 at 3:00 PM
...
namespace Librainian.Maths {
    ...
    public class Percentage : IComparable<Percentage>, IComparable<Double>, IEquatable<Percentage> {
        ...
        /// <summary>
        /// <para>Restricts the value to between <see cref="Minimum" /> and <see cref="Maximum" />.</para></summary>
