...
// 
// "Librainian/MathExtensions.cs" was last cleaned by Rick on 2014/08/11 at 12:38 AM
#endregion
...
namespace Librainian.Maths {
    ...
    public static class MathExtensions {
        ...
        public static Single Half( this Single x ) {
            return x/2.0f;
        }
        ...
        public static Int32 Half( this int x ) {
            return ( Int32 ) ( x/2.0f );
        }

        public static UInt32 Half( this UInt32 x ) {
            return ( UInt32 ) ( x/2.0f );
        }

        public static UInt64 Half( this UInt64 x ) {
            return ( UInt64 ) ( x/2.0d );
        }
        ...
        /// <returns></returns>
        public static string IntToStringWithBase( int n, int b, int minDigits = 1 ) {
            if ( minDigits < 1 ) {
                minDigits = 1;
            }
            if ( n == 0 ) {
        ...
        public static Single Lerp( Single source, Single target, Single amount ) {
        ...
        /// <param name="target"> Target value. </param>
        /// <param name="amount"> Value between 0 and 1 indicating the weight of value2. </param>
        public static Double Lerp( Double source, Double target, Single amount ) {
            return source + ( target - source )*amount;
        }
        ...
        /// <param name="target"> Target value. </param>
        /// <param name="amount"> Value between 0 and 1 indicating the weight of value2. </param>
        public static UInt64 Lerp( UInt64 source, UInt64 target, Single amount ) {
        ...
        /// <param name="target"> Target value. </param>
        /// <param name="amount"> Value between 0 and 1 indicating the weight of value2. </param>
        public static UInt32 Lerp( UInt32 source, UInt32 target, Single amount ) {
