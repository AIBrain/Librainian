...
// 
// This source code contained in "MathExtensions.cs" belongs to Rick@AIBrain.org and
...
// 
// ***  Project "Librainian"  ***
// File "MathExtensions.cs" was last formatted by Protiguous on 2018/06/04 at 4:04 PM.
...
namespace Librainian.Maths {
	...
	public static class MathExtensions {
		...
		///     <para>var withTax = 50.AddTax( 0.06 );</para>
		...
		/// <param name="high"></param>
		/// <returns></returns>
		public static UInt16 CombineBytes( this Byte low, Byte high ) => BitConverter.ToUInt16( BitConverter.IsLittleEndian ? new[] { high, low } : new[] { low, high }, startIndex: 0 );
		...
		/// <summary>
		///     <para>
		///         If the <paramref name="number" /> is less than <see cref="BigRational.Zero" />, then return
		///         <see cref="Decimal.Zero" />.
		///     </para>
		///     <para>Otherwise return the <paramref name="number" />.</para>
		/// </summary>
		...
		[DebuggerStepThrough]
		[Pure]
		public static Boolean Near( this Decimal number, Decimal target ) => Math.Abs( number - target ) <= Constants.EpsilonDecimal;
		...
		public static UInt32 ReverseBits( this UInt32 source ) =>
			( UInt32 ) ( ( BitReverseTable256[ source & 0xff ] << 24 ) | ( BitReverseTable256[ ( source >> 8 ) & 0xff ] << 16 ) | ( BitReverseTable256[ ( source >> 16 ) & 0xff ] << 8 ) |
