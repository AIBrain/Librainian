...
//  
// "Librainian/BiggerRational.cs" was last cleaned by Rick on 2015/08/05 at 2:20 PM
...
//    /// <summary>
//    /// <para>
//    /// Decompiled from BigRationalLibrary. Where BigRationalLibrary came from, I don't know. But thanks!
//    /// </para>
...
//            [FieldOffset( 0 )] public Int32 flags;
...
//            [FieldOffset( 0 )] public UInt64 uu;
...
//        private const Int32 DecimalMaxScale = 28;

//        private const Int32 DecimalScaleMask = 16711680;

//        private const Int32 DecimalSignMask = -2147483648;

//        private const Int32 DoubleMaxScale = 308;
...
//            }
//            else {
//                this.Numerator = new BigInteger( ( UInt64 ) ( UInt32 ) bits[ 2 ] << 32 | ( UInt32 ) bits[ 1 ] ) << 32 | ( UInt32 ) bits[ 0 ];
//                if ( ( bits[ 3 ] & Int32.MinValue ) != 0 ) {
//                    this.Numerator = BigInteger.Negate( this.Numerator );
//                }
...
//        public Int32 Sign => this.Numerator.Sign;
...
//        public Int32 CompareTo( BiggerRational other ) => Compare( this, other );
...
//        public Boolean Equals( BiggerRational other ) => Equals( this, other );
...
//        public static Int32 Compare( BiggerRational r1, BiggerRational r2 ) => BigInteger.Compare( r1.Numerator * r2.Denominator, r2.Numerator * r1.Denominator );
...
//        public static explicit operator Int32( BiggerRational value ) => ( Int32 ) BigInteger.Divide( value.Numerator, value.Denominator );

//        public static explicit operator BigInteger( BiggerRational value ) => BigInteger.Divide( value.Numerator, value.Denominator );

//        public static explicit operator UInt32( BiggerRational value ) => ( UInt32 ) BigInteger.Divide( value.Numerator, value.Denominator );

//        public static explicit operator Single( BiggerRational value ) => ( Single ) ( Double ) value;
...
//                }
//                else {
//                    var decimalUint32 = new DecimalUInt32 {dec = ( Decimal ) bigInteger};
...
//        public static implicit operator BiggerRational( UInt32 value ) => new BiggerRational( ( BigInteger ) value );
...
//        public static implicit operator BiggerRational( Int16 value ) => new BiggerRational( ( BigInteger ) value );

//        public static implicit operator BiggerRational( Int32 value ) => new BiggerRational( ( BigInteger ) value );

//        public static implicit operator BiggerRational( Int64 value ) => new BiggerRational( ( BigInteger ) value );

//        public static implicit operator BiggerRational( BigInteger value ) => new BiggerRational( value );

//        public static implicit operator BiggerRational( Single value ) => new BiggerRational( value );
...
//        public static Boolean operator !=( BiggerRational x, BiggerRational y ) => Compare( x, y ) != 0;
...
//        public static Boolean SafeCastToDecimal( BigInteger value ) {
...
//        public static Boolean SafeCastToDouble( BigInteger value ) {
...
//        public static void SplitDoubleIntoParts( Double dbl, out Int32 sign, out Int32 exp, out UInt64 man, out Boolean isFinite ) {
//            DoubleVsUlong doubleVsUlong;
//            doubleVsUlong.uu = 0UL;
//            doubleVsUlong.dbl = dbl;
//            sign = 1 - ( ( Int32 ) ( doubleVsUlong.uu >> 62 ) & 2 );
//            man = doubleVsUlong.uu & 4503599627370495UL;
//            exp = ( Int32 ) ( doubleVsUlong.uu >> 52 ) & 2047;
//            switch ( exp ) {
//                case 0:
//                    isFinite = true;
//                    if ( ( Int64 ) man == 0L ) {
...
//        public override Boolean Equals( Object obj ) => obj is BiggerRational && Equals( this, ( BiggerRational ) obj );
...
//        public static explicit operator Int16( BiggerRational value ) => ( Int16 ) BigInteger.Divide( value.Numerator, value.Denominator );

//        public static explicit operator Int64( BiggerRational value ) => ( Int64 ) BigInteger.Divide( value.Numerator, value.Denominator );
...
//            if ( bigInteger.IsZero ) {
//                return value.Sign >= 0 ? 0.0 : BitConverter.Int64BitsToDouble( Int64.MinValue );
//            }
//            var num = 0.0;
//            var flag = false;
...
//        private static Int32 CbitHighZero( UInt64 uu ) {
//            if ( ( ( Int64 ) uu & -4294967296L ) == 0L ) {
//                return 32 + CbitHighZero( ( UInt32 ) uu );
//            }
//            return CbitHighZero( ( UInt32 ) ( uu >> 32 ) );
//        }

//        private static Int32 CbitHighZero( UInt32 u ) {
//            if ( ( Int32 ) u == 0 ) {
//                return 32;
//            }
//            var num = 0;
...
//                u <<= 16;
//            }
//            if ( ( ( Int32 ) u & -16777216 ) == 0 ) {
//                num += 8;
//                u <<= 8;
//            }
//            if ( ( ( Int32 ) u & -268435456 ) == 0 ) {
//                num += 4;
//                u <<= 4;
//            }
//            if ( ( ( Int32 ) u & -1073741824 ) == 0 ) {
//                num += 2;
//                u <<= 2;
//            }
//            if ( ( ( Int32 ) u & Int32.MinValue ) == 0 ) {
//                ++num;
//            }
//            return num;
//        }

//        private static Double GetDoubleFromParts( Int32 sign, Int32 exp, UInt64 man ) {
//            DoubleVsUlong doubleVsUlong;
...
//                }
//                else {
//                    doubleVsUlong.uu = ( UInt64 ) ( ( Int64 ) man & 4503599627370495L | ( Int64 ) exp << 52 );
//                }
//            }
//            if ( sign < 0 ) {
