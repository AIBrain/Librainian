...
// 
// "Librainian2/VotallyD.cs" was last cleaned by Rick on 2014/08/08 at 2:28 PM
#endregion
...
namespace Librainian.Maths {
    ...
    public class VotallyD {
        ...
        public Boolean IsBWinning { get { return this.B > this.A; } }

        public Boolean IsProtiguous { get { return this.IsTied() && this.Votes > 1; } }

        public Boolean IsLandslideA { get { return this.IsAWinning && this.A > this.HalfOfVotes(); } }

        public Boolean IsAWinning { get { return this.A > this.B; } }

        public Double Votes { get { return this.A + this.B; } }

        public Double A { get { return Thread.VolatileRead( ref this._aVotes ); } private set { Thread.VolatileWrite( ref this._aVotes, value ); } }

        public Double B { get { return Thread.VolatileRead( ref this._bVotes ); } private set { Thread.VolatileWrite( ref this._bVotes, value ); } }
