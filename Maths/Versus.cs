...
// 
// "Librainian/Versus.cs" was last cleaned by Rick on 2015/06/12 at 3:01 PM
...
namespace Librainian.Maths {
    ...
    /// <summary>
    /// <para>Keep count of Success or Failure counts (threadsafe).</para></summary>
    ...
    public class Versus {
        ...
        /// <summary>
        /// <para>Increments the <see cref="Failures" /> count by <paramref name="amount" />.</para></summary>
        ...
        /// <summary>
        /// <para>Increments the <see cref="Successes" /> count by <paramref name="amount" />.</para></summary>
