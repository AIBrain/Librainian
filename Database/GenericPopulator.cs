...
//  
// "Librainian/GenericPopulator.cs" was last cleaned by Rick on 2015/10/26 at 5:28 PM
...
namespace Librainian.Database {
    ...
    public sealed class GenericPopulator< T > {
        ...
        private static Func< SqlDataReader, T > GetReader( SqlDataReader reader ) {
            ...
            foreach ( var prop in typeof ( T ).GetProperties() ) {
                ...
                else if ( prop.PropertyType.Name.ToLower()
                              .Equals( "string" ) ) {
